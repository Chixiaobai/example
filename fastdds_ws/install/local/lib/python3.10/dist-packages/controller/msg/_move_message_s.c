...
bool controller__msg__move_message__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("controller.msg._move_message.MoveMessage", full_classname_dest, 40) == 0);
  }
  controller__msg__MoveMessage * ros_message = _ros_message;
  {  // state
  ...
  {  // tcp_pose
    ...
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'tcp_pose'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    controller__msg__TcpPoseParams * dest = ros_message->tcp_pose.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
...
{
  /* NOTE(esteve): Call constructor of MoveMessage */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("controller.msg._move_message");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MoveMessage");
  ...
  {  // tcp_pose
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->tcp_pose.data[i]);
