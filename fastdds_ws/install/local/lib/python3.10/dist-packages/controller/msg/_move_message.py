...
class Metaclass_MoveMessage(type):
    """Metaclass of message 'MoveMessage'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'controller.msg.MoveMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__move_message
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__move_message
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__move_message
            cls._TYPE_SUPPORT = module.type_support_msg__msg__move_message
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__move_message
...
class MoveMessage(metaclass=Metaclass_MoveMessage):
    """Message class 'MoveMessage'."""
    ...
    _fields_and_field_types = {
        ...
        'tcp_pose': 'sequence<controller/TcpPoseParams>',
        'token': 'uint32',
    }
    ...
    def __init__(self, **kwargs):
        ...
        self.tcp_pose = kwargs.get('tcp_pose', [])
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'tcp_pose' field must be a set or sequence and each value of type 'TcpPoseParams'"
