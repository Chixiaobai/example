...
bool controller__msg__error_message__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("controller.msg._error_message.ErrorMessage", full_classname_dest, 42) == 0);
  }
  controller__msg__ErrorMessage * ros_message = _ros_message;
  {  // id
  ...
  {  // module
    ...
    assert(PyLong_Check(field));
    ros_message->module = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // error_code
...
{
  /* NOTE(esteve): Call constructor of ErrorMessage */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("controller.msg._error_message");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ErrorMessage");
  ...
  {  // module
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->module);
    {
