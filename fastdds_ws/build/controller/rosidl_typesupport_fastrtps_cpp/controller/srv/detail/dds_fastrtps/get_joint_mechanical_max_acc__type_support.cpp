...
#include "controller/srv/detail/get_joint_mechanical_max_acc__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = controller::srv::GetJointMechanicalMaxAcc_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const controller::srv::GetJointMechanicalMaxAcc_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<controller::srv::GetJointMechanicalMaxAcc_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GetJointMechanicalMaxAcc_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const controller::srv::GetJointMechanicalMaxAcc_Request *>(
...
static size_t _GetJointMechanicalMaxAcc_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetJointMechanicalMaxAcc_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GetJointMechanicalMaxAcc_Request__callbacks = {
  "controller::srv",
...
static rosidl_message_type_support_t _GetJointMechanicalMaxAcc_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetJointMechanicalMaxAcc_Request__callbacks,
...
{
  return &controller::srv::typesupport_fastrtps_cpp::_GetJointMechanicalMaxAcc_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = controller::srv::GetJointMechanicalMaxAcc_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const controller::srv::GetJointMechanicalMaxAcc_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<controller::srv::GetJointMechanicalMaxAcc_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GetJointMechanicalMaxAcc_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const controller::srv::GetJointMechanicalMaxAcc_Response *>(
...
static size_t _GetJointMechanicalMaxAcc_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetJointMechanicalMaxAcc_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GetJointMechanicalMaxAcc_Response__callbacks = {
  "controller::srv",
...
static rosidl_message_type_support_t _GetJointMechanicalMaxAcc_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetJointMechanicalMaxAcc_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &controller::srv::typesupport_fastrtps_cpp::_GetJointMechanicalMaxAcc_Response__handle;
}
...
static service_type_support_callbacks_t _GetJointMechanicalMaxAcc__callbacks = {
  "controller::srv",
...
static rosidl_service_type_support_t _GetJointMechanicalMaxAcc__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetJointMechanicalMaxAcc__callbacks,
...
{
  return &controller::srv::typesupport_fastrtps_cpp::_GetJointMechanicalMaxAcc__handle;
}
