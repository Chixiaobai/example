...
#include "controller/srv/detail/linear_move__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const controller::msg::LinearMoveParams &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  controller::msg::LinearMoveParams &);
...
cdr_serialize(
  const controller::srv::LinearMove_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  controller::srv::LinearMove_Request & ros_message)
{
  // Member: linear_move
  {
    uint32_t cdrSize;
    ...
    ros_message.linear_move.resize(size);
    for (size_t i = 0; i < size; i++) {
      controller::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.linear_move[i]);
    }
  }
  ...
  // Member: linear_move
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.linear_move[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: linear_move
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        controller::msg::typesupport_fastrtps_cpp::max_serialized_size_LinearMoveParams(
  ...
  if (is_plain) {
    ...
    using DataType = controller::srv::LinearMove_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const controller::srv::LinearMove_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<controller::srv::LinearMove_Request *>(
    untyped_ros_message);
...
{
  return &controller::srv::typesupport_fastrtps_cpp::_LinearMove_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, controller, srv, LinearMove_Request)() {
  return &controller::srv::typesupport_fastrtps_cpp::_LinearMove_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_controller
cdr_serialize(
  const controller::srv::LinearMove_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: result
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  controller::srv::LinearMove_Response & ros_message)
{
  // Member: result
  cdr >> ros_message.result;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = controller::srv::LinearMove_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const controller::srv::LinearMove_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<controller::srv::LinearMove_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &controller::srv::typesupport_fastrtps_cpp::_LinearMove_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, controller, srv, LinearMove_Response)() {
  return &controller::srv::typesupport_fastrtps_cpp::_LinearMove_Response__handle;
}
...
{
  return &controller::srv::typesupport_fastrtps_cpp::_LinearMove__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, controller, srv, LinearMove)() {
  return &controller::srv::typesupport_fastrtps_cpp::_LinearMove__handle;
}
