...
#include "controller/srv/detail/inverse_kinematics__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const controller::srv::InverseKinematics_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  controller::srv::InverseKinematics_Request & ros_message)
{
  // Member: pose
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = controller::srv::InverseKinematics_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const controller::srv::InverseKinematics_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<controller::srv::InverseKinematics_Request *>(
    untyped_ros_message);
...
{
  return &controller::srv::typesupport_fastrtps_cpp::_InverseKinematics_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, controller, srv, InverseKinematics_Request)() {
  return &controller::srv::typesupport_fastrtps_cpp::_InverseKinematics_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_controller
cdr_serialize(
  const controller::srv::InverseKinematics_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: joint_angles
  {
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  controller::srv::InverseKinematics_Response & ros_message)
{
  // Member: joint_angles
  {
    cdr >> ros_message.joint_angles;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = controller::srv::InverseKinematics_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const controller::srv::InverseKinematics_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<controller::srv::InverseKinematics_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &controller::srv::typesupport_fastrtps_cpp::_InverseKinematics_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, controller, srv, InverseKinematics_Response)() {
  return &controller::srv::typesupport_fastrtps_cpp::_InverseKinematics_Response__handle;
}
...
{
  return &controller::srv::typesupport_fastrtps_cpp::_InverseKinematics__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, controller, srv, InverseKinematics)() {
  return &controller::srv::typesupport_fastrtps_cpp::_InverseKinematics__handle;
}
