...
class Localization(metaclass=Metaclass_Localization):
    ...
    def __init__(self, **kwargs):
        ...
        self.valid_flag = kwargs.get('valid_flag', int())
        self.error_msgs = kwargs.get('error_msgs', int())
    ...
    def __eq__(self, other):
        ...
        if self.confidence != other.confidence:
            return False
        if self.valid_flag != other.valid_flag:
            return False
        if self.error_msgs != other.error_msgs:
            return False
    ...
    @builtins.property
    def valid_flag(self):
        """Message field 'valid_flag'."""
        return self._valid_flag

    @valid_flag.setter
    def valid_flag(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'valid_flag' field must be of type 'int'"
            assert value >= -128 and value < 128, \
                "The 'valid_flag' field must be an integer in [-128, 127]"
        self._valid_flag = value

    @builtins.property
    def error_msgs(self):
        """Message field 'error_msgs'."""
        return self._error_msgs

    @error_msgs.setter
    def error_msgs(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'error_msgs' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'error_msgs' field must be an integer in [-2147483648, 2147483647]"
        self._error_msgs = value
