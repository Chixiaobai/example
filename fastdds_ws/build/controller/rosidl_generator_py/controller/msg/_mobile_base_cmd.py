...
class Metaclass_MobileBaseCmd(type):
    """Metaclass of message 'MobileBaseCmd'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'controller.msg.MobileBaseCmd')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__mobile_base_cmd
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__mobile_base_cmd
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__mobile_base_cmd
            cls._TYPE_SUPPORT = module.type_support_msg__msg__mobile_base_cmd
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__mobile_base_cmd
...
class MobileBaseCmd(metaclass=Metaclass_MobileBaseCmd):
    """Message class 'MobileBaseCmd'."""
    ...
    def lifetime(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'lifetime' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
