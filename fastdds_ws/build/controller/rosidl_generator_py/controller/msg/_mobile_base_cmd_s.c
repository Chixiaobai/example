...
bool controller__msg__mobile_base_cmd__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("controller.msg._mobile_base_cmd.MobileBaseCmd", full_classname_dest, 45) == 0);
  }
  controller__msg__MobileBaseCmd * ros_message = _ros_message;
  {  // linear_velocity
  ...
  {  // lifetime
    ...
    assert(PyFloat_Check(field));
    ros_message->lifetime = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of MobileBaseCmd */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("controller.msg._mobile_base_cmd");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MobileBaseCmd");
