...
class Metaclass_RealTimeBodyTcpCartesian(type):
    """Metaclass of message 'RealTimeBodyTcpCartesian'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'controller.msg.RealTimeBodyTcpCartesian')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__real_time_body_tcp_cartesian
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__real_time_body_tcp_cartesian
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__real_time_body_tcp_cartesian
            cls._TYPE_SUPPORT = module.type_support_msg__msg__real_time_body_tcp_cartesian
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__real_time_body_tcp_cartesian
...
class RealTimeBodyTcpCartesian(metaclass=Metaclass_RealTimeBodyTcpCartesian):
    """Message class 'RealTimeBodyTcpCartesian'."""
    ...
    def left_arm(self, value):
        if isinstance(value, numpy.ndarray):
            ...
            assert value.size == 6, \
                "The 'left_arm' numpy.ndarray() must have a size of 6"
    ...
    def right_arm(self, value):
        if isinstance(value, numpy.ndarray):
            ...
            assert value.size == 6, \
                "The 'right_arm' numpy.ndarray() must have a size of 6"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 all(not (val < -1.7976931348623157e+308 or val > 1.7976931348623157e+308) or math.isinf(val) for val in value)), \
                "The 'right_arm' field must be a set or sequence with length 6 and each value of type 'float' and each double in [-.000000, .000000]"
    ...
    def torso(self, value):
        if isinstance(value, numpy.ndarray):
            ...
            assert value.size == 6, \
                "The 'torso' numpy.ndarray() must have a size of 6"
            self._torso = value
            return
        if __debug__:
            from collections.abc import Sequence
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 all(not (val < -1.7976931348623157e+308 or val > 1.7976931348623157e+308) or math.isinf(val) for val in value)), \
                "The 'torso' field must be a set or sequence with length 6 and each value of type 'float' and each double in [-.000000, .000000]"
