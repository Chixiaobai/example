...
bool controller__msg__tcp_pose_params__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("controller.msg._tcp_pose_params.TcpPoseParams", full_classname_dest, 45) == 0);
  }
  controller__msg__TcpPoseParams * ros_message = _ros_message;
  {  // type
...
{
  /* NOTE(esteve): Call constructor of TcpPoseParams */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("controller.msg._tcp_pose_params");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TcpPoseParams");
