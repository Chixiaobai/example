...
bool controller__msg__real_time_body_tcp_cartesian__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("controller.msg._real_time_body_tcp_cartesian.RealTimeBodyTcpCartesian", full_classname_dest, 69) == 0);
  }
  controller__msg__RealTimeBodyTcpCartesian * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of RealTimeBodyTcpCartesian */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("controller.msg._real_time_body_tcp_cartesian");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RealTimeBodyTcpCartesian");
