...
static const _ErrorClear_Request_type_support_symbol_names_t _ErrorClear_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, controller, srv, ErrorClear_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, controller, srv, ErrorClear_Request)),
  }
};
...
{
  return &::controller::srv::rosidl_typesupport_cpp::ErrorClear_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, controller, srv, ErrorClear_Request)() {
  return get_message_type_support_handle<controller::srv::ErrorClear_Request>();
}
...
static const _ErrorClear_Response_type_support_symbol_names_t _ErrorClear_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, controller, srv, ErrorClear_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, controller, srv, ErrorClear_Response)),
  }
};
...
{
  return &::controller::srv::rosidl_typesupport_cpp::ErrorClear_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, controller, srv, ErrorClear_Response)() {
  return get_message_type_support_handle<controller::srv::ErrorClear_Response>();
}
...
static const _ErrorClear_type_support_symbol_names_t _ErrorClear_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, controller, srv, ErrorClear)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, controller, srv, ErrorClear)),
  }
};
...
{
  return &::controller::srv::rosidl_typesupport_cpp::ErrorClear_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, controller, srv, ErrorClear)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<controller::srv::ErrorClear>();
}
