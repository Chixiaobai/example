...
static const _InverseKinematics_Request_type_support_symbol_names_t _InverseKinematics_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, controller, srv, InverseKinematics_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, controller, srv, InverseKinematics_Request)),
  }
};
...
{
  return &::controller::srv::rosidl_typesupport_cpp::InverseKinematics_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, controller, srv, InverseKinematics_Request)() {
  return get_message_type_support_handle<controller::srv::InverseKinematics_Request>();
}
...
static const _InverseKinematics_Response_type_support_symbol_names_t _InverseKinematics_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, controller, srv, InverseKinematics_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, controller, srv, InverseKinematics_Response)),
  }
};
...
{
  return &::controller::srv::rosidl_typesupport_cpp::InverseKinematics_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, controller, srv, InverseKinematics_Response)() {
  return get_message_type_support_handle<controller::srv::InverseKinematics_Response>();
}
...
static const _InverseKinematics_type_support_symbol_names_t _InverseKinematics_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, controller, srv, InverseKinematics)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, controller, srv, InverseKinematics)),
  }
};
...
{
  return &::controller::srv::rosidl_typesupport_cpp::InverseKinematics_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, controller, srv, InverseKinematics)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<controller::srv::InverseKinematics>();
}
