...
#include "controller/srv/detail/inverse_kinematics__rosidl_typesupport_fastrtps_c.h"
...
using _InverseKinematics_Request__ros_msg_type = controller__srv__InverseKinematics_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: if_use_whole_body
  {
    cdr << (ros_message->if_use_whole_body ? true : false);
  }
  ...
  void * untyped_ros_message)
{
  ...
  _InverseKinematics_Request__ros_msg_type * ros_message = static_cast<_InverseKinematics_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: pose
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: if_use_whole_body
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->if_use_whole_body = tmp ? true : false;
  }
...
size_t get_serialized_size_controller__srv__InverseKinematics_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _InverseKinematics_Request__ros_msg_type * ros_message = static_cast<const _InverseKinematics_Request__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name if_use_whole_body
  {
    size_t item_size = sizeof(ros_message->if_use_whole_body);
...
static uint32_t _InverseKinematics_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_controller__srv__InverseKinematics_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_controller
size_t max_serialized_size_controller__srv__InverseKinematics_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = controller__srv__InverseKinematics_Request;
    is_plain =
      (
      offsetof(DataType, if_use_whole_body) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _InverseKinematics_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_controller__srv__InverseKinematics_Request(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, controller, srv, InverseKinematics_Request)() {
...
using _InverseKinematics_Response__ros_msg_type = controller__srv__InverseKinematics_Response;
  ...
  void * untyped_ros_message)
{
  ...
  _InverseKinematics_Response__ros_msg_type * ros_message = static_cast<_InverseKinematics_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: joint_angles
  {
    uint32_t cdrSize;
    cdr >> cdrSize;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_controller
size_t get_serialized_size_controller__srv__InverseKinematics_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _InverseKinematics_Response__ros_msg_type * ros_message = static_cast<const _InverseKinematics_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_controller__srv__InverseKinematics_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_controller
size_t max_serialized_size_controller__srv__InverseKinematics_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = controller__srv__InverseKinematics_Response;
    is_plain =
      (
...
static size_t _InverseKinematics_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_controller__srv__InverseKinematics_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, controller, srv, InverseKinematics_Response)() {
...
// already included above
// #include "controller/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "controller/srv/inverse_kinematics.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, controller, srv, InverseKinematics)() {
