...
#include "controller/msg/detail/localization__rosidl_typesupport_fastrtps_c.h"
...
using _Localization__ros_msg_type = controller__msg__Localization;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: valid_flag
  {
    cdr << ros_message->valid_flag;
  }

  // Field name: error_msgs
  {
    cdr << ros_message->error_msgs;
  }
...
size_t get_serialized_size_controller__msg__Localization(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Localization__ros_msg_type * ros_message = static_cast<const _Localization__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name valid_flag
  {
    size_t item_size = sizeof(ros_message->valid_flag);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name error_msgs
  {
    size_t item_size = sizeof(ros_message->error_msgs);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name trajectory_id
...
static uint32_t _Localization__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_controller__msg__Localization(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_controller
size_t max_serialized_size_controller__msg__Localization(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = controller__msg__Localization;
    is_plain =
      (
...
static size_t _Localization__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_controller__msg__Localization(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, controller, msg, Localization)() {
