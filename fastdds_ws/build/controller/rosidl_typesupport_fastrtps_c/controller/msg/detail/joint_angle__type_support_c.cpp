...
#include "controller/msg/detail/joint_angle__rosidl_typesupport_fastrtps_c.h"
...
using _JointAngle__ros_msg_type = controller__msg__JointAngle;
...
static uint32_t _JointAngle__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_controller__msg__JointAngle(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = controller__msg__JointAngle;
    is_plain =
      (
...
static size_t _JointAngle__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_controller__msg__JointAngle(
