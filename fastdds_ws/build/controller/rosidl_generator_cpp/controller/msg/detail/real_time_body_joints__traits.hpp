...
#ifndef CONTROLLER__MSG__DETAIL__REAL_TIME_BODY_JOINTS__TRAITS_HPP_
#define CONTROLLER__MSG__DETAIL__REAL_TIME_BODY_JOINTS__TRAITS_HPP_
...
inline std::string to_yaml(const RealTimeBodyJoints & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const controller::msg::RealTimeBodyJoints & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const controller::msg::RealTimeBodyJoints & msg)
{
  return controller::msg::to_yaml(msg);
}

template<>
inline const char * data_type<controller::msg::RealTimeBodyJoints>()
{
  return "controller::msg::RealTimeBodyJoints";
}

template<>
inline const char * name<controller::msg::RealTimeBodyJoints>()
{
  return "controller/msg/RealTimeBodyJoints";
}

template<>
struct has_fixed_size<controller::msg::RealTimeBodyJoints>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<controller::msg::RealTimeBodyJoints>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<controller::msg::RealTimeBodyJoints>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // CONTROLLER__MSG__DETAIL__REAL_TIME_BODY_JOINTS__TRAITS_HPP_
