...
public:
   ...
   * ReliabilityQosPolicy.max_blocking_time on PublisherAttributes defines this
   * period of time.
   * @par Calling example:
   ...
   * instance. It gives and opportunity to the middleware to pre-configure
   ...
   * more of that data instance. Also indicates that the middleware can locally
   * remove all information regarding that instance.
