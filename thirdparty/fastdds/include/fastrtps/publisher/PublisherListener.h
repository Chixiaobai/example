...
/**
 * Class PublisherListener, allows the end user to implement callbacks triggered
 * by certain events.
...
public:
  ...
  /**
   * This method is called when the Publisher is matched (or unmatched) against
   * an endpoint.
   ...
   */
  virtual void
  on_offered_deadline_missed(Publisher *pub,
