...
protected:
  ...
  MemberId id_; // MemberId, it should be filled automatically when the member
                // is added.
...
public:
  ...
  RTPS_DllAPI MemberDescriptor(MemberId id, const std::string &name,
  ...
  RTPS_DllAPI DynamicType_ptr get_type() const { return type_; }
