...
/*!
 * @brief This class represents the structure StringSTypeDefn defined by the
...
public:
   ...
   */
  RTPS_DllAPI static size_t getCdrSerializedSize(const StringSTypeDefn &data,
  ...
  RTPS_DllAPI bool
  consistent(const StringSTypeDefn &x,
             const fastdds::dds::TypeConsistencyEnforcementQosPolicy
                 &consistency) const;

  RTPS_DllAPI bool
  consistent(const StringLTypeDefn &x,
             const fastdds::dds::TypeConsistencyEnforcementQosPolicy
                 &consistency) const;
...
/*!
 * @brief This class represents the structure StringLTypeDefn defined by the
 * user in the IDL file.
 * @ingroup TYPES_MODULE
 */
...
public:
   ...
   * @param _bound New value for member bound
   */
  RTPS_DllAPI inline void bound(LBound _bound) { m_bound = _bound; }

  /*!
   * @brief This function returns the value of member bound
   * @return Value of member bound
   */
  RTPS_DllAPI inline LBound bound() const { return m_bound; }
   ...
   * @return Serialized size.
   */
  RTPS_DllAPI static size_t getCdrSerializedSize(const StringLTypeDefn &data,
                                                 size_t current_alignment = 0);
...
/*!
 * @brief This class represents the structure PlainCollectionHeader defined by
...
public:
   ...
   */
  RTPS_DllAPI inline EquivalenceKind equiv_kind() const { return m_equiv_kind; }

  /*!
   * @brief This function returns a reference to member equiv_kind
   * @return Reference to member equiv_kind
   */
  RTPS_DllAPI inline EquivalenceKind &equiv_kind() { return m_equiv_kind; }
  ...
  getCdrSerializedSize(const PlainCollectionHeader &data,
                       size_t current_alignment = 0);
  ...
  RTPS_DllAPI bool
  consistent(const PlainCollectionHeader &x,
             const fastdds::dds::TypeConsistencyEnforcementQosPolicy
                 &consistency) const;
...
/*!
 * @brief This class represents the structure PlainSequenceSElemDefn defined by
 * the user in the IDL file.
 * @ingroup TYPES_MODULE
 */
...
public:
  ...
  /*!
   * @brief Copy constructor.
   * @param x Reference to the object PlainSequenceSElemDefn that will be
   * copied.
   */
   ...
   */
  RTPS_DllAPI PlainSequenceSElemDefn &
  operator=(const PlainSequenceSElemDefn &x);
   ...
   */
  RTPS_DllAPI inline PlainCollectionHeader &header() { return m_header; }
   ...
   */
  RTPS_DllAPI void
  element_identifier(const TypeIdentifier *_element_identifier);
   ...
   */
  RTPS_DllAPI static size_t
  getCdrSerializedSize(const PlainSequenceSElemDefn &data,
                       size_t current_alignment = 0);
  ...
  RTPS_DllAPI bool
  consistent(const PlainSequenceSElemDefn &x,
             const fastdds::dds::TypeConsistencyEnforcementQosPolicy
                 &consistency) const;
...
/*!
 * @brief This class represents the structure PlainSequenceLElemDefn defined by
 * the user in the IDL file.
 * @ingroup TYPES_MODULE
 */
...
public:
  ...
  /*!
   * @brief Copy constructor.
   * @param x Reference to the object PlainSequenceLElemDefn that will be
   * copied.
   */
   ...
   */
  RTPS_DllAPI PlainSequenceLElemDefn &
  operator=(const PlainSequenceLElemDefn &x);
   ...
   */
  RTPS_DllAPI static size_t
  getCdrSerializedSize(const PlainSequenceLElemDefn &data,
                       size_t current_alignment = 0);
  ...
  RTPS_DllAPI bool
  consistent(const PlainSequenceLElemDefn &x,
             const fastdds::dds::TypeConsistencyEnforcementQosPolicy
                 &consistency) const;
...
/*!
 * @brief This class represents the structure PlainArraySElemDefn defined by the
 * user in the IDL file.
 * @ingroup TYPES_MODULE
 */
...
public:
   ...
   */
  RTPS_DllAPI inline SBoundSeq &array_bound_seq() { return m_array_bound_seq; }
   ...
   */
  RTPS_DllAPI static size_t
  getCdrSerializedSize(const PlainArraySElemDefn &data,
                       size_t current_alignment = 0);
  ...
  RTPS_DllAPI bool
  consistent(const PlainArraySElemDefn &x,
             const fastdds::dds::TypeConsistencyEnforcementQosPolicy
                 &consistency) const;
...
/*!
 * @brief This class represents the structure PlainArrayLElemDefn defined by the
 * user in the IDL file.
 * @ingroup TYPES_MODULE
 */
...
public:
   ...
   * @return Reference to member array_bound_seq
   */
  RTPS_DllAPI inline LBoundSeq &array_bound_seq() { return m_array_bound_seq; }
   ...
   */
  RTPS_DllAPI static size_t
  getCdrSerializedSize(const PlainArrayLElemDefn &data,
                       size_t current_alignment = 0);
  ...
  RTPS_DllAPI bool
  consistent(const PlainArrayLElemDefn &x,
             const fastdds::dds::TypeConsistencyEnforcementQosPolicy
                 &consistency) const;
...
/*!
 * @brief This class represents the structure PlainMapSTypeDefn defined by the
 * user in the IDL file.
 * @ingroup TYPES_MODULE
 */
...
public:
   ...
   */
  RTPS_DllAPI inline CollectionElementFlag &key_flags() { return m_key_flags; }
   ...
   * @return Serialized size.
   */
  RTPS_DllAPI static size_t getCdrSerializedSize(const PlainMapSTypeDefn &data,
                                                 size_t current_alignment = 0);
  ...
  RTPS_DllAPI bool
  consistent(const PlainMapSTypeDefn &x,
             const fastdds::dds::TypeConsistencyEnforcementQosPolicy
                 &consistency) const;
...
/*!
 * @brief This class represents the structure PlainMapLTypeDefn defined by the
 * user in the IDL file.
 * @ingroup TYPES_MODULE
 */
...
public:
   ...
   * @return Serialized size.
   */
  RTPS_DllAPI static size_t getCdrSerializedSize(const PlainMapLTypeDefn &data,
                                                 size_t current_alignment = 0);
  ...
  RTPS_DllAPI bool
  consistent(const PlainMapLTypeDefn &x,
             const fastdds::dds::TypeConsistencyEnforcementQosPolicy
                 &consistency) const;
...
/*!
 * @brief This class represents the structure StronglyConnectedComponentId
...
public:
  ...
  /*!
   * @brief Copy constructor.
   * @param x Reference to the object StronglyConnectedComponentId that will be
   * copied.
   */
  RTPS_DllAPI
   ...
   */
  RTPS_DllAPI StronglyConnectedComponentId &
  operator=(const StronglyConnectedComponentId &x);
   ...
   */
  RTPS_DllAPI StronglyConnectedComponentId &
  operator=(StronglyConnectedComponentId &&x);
  ...
  sc_component_id(const TypeObjectHashId &_sc_component_id) {
   ...
   */
  RTPS_DllAPI inline int32_t scc_length() const { return m_scc_length; }

  /*!
   * @brief This function returns a reference to member scc_length
   * @return Reference to member scc_length
   */
  RTPS_DllAPI inline int32_t &scc_length() { return m_scc_length; }
   ...
   */
  RTPS_DllAPI inline int32_t scc_index() const { return m_scc_index; }

  /*!
   * @brief This function returns a reference to member scc_index
   * @return Reference to member scc_index
   */
  RTPS_DllAPI inline int32_t &scc_index() { return m_scc_index; }
   ...
   */
  RTPS_DllAPI static size_t
  getCdrSerializedSize(const StronglyConnectedComponentId &data,
                       size_t current_alignment = 0);
  ...
  RTPS_DllAPI bool
  consistent(const StronglyConnectedComponentId &x,
             const fastdds::dds::TypeConsistencyEnforcementQosPolicy
                 &consistency) const;
...
/*!
 * @brief This class represents the structure ExtendedTypeDefn defined by the
 * user in the IDL file.
 * @ingroup TYPES_MODULE
 */
...
public:
   ...
   * @return Serialized size.
   */
  RTPS_DllAPI static size_t getCdrSerializedSize(const ExtendedTypeDefn &data,
                                                 size_t current_alignment = 0);
  ...
  RTPS_DllAPI bool
  consistent(const ExtendedTypeDefn &x,
             const fastdds::dds::TypeConsistencyEnforcementQosPolicy
                 &consistency) const;
};
