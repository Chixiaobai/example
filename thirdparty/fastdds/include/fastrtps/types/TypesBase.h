...
public:
  ...
  ReturnCode_t(uint32_t e) { value_ = e; }
...
RTPS_DllAPI inline bool operator==(ReturnCode_t::ReturnCodeValue a,
...
RTPS_DllAPI inline bool operator==(uint32_t a, const ReturnCode_t &b) {
  return b.operator==(a);
}
...
public:
  ...
  static size_t getCdrSerializedSize(const MemberFlag &,
