...
public:
   ...
   */
  RTPS_DllAPI void
  sc_component_id(StronglyConnectedComponentId _sc_component_id);
   ...
   */
  RTPS_DllAPI static size_t getCdrSerializedSize(const TypeIdentifier &data,
  ...
  RTPS_DllAPI bool
  consistent(const TypeIdentifier &x,
