...
/*!
 * @brief This class represents the structure ExtendedAnnotationParameterValue
...
public:
   ...
   * @param x Reference to the object ExtendedAnnotationParameterValue that will
   * be copied.
   */
  RTPS_DllAPI
   ...
   */
  RTPS_DllAPI ExtendedAnnotationParameterValue &
  operator=(const ExtendedAnnotationParameterValue &x);
   ...
   */
  RTPS_DllAPI ExtendedAnnotationParameterValue &
  operator=(ExtendedAnnotationParameterValue &&x);
  ...
  getCdrSerializedSize(const ExtendedAnnotationParameterValue &data,
   ...
   */
  RTPS_DllAPI static size_t
  getKeyMaxCdrSerializedSize(size_t current_alignment = 0);
...
/*!
 * @brief This class represents the union AnnotationParameterValue defined by
...
public:
  ...
  /*!
   * @brief Copy constructor.
   * @param x Reference to the object AnnotationParameterValue that will be
   * copied.
   */
   ...
   */
  RTPS_DllAPI AnnotationParameterValue &
  operator=(const AnnotationParameterValue &x);
   ...
   */
  RTPS_DllAPI void
  extended_value(const ExtendedAnnotationParameterValue &_extended_value);
   ...
   */
  RTPS_DllAPI void
  extended_value(ExtendedAnnotationParameterValue &&_extended_value);
   ...
   */
  RTPS_DllAPI static size_t
  getCdrSerializedSize(const AnnotationParameterValue &data,
                       size_t current_alignment = 0);
...
/*!
 * @brief This class represents the structure AppliedAnnotationParameter defined
...
public:
  ...
  /*!
   * @brief Copy constructor.
   * @param x Reference to the object AppliedAnnotationParameter that will be
   * copied.
   */
   ...
   */
  RTPS_DllAPI AppliedAnnotationParameter &
  operator=(const AppliedAnnotationParameter &x);
   ...
   */
  RTPS_DllAPI AppliedAnnotationParameter &
  operator=(AppliedAnnotationParameter &&x);
   ...
   */
  RTPS_DllAPI static size_t
  getCdrSerializedSize(const AppliedAnnotationParameter &data,
                       size_t current_alignment = 0);
...
/*
   ...
   public:
    ...
    inline void paramname_hash(const NameHash &_paramname_hash) {
   m_paramname_hash = _paramname_hash; } inline void paramname_hash(NameHash
   &&_paramname_hash) { m_paramname_hash = std::move(_paramname_hash); } inline
   const NameHash& paramname_hash() const { return m_paramname_hash; } inline
   NameHash& paramname_hash() { return m_paramname_hash; }

    inline void value(const AnnotationParameterValue &_value) { m_value =
   _value; } inline void value(AnnotationParameterValue &&_value) { m_value =
   std::move(_value); } inline const AnnotationParameterValue& value() const {
   return m_value; } inline AnnotationParameterValue& value() { return m_value;
   }

    static size_t getCdrSerializedSize(const AppliedAnnotationParameter& data,
   size_t current_alignment = 0); void serialize(eprosima::fastcdr::Cdr &cdr)
   const; void deserialize(eprosima::fastcdr::Cdr &cdr); static size_t
   getKeyMaxCdrSerializedSize(size_t current_alignment = 0); static bool
   isKeyDefined(); void serializeKey(eprosima::fastcdr::Cdr &cdr) const;
...
public:
  ...
  RTPS_DllAPI static size_t getCdrSerializedSize(const AppliedAnnotation &data,
                                                 size_t current_alignment = 0);
  RTPS_DllAPI void serialize(eprosima::fastcdr::Cdr &cdr) const;
  RTPS_DllAPI void deserialize(eprosima::fastcdr::Cdr &cdr);
  RTPS_DllAPI static size_t
...
public:
  ...
  RTPS_DllAPI AppliedVerbatimAnnotation &
  operator=(const AppliedVerbatimAnnotation &x);

  RTPS_DllAPI AppliedVerbatimAnnotation &
  operator=(AppliedVerbatimAnnotation &&x);

  inline void placement(const std::string &_placement) {
    m_placement = _placement;
  }

  inline void placement(std::string &&_placement) {
  ...
  inline void language(std::string &&_language) {
  ...
  RTPS_DllAPI static size_t
  getCdrSerializedSize(const AppliedVerbatimAnnotation &data,
                       size_t current_alignment = 0);
...
public:
  ...
  RTPS_DllAPI AppliedBuiltinMemberAnnotations &
  operator=(const AppliedBuiltinMemberAnnotations &x);

  RTPS_DllAPI AppliedBuiltinMemberAnnotations &
  operator=(AppliedBuiltinMemberAnnotations &&x);
  ...
  inline void hash_id(std::string &&_hash_id) {
  ...
  RTPS_DllAPI static size_t
  getCdrSerializedSize(const AppliedBuiltinMemberAnnotations &data,
                       size_t current_alignment = 0);
  ...
  RTPS_DllAPI bool
  operator==(const AppliedBuiltinMemberAnnotations &other) const;
