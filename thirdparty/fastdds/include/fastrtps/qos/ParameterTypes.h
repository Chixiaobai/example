...
using ParameterBuiltinEndpointSet_t =
    fastdds::dds::ParameterBuiltinEndpointSet_t;
...
using ParameterParticipantSecurityInfo_t =
    fastdds::dds::ParameterParticipantSecurityInfo_t;
using ParameterEndpointSecurityInfo_t =
    fastdds::dds::ParameterEndpointSecurityInfo_t;
#endif
