...
using DestinationOrderQosPolicyKind =
    fastdds::dds::DestinationOrderQosPolicyKind;
constexpr DestinationOrderQosPolicyKind
...
using PresentationQosPolicyAccessScopeKind =
...
using TypeConsistencyEnforcementQosPolicy =
    fastdds::dds::TypeConsistencyEnforcementQosPolicy;
