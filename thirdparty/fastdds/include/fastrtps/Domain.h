...
public:
   ...
   */
  RTPS_DllAPI DEPRECATED static Participant *
  createParticipant(const std::string &participant_profile,
   ...
   */
  RTPS_DllAPI DEPRECATED static Participant *
  createParticipant(const ParticipantAttributes &att,
                    ParticipantListener *listen = nullptr);
   ...
   * @param part Pointer to the participant where you want to create the
   * Publisher.
   ...
   */
  RTPS_DllAPI static Publisher *
  createPublisher(Participant *part, const std::string &publisher_profile,
   ...
   */
  RTPS_DllAPI static Publisher *
  createPublisher(Participant *part, const PublisherAttributes &att,
                  PublisherListener *listen = nullptr);
   ...
   */
  RTPS_DllAPI static Subscriber *
  createSubscriber(Participant *part, const std::string &subscriber_profile,
   ...
   */
  RTPS_DllAPI static Subscriber *
  createSubscriber(Participant *part, const SubscriberAttributes &att,
                   SubscriberListener *listen = nullptr);
   ...
   */
  RTPS_DllAPI static bool getRegisteredType(Participant *part,
                                            const char *typeName,
   ...
   */
  RTPS_DllAPI static bool registerType(Participant *part,
                                       fastdds::dds::TopicDataType *type);
   ...
   * @return True if correctly registered.
   */
  RTPS_DllAPI static bool registerDynamicType(Participant *part,
   ...
   */
  RTPS_DllAPI static bool unregisterType(Participant *part,
                                         const char *typeName);

  /**
   * Stop and remove all participants, publishers and subscribers in this
   * Domain.
   */
   ...
   */
  RTPS_DllAPI static bool
  loadXMLProfilesFile(const std::string &xml_profile_file);
   ...
   * @return True if correctly loaded.
   */
  RTPS_DllAPI static bool loadXMLProfilesString(const char *data,
                                                size_t length);
