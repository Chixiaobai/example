...
/**
 * Class XMLEndpointParser used to parse the XML file that contains information
...
public:
   ...
   * @param pdata Pointer to the RTPSParticipantInfo where the reader must be
   * added.
   ...
   */
  XMLP_ret lookforReader(const char *partname, uint16_t id,
   ...
   * @return True if found
   */
  XMLP_ret lookforWriter(const char *partname, uint16_t id,
