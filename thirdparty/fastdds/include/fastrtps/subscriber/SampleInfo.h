...
/**
 * Class SampleInfo_t with information that is provided along a sample when
 * reading data from a Subscriber.
 * @ingroup FASTRTPS_MODULE
 */
class RTPS_DllAPI SampleInfo_t {
public:
  SampleInfo_t()
      : sampleKind(rtps::ALIVE), ownershipStrength(0),
  ...
  //! Ownership Strength of the writer of the sample (0 if the ownership kind is
