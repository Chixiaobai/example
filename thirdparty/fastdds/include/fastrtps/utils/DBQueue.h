...
/**
 * Double buffered, threadsafe queue for MPSC (multi-producer, single-consumer)
 * comms.
 */
template <class T> class DBQueue {

public:
  DBQueue() : mForegroundQueue(&mQueueAlpha), mBackgroundQueue(&mQueueBeta) {}
