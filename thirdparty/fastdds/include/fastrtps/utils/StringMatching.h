...
namespace rtps {
/**
 * Class StringMatching used to match different strings against each other as
 defined by the POSIX fnmatch API (1003.2-1992 section B.6).
...
public:
   ...
   * It checks if the input strings match. Any of the strings or both can be a
   * pattern.
   */
  static bool matchString(const char *input1, const char *input2);

  /** Static method to match a string to a pattern.
   * It checks the string specified by the input argument to see if it matches
