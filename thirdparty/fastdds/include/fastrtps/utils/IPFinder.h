...
public:
  ...
  /**
   * Structure info_MAC with information about a specific MAC obtained from a
   * NIC.
   */
   ...
   * @param[out] locators List of locators to be populated with the IP4
   * addresses.
   */
  RTPS_DllAPI static bool getIP4Address(LocatorList_t *locators);
  /**
   * Get the IP6Adresses in all interfaces.
   * @param[out] locators List of locators to be populated with the IP6
   * addresses.
   */
   ...
   * Will return all unique MAC addresses for eadh of the interfaces returned by
   * getAllIPAddress
