...
public:
  ...
  explicit strand(
      const Executor1 &e,
      typename enable_if<conditional<!is_same<Executor1, strand>::value,
  ...
  typename enable_if<can_require<const Executor &, Property>::value,
                     strand<typename decay<typename require_result<
  ...
  typename enable_if<can_prefer<const Executor &, Property>::value,
                     strand<typename decay<typename prefer_result<
                         const Executor &, Property>::type>::type>>::type
...
private:
  ...
  static implementation_type create_implementation(
      ...
      typename enable_if<
          can_query<InnerExecutor, execution::context_t>::value>::type * = 0) {
...
struct execute_member<strand<Executor>, Function,
                      typename enable_if<execution::can_execute<
                          const Executor &, Function>::value>::type> {
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
