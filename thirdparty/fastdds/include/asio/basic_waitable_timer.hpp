...
public:
  ...
  basic_waitable_timer(
      ...
      typename enable_if<is_convertible<Executor1, Executor>::value>::type * =
          0)
      : impl_(std::move(other.impl_)) {}
   ...
   */
  template <typename Executor1>
  typename enable_if<is_convertible<Executor1, Executor>::value,
                     basic_waitable_timer &>::type
  ...
  async_wait(ASIO_MOVE_ARG(WaitHandler)
