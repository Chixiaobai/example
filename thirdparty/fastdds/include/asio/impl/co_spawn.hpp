...
awaitable<void, Executor> co_spawn_entry_point(awaitable<T, Executor> *,
                                               Executor ex, F f,
                                               Handler handler) {
...
awaitable<void, Executor> co_spawn_entry_point(awaitable<void, Executor> *,
                                               Executor ex, F f,
                                               Handler handler) {
  auto spawn_work = make_co_spawn_work_guard(ex);
  auto handler_work =
...
inline ASIO_INITFN_AUTO_RESULT_TYPE(CompletionToken,
    ...
    co_spawn(const Executor &ex, awaitable<T, AwaitableExecutor> a,
             ...
             typename enable_if<
                 ...
                 is_convertible<Executor, AwaitableExecutor>::value>::type *) {
...
inline ASIO_INITFN_AUTO_RESULT_TYPE(
  ...
  return async_initiate<CompletionToken,
                        typename detail::awaitable_signature<
                            typename result_of<F()>::type>::type>(
      detail::initiate_co_spawn<typename result_of<F()>::type::executor_type>(
          ex),
