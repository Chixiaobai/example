...
inline std::size_t read_until(
  ...
  std::size_t bytes_transferred = read_until(
      s, ASIO_MOVE_CAST(DynamicBuffer_v1)(buffers), match_condition, ec);
  asio::detail::throw_error(ec, "read_until");
  return bytes_transferred;
}
...
inline std::size_t read_until(
    SyncReadStream &s, asio::basic_streambuf<Allocator> &b,
    MatchCondition match_condition,
...
inline std::size_t read_until(
  ...
  asio::error_code ec;
  std::size_t bytes_transferred = read_until(
      s, ASIO_MOVE_CAST(DynamicBuffer_v2)(buffers), match_condition, ec);
  asio::detail::throw_error(ec, "read_until");
  return bytes_transferred;
}
...
public:
  ...
  read_until_delim_op_v1(AsyncReadStream &stream,
                         ASIO_MOVE_ARG(BufferSequence) buffers, char delim,
                         ReadHandler &handler)
      : stream_(stream), buffers_(ASIO_MOVE_CAST(BufferSequence)(buffers)),
...
asio_handler_allocate(std::size_t size,
                      read_until_delim_op_v1<AsyncReadStream, DynamicBuffer_v1,
...
template <typename AsyncReadStream, typename DynamicBuffer_v1,
          typename ReadHandler>
inline asio_handler_deallocate_is_deprecated asio_handler_deallocate(
...
public:
  ...
  void operator()(ASIO_MOVE_ARG(ReadHandler) handler,
                  ASIO_MOVE_ARG(DynamicBuffer_v1) buffers, char delim) const {
    ...
    read_until_delim_op_v1<AsyncReadStream,
        ...
        stream_, ASIO_MOVE_CAST(DynamicBuffer_v1)(buffers), delim,
...
struct associated_allocator<detail::read_until_delim_op_v1<
...
struct associated_executor<detail::read_until_delim_op_v1<
                               AsyncReadStream, DynamicBuffer_v1, ReadHandler>,
                           Executor>
...
public:
  ...
  read_until_delim_string_op_v1(read_until_delim_string_op_v1 &&other)
      : stream_(other.stream_),
        buffers_(ASIO_MOVE_CAST(DynamicBuffer_v1)(other.buffers_)),
        delim_(ASIO_MOVE_CAST(std::string)(other.delim_)), start_(other.start_),
        search_position_(other.search_position_),
        handler_(ASIO_MOVE_CAST(ReadHandler)(other.handler_)) {}
#endif // defined(ASIO_HAS_MOVE)
...
template <typename Function, typename AsyncReadStream,
          typename DynamicBuffer_v1, typename ReadHandler>
inline asio_handler_invoke_is_deprecated asio_handler_invoke(
    Function &function,
    read_until_delim_string_op_v1<AsyncReadStream, DynamicBuffer_v1,
                                  ReadHandler> *this_handler) {
  asio_handler_invoke_helpers::invoke(function, this_handler->handler_);
...
template <typename AsyncReadStream, typename DynamicBuffer_v1,
          typename ReadHandler, typename Allocator>
struct associated_allocator<detail::read_until_delim_string_op_v1<
                                AsyncReadStream, DynamicBuffer_v1, ReadHandler>,
                            Allocator> {
  typedef typename associated_allocator<ReadHandler, Allocator>::type type;

  static type get(const detail::read_until_delim_string_op_v1<
...
template <typename AsyncReadStream, typename DynamicBuffer_v1,
          typename ReadHandler, typename Executor>
struct associated_executor<detail::read_until_delim_string_op_v1<
                               AsyncReadStream, DynamicBuffer_v1, ReadHandler>,
                           Executor>
    : detail::associated_executor_forwarding_base<ReadHandler, Executor> {
  typedef typename associated_executor<ReadHandler, Executor>::type type;
      ...
      for (;;) {
        {
          ...
          boost::match_results<
              ...
              match_results;
          bool match =
              regex_search(start_pos, end, match_results, expr_,
                           boost::match_default | boost::match_partial);
...
inline asio_handler_allocate_is_deprecated
asio_handler_allocate(std::size_t size,
                      read_until_expr_op_v1<AsyncReadStream, DynamicBuffer_v1,
                                            RegEx, ReadHandler> *this_handler) {
#if defined(ASIO_NO_DEPRECATED)
  asio_handler_alloc_helpers::allocate(size, this_handler->handler_);
  return asio_handler_allocate_is_no_longer_used();
#else  // defined(ASIO_NO_DEPRECATED)
...
public:
  ...
  void operator()(ASIO_MOVE_ARG(ReadHandler) handler,
    ...
    read_until_expr_op_v1<AsyncReadStream,
                          typename decay<DynamicBuffer_v1>::type, RegEx,
                          typename decay<ReadHandler>::type>(
        stream_, ASIO_MOVE_CAST(DynamicBuffer_v1)(buffers), expr,
        handler2.value)(asio::error_code(), 0, 1);
  }
...
struct associated_allocator<
    detail::read_until_expr_op_v1<AsyncReadStream, DynamicBuffer_v1, RegEx,
                                  ReadHandler>,
    Allocator> {
  typedef typename associated_allocator<ReadHandler, Allocator>::type type;
...
public:
  ...
  void operator()(ASIO_MOVE_ARG(ReadHandler) handler,
    ...
    read_until_match_op_v1<AsyncReadStream,
        ...
        stream_, ASIO_MOVE_CAST(DynamicBuffer_v1)(buffers), match_condition,
        handler2.value)(asio::error_code(), 0, 1);
  }
...
inline asio_handler_allocate_is_deprecated
asio_handler_allocate(std::size_t size,
                      read_until_delim_op_v2<AsyncReadStream, DynamicBuffer_v2,
                                             ReadHandler> *this_handler) {
#if defined(ASIO_NO_DEPRECATED)
  asio_handler_alloc_helpers::allocate(size, this_handler->handler_);
  return asio_handler_allocate_is_no_longer_used();
...
public:
  ...
  void operator()(ASIO_MOVE_ARG(ReadHandler) handler,
    ...
    read_until_delim_op_v2<AsyncReadStream,
                           ...
                           typename decay<ReadHandler>::type>(
        stream_, ASIO_MOVE_CAST(DynamicBuffer_v2)(buffers), delim,
        handler2.value)(asio::error_code(), 0, 1);
  }
...
template <typename AsyncReadStream, typename DynamicBuffer_v2,
          typename ReadHandler, typename Allocator>
struct associated_allocator<detail::read_until_delim_op_v2<
...
template <typename AsyncReadStream, typename DynamicBuffer_v2,
          typename ReadHandler, typename Executor>
struct associated_executor<detail::read_until_delim_op_v2<
                               AsyncReadStream, DynamicBuffer_v2, ReadHandler>,
                           Executor>
    : detail::associated_executor_forwarding_base<ReadHandler, Executor> {
  typedef typename associated_executor<ReadHandler, Executor>::type type;
...
template <typename AsyncReadStream, typename DynamicBuffer_v2,
          typename ReadHandler, typename Allocator>
struct associated_allocator<detail::read_until_delim_string_op_v2<
                                AsyncReadStream, DynamicBuffer_v2, ReadHandler>,
                            Allocator> {
  typedef typename associated_allocator<ReadHandler, Allocator>::type type;

  static type get(const detail::read_until_delim_string_op_v2<
...
template <typename AsyncReadStream, typename DynamicBuffer_v2,
          typename ReadHandler, typename Executor>
struct associated_executor<detail::read_until_delim_string_op_v2<
                               AsyncReadStream, DynamicBuffer_v2, ReadHandler>,
                           Executor>
    : detail::associated_executor_forwarding_base<ReadHandler, Executor> {
  typedef typename associated_executor<ReadHandler, Executor>::type type;
...
inline asio_handler_allocate_is_deprecated
asio_handler_allocate(std::size_t size,
                      read_until_expr_op_v2<AsyncReadStream, DynamicBuffer_v2,
                                            RegEx, ReadHandler> *this_handler) {
#if defined(ASIO_NO_DEPRECATED)
  asio_handler_alloc_helpers::allocate(size, this_handler->handler_);
  return asio_handler_allocate_is_no_longer_used();
...
public:
  ...
  void operator()(ASIO_MOVE_ARG(ReadHandler) handler,
    ...
    read_until_expr_op_v2<AsyncReadStream,
                          typename decay<DynamicBuffer_v2>::type, RegEx,
                          typename decay<ReadHandler>::type>(
        stream_, ASIO_MOVE_CAST(DynamicBuffer_v2)(buffers), expr,
        handler2.value)(asio::error_code(), 0, 1);
  }
...
template <typename AsyncReadStream, typename DynamicBuffer_v2, typename RegEx,
          typename ReadHandler, typename Allocator>
struct associated_allocator<
    detail::read_until_expr_op_v2<AsyncReadStream, DynamicBuffer_v2, RegEx,
                                  ReadHandler>,
    Allocator> {
  typedef typename associated_allocator<ReadHandler, Allocator>::type type;
...
ASIO_INITFN_AUTO_RESULT_TYPE(ReadHandler, void(asio::error_code, std::size_t))
async_read_until(
    AsyncReadStream &s, DynamicBuffer_v2 buffers, const boost::regex &expr,
    ASIO_MOVE_ARG(ReadHandler) handler,
    typename enable_if<is_dynamic_buffer_v2<DynamicBuffer_v2>::value>::type *) {
  return async_initiate<ReadHandler, void(asio::error_code, std::size_t)>(
...
public:
  ...
  read_until_match_op_v2(AsyncReadStream &stream,
      ...
      : stream_(stream), buffers_(ASIO_MOVE_CAST(BufferSequence)(buffers)),
        match_condition_(match_condition), start_(0), search_position_(0),
        bytes_to_read_(0), handler_(ASIO_MOVE_CAST(ReadHandler)(handler)) {}
...
public:
  ...
  void operator()(ASIO_MOVE_ARG(ReadHandler) handler,
    ...
    read_until_match_op_v2<AsyncReadStream,
                           typename decay<DynamicBuffer_v2>::type,
                           MatchCondition, typename decay<ReadHandler>::type>(
        stream_, ASIO_MOVE_CAST(DynamicBuffer_v2)(buffers), match_condition,
        handler2.value)(asio::error_code(), 0, 1);
  }
