...
public:
  ...
  void dispatch(ASIO_MOVE_ARG(function) f) {
    executor_.dispatch(ASIO_MOVE_CAST(function)(f), std::allocator<void>());
  }

  void post(ASIO_MOVE_ARG(function) f) {
    executor_.post(ASIO_MOVE_CAST(function)(f), std::allocator<void>());
  }

  void defer(ASIO_MOVE_ARG(function) f) {
    executor_.defer(ASIO_MOVE_CAST(function)(f), std::allocator<void>());
  }
...
template <typename Executor> Executor *executor::target() ASIO_NOEXCEPT {
