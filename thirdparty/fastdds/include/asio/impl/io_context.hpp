  ...
  void operator()(ASIO_MOVE_ARG(LegacyCompletionHandler) handler,
    ...
    if (self->impl_.can_dispatch()) {
      ...
      typedef detail::completion_handler<
          typename decay<LegacyCompletionHandler>::type, executor_type>
          op;
...
template <typename Allocator, unsigned int Bits>
inline bool
io_context::basic_executor_type<Allocator, Bits>::running_in_this_thread() const
    ASIO_NOEXCEPT {
...
void io_context::basic_executor_type<Allocator, Bits>::execute(
  ...
  ASIO_HANDLER_CREATION(
      (*io_context_, *p.p, "io_context", io_context_, 0, "execute"));

  io_context_->impl_.post_immediate_completion(
...
template <typename Allocator, unsigned int Bits>
inline io_context &io_context::basic_executor_type<Allocator, Bits>::context()
    const ASIO_NOEXCEPT {
  return *io_context_;
}
...
void io_context::basic_executor_type<Allocator, Bits>::dispatch(
  ...
  ASIO_HANDLER_CREATION(
      (*io_context_, *p.p, "io_context", io_context_, 0, "dispatch"));
...
void io_context::basic_executor_type<Allocator, Bits>::post(
  ...
  ASIO_HANDLER_CREATION(
      (*io_context_, *p.p, "io_context", io_context_, 0, "post"));
...
void io_context::basic_executor_type<Allocator, Bits>::defer(
  ...
  ASIO_HANDLER_CREATION(
      (*io_context_, *p.p, "io_context", io_context_, 0, "defer"));
