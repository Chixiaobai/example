...
template <typename AsyncRandomAccessReadDevice, typename MutableBufferSequence,
          typename MutableBufferIterator, typename CompletionCondition,
          typename ReadHandler>
inline void start_read_at_buffer_sequence_op(
...
public:
  read_at_streambuf_op(AsyncRandomAccessReadDevice &device, uint64_t offset,
      ...
      : detail::base_from_completion_cond<CompletionCondition>(
        ...
        total_transferred_(0), handler_(ASIO_MOVE_CAST(ReadHandler)(handler)) {}
...
struct associated_allocator<
  ...
  static type
  get(const detail::read_at_streambuf_op<AsyncRandomAccessReadDevice, Allocator,
                                         CompletionCondition, ReadHandler> &h,
