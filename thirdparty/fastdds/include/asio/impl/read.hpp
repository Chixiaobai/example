...
read(SyncReadStream &s, const MutableBufferSequence &buffers,
  ...
  return detail::read_buffer_sequence(
...
template <typename SyncReadStream, typename DynamicBuffer_v1,
          typename CompletionCondition>
std::size_t
read(SyncReadStream &s, ASIO_MOVE_ARG(DynamicBuffer_v1) buffers,
     CompletionCondition completion_condition, asio::error_code &ec,
     typename enable_if<
...
template <typename SyncReadStream, typename DynamicBuffer_v2,
          typename CompletionCondition>
std::size_t read(
    SyncReadStream &s, DynamicBuffer_v2 buffers,
    CompletionCondition completion_condition, asio::error_code &ec,
...
template <typename SyncReadStream, typename DynamicBuffer_v2>
inline std::size_t read(
    SyncReadStream &s, DynamicBuffer_v2 buffers, asio::error_code &ec,
    typename enable_if<is_dynamic_buffer_v2<DynamicBuffer_v2>::value>::type *) {
...
template <typename AsyncReadStream, typename MutableBufferSequence,
          typename MutableBufferIterator, typename CompletionCondition,
          typename ReadHandler>
inline void start_read_buffer_sequence_op(
    AsyncReadStream &stream, const MutableBufferSequence &buffers,
...
template <typename AsyncReadStream> class initiate_async_read_buffer_sequence {
public:
...
struct associated_allocator<
  ...
  static type get(const detail::read_op<AsyncReadStream, MutableBufferSequence,
                                        MutableBufferIterator,
...
inline ASIO_INITFN_AUTO_RESULT_TYPE(ReadHandler,
  ...
  return async_read(s, ASIO_MOVE_CAST(DynamicBuffer_v1)(buffers),
...
inline ASIO_INITFN_AUTO_RESULT_TYPE(ReadHandler,
    ...
    async_read(
        ...
        typename enable_if<is_dynamic_buffer_v2<DynamicBuffer_v2>::value>::type
            *) {
  return async_read(s, ASIO_MOVE_CAST(DynamicBuffer_v2)(buffers),
                    transfer_all(), ASIO_MOVE_CAST(ReadHandler)(handler));
}
