...
#include "asio/detail/type_traits.hpp"
    ...
    defined(ASIO_HAS_CONSTEXPR) && defined(ASIO_HAS_VARIABLE_TEMPLATES) &&     \
...
struct static_query_trait
    : conditional<is_same<T, typename decay<T>::type>::value &&
                  ...
                  no_static_query,
                  traits::static_query<typename decay<T>::type,
...
struct static_query_trait<
    ...
    typename void_type<decltype(
        decay<Property>::type::template static_query_v<T>)>::type> {
