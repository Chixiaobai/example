...
struct call_traits<
    ...
    typename enable_if<(
        ...
        static_query<T, Property>::is_valid)>::type>
...
struct call_traits<
    ...
    typename enable_if<(
        ...
        query_member<T, Property>::is_valid)>::type>
...
struct call_traits<
    ...
    typename enable_if<(
        ...
        query_free<T, Property>::is_valid)>::type> : query_free<T, Property> {
...
struct impl {
  ...
  operator()(ASIO_MOVE_ARG(T), ASIO_MOVE_ARG(Property)) const
      ASIO_NOEXCEPT_IF((call_traits<T, void(Property)>::is_noexcept)) {
    return static_query<typename decay<T>::type,
                        typename decay<Property>::type>::value();
  }
...
static ASIO_CONSTEXPR const asio_query_fn::impl &query =
...
struct can_query
    : integral_constant<
          bool, asio_query_fn::call_traits<T, void(Property)>::overload !=
...
struct is_nothrow_query
    : integral_constant<
          bool, asio_query_fn::call_traits<T, void(Property)>::is_noexcept> {};
...
template <typename T, typename Property> struct query_result {
  typedef
      typename asio_query_fn::call_traits<T, void(Property)>::result_type type;
};
