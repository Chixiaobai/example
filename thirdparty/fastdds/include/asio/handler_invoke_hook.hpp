...
typedef asio_handler_invoke_is_no_longer_used asio_handler_invoke_is_deprecated;
...
template <typename Function>
inline asio_handler_invoke_is_deprecated asio_handler_invoke(Function &function,
                                                             ...) {
  function();
#if defined(ASIO_NO_DEPRECATED)
