...
struct call_traits<
    ...
    typename enable_if<(
        ...
        require_concept_member<T, Property>::is_valid)>::type>
...
struct call_traits<
    ...
    typename enable_if<(
        ...
        require_concept_free<T, Property>::is_valid)>::type>
...
struct impl {
  ...
  operator()(ASIO_MOVE_ARG(T) t, ASIO_MOVE_ARG(Property) p) const
      ASIO_NOEXCEPT_IF((call_traits<T, void(Property)>::is_noexcept)) {
    return ASIO_MOVE_CAST(T)(t).require_concept(ASIO_MOVE_CAST(Property)(p));
  }
  ...
  operator()(ASIO_MOVE_ARG(T) t, ASIO_MOVE_ARG(Property) p) const
      ASIO_NOEXCEPT_IF((call_traits<T, void(Property)>::is_noexcept)) {
    return require_concept(ASIO_MOVE_CAST(T)(t), ASIO_MOVE_CAST(Property)(p));
  }
};
...
static ASIO_CONSTEXPR const asio_require_concept_fn::impl &require_concept =
...
struct can_require_concept
    : integral_constant<bool, asio_require_concept_fn::call_traits<
                                  T, void(Property)>::overload !=
