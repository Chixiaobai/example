...
template <typename T, typename Properties, typename = void> struct call_traits {
...
struct call_traits<
    T, void(Property),
    typename enable_if<(
        is_applicable_property<typename decay<T>::type,
                               typename decay<Property>::type>::value &&
        decay<Property>::type::is_preferable &&
        static_require<T, Property>::is_valid)>::type> {
...
struct call_traits<
    ...
    typename enable_if<(
        ...
        require_member<T, Property>::is_valid)>::type>
...
struct call_traits<
    ...
    typename enable_if<(
        ...
        require_free<T, Property>::is_valid)>::type>
...
struct call_traits<
    ...
    typename enable_if<(
        ...
        prefer_member<T, Property>::is_valid)>::type>
...
struct call_traits<
    ...
    typename enable_if<(
        ...
        prefer_free<T, Property>::is_valid)>::type> : prefer_free<T, Property> {
...
struct call_traits<
    ...
    typename enable_if<(
        ...
        !require_free<T, Property>::is_valid &&
        !prefer_member<T, Property>::is_valid &&
        !prefer_free<T, Property>::is_valid)>::type> {
  ASIO_STATIC_CONSTEXPR(overload_type, overload = identity);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
...
struct call_traits<
    ...
    typename enable_if<
        ...
        call_traits<typename call_traits<T, void(P0)>::result_type,
                    void(P1)>::overload != ill_formed>::type> {
  ASIO_STATIC_CONSTEXPR(overload_type, overload = two_props);

  ASIO_STATIC_CONSTEXPR(
      bool,
      is_noexcept = (call_traits<T, void(P0)>::is_noexcept &&
                     call_traits<typename call_traits<T, void(P0)>::result_type,
                                 void(P1)>::is_noexcept));

  typedef typename decay<
      typename call_traits<typename call_traits<T, void(P0)>::result_type,
                           void(P1)>::result_type>::type result_type;
};

template <typename T, typename P0, typename P1, typename ASIO_ELLIPSIS PN>
struct call_traits<
    T, void(P0, P1, PN ASIO_ELLIPSIS),
    typename enable_if<
        call_traits<T, void(P0)>::overload != ill_formed &&
        call_traits<typename call_traits<T, void(P0)>::result_type,
                    void(P1, PN ASIO_ELLIPSIS)>::overload !=
            ill_formed>::type> {
  ...
  ASIO_STATIC_CONSTEXPR(
      ...
      is_noexcept = (call_traits<T, void(P0)>::is_noexcept &&
                     call_traits<typename call_traits<T, void(P0)>::result_type,
                                 void(P1, PN ASIO_ELLIPSIS)>::is_noexcept));

  typedef typename decay<
      typename call_traits<typename call_traits<T, void(P0)>::result_type,
                           void(P1, PN ASIO_ELLIPSIS)>::result_type>::type
      result_type;
};
...
struct impl {
  ...
  ASIO_NODISCARD ASIO_CONSTEXPR typename enable_if<
      ...
      typename call_traits<T, void(Property)>::result_type>::type
  operator()(ASIO_MOVE_ARG(T) t, ASIO_MOVE_ARG(Property)) const
      ASIO_NOEXCEPT_IF((call_traits<T, void(Property)>::is_noexcept)) {
  ...
  ASIO_NODISCARD ASIO_CONSTEXPR typename enable_if<
      ...
      typename call_traits<T, void(Property)>::result_type>::type
  operator()(ASIO_MOVE_ARG(T) t, ASIO_MOVE_ARG(Property) p) const
      ASIO_NOEXCEPT_IF((call_traits<T, void(Property)>::is_noexcept)) {
    return ASIO_MOVE_CAST(T)(t).require(ASIO_MOVE_CAST(Property)(p));
  }
  ...
  operator()(ASIO_MOVE_ARG(T) t, ASIO_MOVE_ARG(Property) p) const
      ASIO_NOEXCEPT_IF((call_traits<T, void(Property)>::is_noexcept)) {
    return require(ASIO_MOVE_CAST(T)(t), ASIO_MOVE_CAST(Property)(p));
  }
  ...
  operator()(ASIO_MOVE_ARG(T) t, ASIO_MOVE_ARG(Property) p) const
      ASIO_NOEXCEPT_IF((call_traits<T, void(Property)>::is_noexcept)) {
    return ASIO_MOVE_CAST(T)(t).prefer(ASIO_MOVE_CAST(Property)(p));
  }
  ...
  operator()(ASIO_MOVE_ARG(T) t, ASIO_MOVE_ARG(Property) p) const
      ASIO_NOEXCEPT_IF((call_traits<T, void(Property)>::is_noexcept)) {
    return prefer(ASIO_MOVE_CAST(T)(t), ASIO_MOVE_CAST(Property)(p));
  }

  template <typename T, typename P0, typename P1>
  ASIO_NODISCARD ASIO_CONSTEXPR typename enable_if<
      call_traits<T, void(P0, P1)>::overload == two_props,
      typename call_traits<T, void(P0, P1)>::result_type>::type
  operator()(ASIO_MOVE_ARG(T) t, ASIO_MOVE_ARG(P0) p0,
             ASIO_MOVE_ARG(P1) p1) const
      ASIO_NOEXCEPT_IF((call_traits<T, void(P0, P1)>::is_noexcept)) {
    return (*this)((*this)(ASIO_MOVE_CAST(T)(t), ASIO_MOVE_CAST(P0)(p0)),
  ...
  ASIO_NODISCARD ASIO_CONSTEXPR typename enable_if<
      ...
      typename call_traits<T,
                           void(P0, P1, PN ASIO_ELLIPSIS)>::result_type>::type
  operator()(ASIO_MOVE_ARG(T) t, ASIO_MOVE_ARG(P0) p0, ASIO_MOVE_ARG(P1) p1,
...
static ASIO_CONSTEXPR const asio_prefer_fn::impl &prefer =
...
struct can_prefer
    : integral_constant<
          bool, asio_prefer_fn::call_traits<T, void(Properties...)>::overload !=
                    asio_prefer_fn::ill_formed> {};

#else // defined(ASIO_HAS_VARIADIC_TEMPLATES)

template <typename T, typename P0 = void, typename P1 = void,
          typename P2 = void>
struct can_prefer
    : integral_constant<
          bool, asio_prefer_fn::call_traits<T, void(P0, P1, P2)>::overload !=
                    asio_prefer_fn::ill_formed> {};

template <typename T, typename P0, typename P1>
struct can_prefer<T, P0, P1>
    : integral_constant<
          bool, asio_prefer_fn::call_traits<T, void(P0, P1)>::overload !=
                    asio_prefer_fn::ill_formed> {};
...
template <typename T> struct can_prefer<T> : false_type {};
...
constexpr bool can_prefer_v = can_prefer<T, Properties ASIO_ELLIPSIS>::value;
...
struct is_nothrow_prefer
    : integral_constant<
          bool, asio_prefer_fn::call_traits<T, void(P0, P1, P2)>::is_noexcept> {
};

template <typename T, typename P0, typename P1>
struct is_nothrow_prefer<T, P0, P1>
    : integral_constant<
          bool, asio_prefer_fn::call_traits<T, void(P0, P1)>::is_noexcept> {};
...
template <typename T> struct is_nothrow_prefer<T> : false_type {};
...
template <typename T, typename... Properties> struct prefer_result {
  typedef
      typename asio_prefer_fn::call_traits<T, void(Properties...)>::result_type
          type;
};
...
struct prefer_result {
  typedef typename asio_prefer_fn::call_traits<T, void(P0, P1, P2)>::result_type
      type;
};
...
struct prefer_result<T, P0, P1> {
  typedef
      typename asio_prefer_fn::call_traits<T, void(P0, P1)>::result_type type;
};

template <typename T, typename P0> struct prefer_result<T, P0> {
  typedef typename asio_prefer_fn::call_traits<T, void(P0)>::result_type type;
};

template <typename T> struct prefer_result<T> {};
