...
struct can_set_error : integral_constant<bool, automatically_determined> {};
...
template <typename R, typename E, typename = void> struct call_traits {
...
struct call_traits<R, void(E),
                   typename enable_if<(set_error_member<R, E>::is_valid)>::type>
...
template <typename R, typename E>
struct call_traits<R, void(E),
                   typename enable_if<(!set_error_member<R, E>::is_valid &&
                                       set_error_free<R, E>::is_valid)>::type>
    : set_error_free<R, E> {
...
struct impl {
  ...
  template <typename R, typename E>
  ASIO_CONSTEXPR
      typename enable_if<call_traits<R, void(E)>::overload == call_member,
                         typename call_traits<R, void(E)>::result_type>::type
      operator()(R &&r, E &&e) const
      ASIO_NOEXCEPT_IF((call_traits<R, void(E)>::is_noexcept)) {
    return ASIO_MOVE_CAST(R)(r).set_error(ASIO_MOVE_CAST(E)(e));
  }

  template <typename R, typename E>
  ASIO_CONSTEXPR
      typename enable_if<call_traits<R, void(E)>::overload == call_free,
                         typename call_traits<R, void(E)>::result_type>::type
      operator()(R &&r, E &&e) const
      ASIO_NOEXCEPT_IF((call_traits<R, void(E)>::is_noexcept)) {
  ...
  ASIO_CONSTEXPR typename enable_if<
      ...
      typename call_traits<R &, void(const E &)>::result_type>::type
  operator()(R &r, const E &e) const
      ASIO_NOEXCEPT_IF((call_traits<R &, void(const E &)>::is_noexcept)) {
  ...
  ASIO_CONSTEXPR typename enable_if<
      ...
      typename call_traits<const R &, void(const E &)>::result_type>::type
  operator()(const R &r, const E &e) const
      ASIO_NOEXCEPT_IF((call_traits<const R &, void(const E &)>::is_noexcept)) {
    return r.set_error(e);
  }
...
static ASIO_CONSTEXPR const asio_execution_set_error_fn::impl &set_error =
    asio_execution_set_error_fn::static_instance<>::instance;

} // namespace

template <typename R, typename E>
struct can_set_error
    : integral_constant<bool, asio_execution_set_error_fn::call_traits<
                                  R, void(E)>::overload !=
