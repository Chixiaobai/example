...
struct can_bulk_execute : integral_constant<bool, automatically_determined> {};
...
template <typename S, typename Args, typename = void> struct call_traits {
...
struct call_traits<
    S, void(F, N),
    typename enable_if<(is_convertible<N, std::size_t>::value &&
                        bulk_execute_member<S, F, N>::is_valid &&
                        is_sender<typename bulk_execute_member<
                            S, F, N>::result_type>::value)>::type>
...
struct call_traits<
    ...
    typename enable_if<(is_convertible<N, std::size_t>::value &&
                        ...
                        is_sender<typename bulk_execute_free<
                            S, F, N>::result_type>::value)>::type>
...
struct call_traits<
    ...
    typename enable_if<(
        ...
        !bulk_execute_member<S, F, N>::is_valid &&
        !bulk_execute_free<S, F, N>::is_valid && is_sender<S>::value &&
        is_same<
            typename result_of<F(typename executor_index<
                                 typename remove_cvref<S>::type>::type)>::type,
            typename result_of<F(typename executor_index<typename remove_cvref<
                                     S>::type>::type)>::type>::value &&
        static_require<S, bulk_guarantee_t::unsequenced_t>::is_valid)>::type> {
...
struct impl {
  ...
  template <typename S, typename F, typename N>
  ASIO_CONSTEXPR
      typename enable_if<call_traits<S, void(F, N)>::overload == call_member,
                         typename call_traits<S, void(F, N)>::result_type>::type
      operator()(S &&s, F &&f, N &&n) const
      ASIO_NOEXCEPT_IF((call_traits<S, void(F, N)>::is_noexcept)) {
    return ASIO_MOVE_CAST(S)(s).bulk_execute(ASIO_MOVE_CAST(F)(f),
                                             ASIO_MOVE_CAST(N)(n));
  }

  template <typename S, typename F, typename N>
  ASIO_CONSTEXPR
      typename enable_if<call_traits<S, void(F, N)>::overload == call_free,
                         typename call_traits<S, void(F, N)>::result_type>::type
      operator()(S &&s, F &&f, N &&n) const
      ASIO_NOEXCEPT_IF((call_traits<S, void(F, N)>::is_noexcept)) {
    return bulk_execute(ASIO_MOVE_CAST(S)(s), ASIO_MOVE_CAST(F)(f),
                        ASIO_MOVE_CAST(N)(n));
  }

  template <typename S, typename F, typename N>
  ASIO_CONSTEXPR
      typename enable_if<call_traits<S, void(F, N)>::overload == adapter,
                         typename call_traits<S, void(F, N)>::result_type>::type
      operator()(S &&s, F &&f, N &&n) const
      ASIO_NOEXCEPT_IF((call_traits<S, void(F, N)>::is_noexcept)) {
    return typename call_traits<S, void(F, N)>::result_type(
        ASIO_MOVE_CAST(S)(s), ASIO_MOVE_CAST(F)(f), ASIO_MOVE_CAST(N)(n));
  }
#else  // defined(ASIO_HAS_MOVE)
  template <typename S, typename F, typename N>
  ASIO_CONSTEXPR typename enable_if<
      call_traits<S, void(const F &, const N &)>::overload == call_member,
      typename call_traits<S, void(const F &, const N &)>::result_type>::type
  operator()(S &s, const F &f, const N &n) const ASIO_NOEXCEPT_IF(
      (call_traits<S, void(const F &, const N &)>::is_noexcept)) {
    return s.bulk_execute(ASIO_MOVE_CAST(F)(f), ASIO_MOVE_CAST(N)(n));
  }
  ...
  ASIO_CONSTEXPR typename enable_if<
      call_traits<S, void(const F &, const N &)>::overload == call_member,
      typename call_traits<S, void(const F &, const N &)>::result_type>::type
  operator()(const S &s, const F &f, const N &n) const ASIO_NOEXCEPT_IF(
      (call_traits<S, void(const F &, const N &)>::is_noexcept)) {
    return s.bulk_execute(ASIO_MOVE_CAST(F)(f), ASIO_MOVE_CAST(N)(n));
  }
  ...
  operator()(S &s, const F &f, const N &n) const ASIO_NOEXCEPT_IF(
      (call_traits<S, void(const F &, const N &)>::is_noexcept)) {
    return bulk_execute(s, ASIO_MOVE_CAST(F)(f), ASIO_MOVE_CAST(N)(n));
  }
...
static ASIO_CONSTEXPR const asio_execution_bulk_execute_fn::impl &bulk_execute =
...
struct can_bulk_execute
    : integral_constant<bool, asio_execution_bulk_execute_fn::call_traits<
                                  S, void(F, N)>::overload !=
...
template <typename S, typename F, typename N> struct bulk_execute_result {
