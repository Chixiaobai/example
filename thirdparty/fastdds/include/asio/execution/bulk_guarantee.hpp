...
struct bulk_guarantee_t {
  ...
  friend constexpr bool operator==(const bulk_guarantee_t &a,
                                   const bulk_guarantee_t &b) noexcept;
...
template <int I = 0> struct bulk_guarantee_t {
  ...
  ASIO_CONSTEXPR bulk_guarantee_t() : value_(-1) {}

  ASIO_CONSTEXPR bulk_guarantee_t(unsequenced_t) : value_(0) {}

  ASIO_CONSTEXPR bulk_guarantee_t(sequenced_t) : value_(1) {}

  ASIO_CONSTEXPR bulk_guarantee_t(parallel_t) : value_(2) {}

#if defined(ASIO_HAS_DEDUCED_STATIC_QUERY_TRAIT) &&                            \
    defined(ASIO_HAS_SFINAE_VARIABLE_TEMPLATES)
  template <typename T>
  static ASIO_CONSTEXPR typename traits::query_static_constexpr_member<
      T, bulk_guarantee_t>::result_type
  static_query() ASIO_NOEXCEPT_IF((traits::query_static_constexpr_member<
                                   T, bulk_guarantee_t>::is_noexcept)) {
  ...
  static ASIO_CONSTEXPR
      ...
      static_query(typename enable_if<
                       !traits::query_static_constexpr_member<
                           T, bulk_guarantee_t>::is_valid &&
                       !traits::query_member<T, bulk_guarantee_t>::is_valid &&
                       traits::static_query<T, unsequenced_t>::is_valid>::type
                       * = 0) ASIO_NOEXCEPT {
  ...
  static ASIO_CONSTEXPR
      ...
      static_query(typename enable_if<
                       ...
                       traits::static_query<T, sequenced_t>::is_valid>::type * =
                       0) ASIO_NOEXCEPT {
  ...
  static ASIO_CONSTEXPR const
      T static_query_v = bulk_guarantee_t::static_query<E>();
#endif                  // defined(ASIO_HAS_DEDUCED_STATIC_QUERY_TRAIT)
                        //   && defined(ASIO_HAS_SFINAE_VARIABLE_TEMPLATES)

  friend ASIO_CONSTEXPR bool operator==(const bulk_guarantee_t &a,
  ...
  friend ASIO_CONSTEXPR bulk_guarantee_t
  query(const Executor &ex, convertible_from_bulk_guarantee_t,
        typename enable_if<
            can_query<const Executor &, unsequenced_t>::value>::type * = 0)
  ...
  friend ASIO_CONSTEXPR bulk_guarantee_t query(
      ...
      typename enable_if<!can_query<const Executor &, unsequenced_t>::value &&
                         can_query<const Executor &, sequenced_t>::value>::type
          * = 0)
#if !defined(__clang__) // Clang crashes if noexcept is used here.
#if defined(ASIO_MSVC)  // Visual C++ wants the type to be qualified.
      ASIO_NOEXCEPT_IF(
...
#else                   // defined(ASIO_MSVC)
      ASIO_NOEXCEPT_IF((is_nothrow_query<const Executor &, sequenced_t>::value))
#endif                  // defined(ASIO_MSVC)
#endif                  // !defined(__clang__)
  {
  ...
  query(const Executor &ex, convertible_from_bulk_guarantee_t,
        typename enable_if<!can_query<const Executor &, unsequenced_t>::value &&
                           ...
                           can_query<const Executor &, parallel_t>::value>::type
            * = 0)
#if !defined(__clang__) // Clang crashes if noexcept is used here.
#if defined(ASIO_MSVC)  // Visual C++ wants the type to be qualified.
      ASIO_NOEXCEPT_IF(
          (is_nothrow_query<const Executor &,
                            bulk_guarantee_t<>::parallel_t>::value))
#else                   // defined(ASIO_MSVC)
      ASIO_NOEXCEPT_IF((is_nothrow_query<const Executor &, parallel_t>::value))
#endif                  // defined(ASIO_MSVC)
#endif                  // !defined(__clang__)
  {
...
#if !defined(ASIO_HAS_CONSTEXPR)
template <int I> const bulk_guarantee_t<I> bulk_guarantee_t<I>::instance;
#endif
...
template <int I>
const typename bulk_guarantee_t<I>::sequenced_t bulk_guarantee_t<I>::sequenced;

template <int I>
const typename bulk_guarantee_t<I>::parallel_t bulk_guarantee_t<I>::parallel;

namespace bulk_guarantee {

template <int I = 0> struct unsequenced_t {
#if defined(ASIO_HAS_VARIABLE_TEMPLATES)
  template <typename T>
  ASIO_STATIC_CONSTEXPR(bool,
                        is_applicable_property_v = is_executor<T>::value ||
  ...
  static ASIO_CONSTEXPR unsequenced_t static_query(
      typename enable_if<
          ...
          !can_query<T, parallel_t<I>>::value>::type * = 0) ASIO_NOEXCEPT {
    return unsequenced_t();
  }

  template <typename E, typename T = decltype(unsequenced_t::static_query<E>())>
  static ASIO_CONSTEXPR const
      T static_query_v = unsequenced_t::static_query<E>();
#endif // defined(ASIO_HAS_DEDUCED_STATIC_QUERY_TRAIT)
       //   && defined(ASIO_HAS_SFINAE_VARIABLE_TEMPLATES)

  static ASIO_CONSTEXPR bulk_guarantee_t<I> value() { return unsequenced_t(); }

  friend ASIO_CONSTEXPR bool operator==(const unsequenced_t &,
                                        const unsequenced_t &) {
    return true;
  }
...
template <int I = 0> struct sequenced_t {
#if defined(ASIO_HAS_VARIABLE_TEMPLATES)
  template <typename T>
  ASIO_STATIC_CONSTEXPR(bool,
                        is_applicable_property_v = is_executor<T>::value ||
  ...
  template <typename T>
  static ASIO_CONSTEXPR
      typename traits::query_static_constexpr_member<T,
                                                     sequenced_t>::result_type
      static_query() ASIO_NOEXCEPT_IF((
  ...
  static ASIO_CONSTEXPR const T static_query_v = sequenced_t::static_query<E>();
#endif // defined(ASIO_HAS_DEDUCED_STATIC_QUERY_TRAIT)
       //   && defined(ASIO_HAS_SFINAE_VARIABLE_TEMPLATES)

  static ASIO_CONSTEXPR bulk_guarantee_t<I> value() { return sequenced_t(); }

  friend ASIO_CONSTEXPR bool operator==(const sequenced_t &,
                                        const sequenced_t &) {
    return true;
  }
...
template <int I> struct parallel_t {
  ...
  static ASIO_CONSTEXPR const T static_query_v = parallel_t::static_query<E>();
#endif // defined(ASIO_HAS_DEDUCED_STATIC_QUERY_TRAIT)
       //   && defined(ASIO_HAS_SFINAE_VARIABLE_TEMPLATES)

  static ASIO_CONSTEXPR bulk_guarantee_t<I> value() { return parallel_t(); }

  friend ASIO_CONSTEXPR bool operator==(const parallel_t &,
                                        const parallel_t &) {
    return true;
  }
...
namespace {
static const bulk_guarantee_t &bulk_guarantee = bulk_guarantee_t::instance;
}
#endif
...
struct query_free_default<
    T, execution::bulk_guarantee_t,
    typename enable_if<can_query<
        T, execution::bulk_guarantee_t::unsequenced_t>::value>::type> {
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(
      bool,
      is_noexcept = (is_nothrow_query<
                     T, execution::bulk_guarantee_t::unsequenced_t>::value));
...
struct query_free_default<
    ...
    typename enable_if<
        ...
        can_query<T, execution::bulk_guarantee_t::sequenced_t>::value>::type> {
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(
      bool,
      is_noexcept = (is_nothrow_query<
                     T, execution::bulk_guarantee_t::sequenced_t>::value));
...
struct query_free_default<
    ...
    typename enable_if<
        ...
        can_query<T, execution::bulk_guarantee_t::parallel_t>::value>::type> {
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(
      bool, is_noexcept = (is_nothrow_query<
                           T, execution::bulk_guarantee_t::parallel_t>::value));
...
struct static_query<T, execution::bulk_guarantee_t,
                    typename enable_if<traits::query_static_constexpr_member<
                        T, execution::bulk_guarantee_t>::is_valid>::type> {
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);

  typedef typename traits::query_static_constexpr_member<
      T, execution::bulk_guarantee_t>::result_type result_type;

  static ASIO_CONSTEXPR result_type value() {
    return traits::query_static_constexpr_member<
        T, execution::bulk_guarantee_t>::value();
  }
};
...
struct static_query<
    ...
    typename enable_if<
        !traits::query_static_constexpr_member<
            T, execution::bulk_guarantee_t>::is_valid &&
        !traits::query_member<T, execution::bulk_guarantee_t>::is_valid &&
        traits::static_query<
            T, execution::bulk_guarantee_t::unsequenced_t>::is_valid>::type> {
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);

  typedef typename traits::static_query<
      T, execution::bulk_guarantee_t::unsequenced_t>::result_type result_type;
...
struct static_query<
    ...
    typename enable_if<
        ...
        !traits::query_member<T, execution::bulk_guarantee_t>::is_valid &&
        !traits::static_query<
            T, execution::bulk_guarantee_t::unsequenced_t>::is_valid &&
        traits::static_query<
            T, execution::bulk_guarantee_t::sequenced_t>::is_valid>::type> {
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);

  typedef typename traits::static_query<
      T, execution::bulk_guarantee_t::sequenced_t>::result_type result_type;
...
struct static_query<
    ...
    typename enable_if<
        ...
        !traits::static_query<
            T, execution::bulk_guarantee_t::unsequenced_t>::is_valid &&
        !traits::static_query<
            T, execution::bulk_guarantee_t::sequenced_t>::is_valid &&
        traits::static_query<
            T, execution::bulk_guarantee_t::parallel_t>::is_valid>::type> {
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);

  typedef typename traits::static_query<
      T, execution::bulk_guarantee_t::parallel_t>::result_type result_type;
...
template <typename T>
struct static_query<
    T, execution::bulk_guarantee_t::unsequenced_t,
    typename enable_if<traits::query_static_constexpr_member<
        T, execution::bulk_guarantee_t::unsequenced_t>::is_valid>::type> {
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
...
template <typename T>
struct static_query<
    T, execution::bulk_guarantee_t::sequenced_t,
    typename enable_if<traits::query_static_constexpr_member<
        T, execution::bulk_guarantee_t::sequenced_t>::is_valid>::type> {
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
...
template <typename T>
struct static_query<
    T, execution::bulk_guarantee_t::parallel_t,
    typename enable_if<traits::query_static_constexpr_member<
        T, execution::bulk_guarantee_t::parallel_t>::is_valid>::type> {
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
...
struct static_require<
  ...
  ASIO_STATIC_CONSTEXPR(
      bool,
      is_valid =
          (is_same<typename static_query<T, execution::bulk_guarantee_t::
                                                unsequenced_t>::result_type,
...
struct static_require<
  ...
  ASIO_STATIC_CONSTEXPR(
      bool,
      is_valid = (is_same<
                  typename static_query<
                      T, execution::bulk_guarantee_t::sequenced_t>::result_type,
  ...
  ASIO_STATIC_CONSTEXPR(
      ...
      is_valid =
          (is_same<typename static_query<
                       T, execution::bulk_guarantee_t::parallel_t>::result_type,
