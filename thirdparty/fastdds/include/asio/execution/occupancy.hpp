...
template <int I = 0> struct occupancy_t {
  ...
  static ASIO_CONSTEXPR const T static_query_v = occupancy_t::static_query<E>();
...
#if !defined(ASIO_HAS_CONSTEXPR)
template <int I> const occupancy_t<I> occupancy_t<I>::instance;
#endif
...
namespace {
static const occupancy_t &occupancy = occupancy_t::instance;
}
#endif
