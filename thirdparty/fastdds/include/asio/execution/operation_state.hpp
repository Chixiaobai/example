...
struct is_operation_state_base
    : integral_constant<bool,
                        is_destructible<T>::value && is_object<T>::value> {};
...
struct is_operation_state :
    ...
    conditional<
        ...
        detail::is_operation_state_base<T>, false_type>::type
...
template <typename T>
ASIO_CONSTEXPR const bool is_operation_state_v = is_operation_state<T>::value;
...
#define ASIO_EXECUTION_OPERATION_STATE ::asio::execution::operation_state
