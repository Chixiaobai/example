...
template <int I = 0> struct mapping_t {
  ...
  ASIO_CONSTEXPR mapping_t() : value_(-1) {}

  ASIO_CONSTEXPR mapping_t(thread_t) : value_(0) {}

  ASIO_CONSTEXPR mapping_t(new_thread_t) : value_(1) {}

  ASIO_CONSTEXPR mapping_t(other_t) : value_(2) {}
  ...
  template <typename T>
  static ASIO_CONSTEXPR typename traits::static_query<T, thread_t>::result_type
  static_query(
      typename enable_if<
          !traits::query_static_constexpr_member<T, mapping_t>::is_valid &&
          !traits::query_member<T, mapping_t>::is_valid &&
          traits::static_query<T, thread_t>::is_valid>::type * = 0)
      ASIO_NOEXCEPT {
  ...
  static ASIO_CONSTEXPR
      ...
      static_query(
          typename enable_if<
              ...
              traits::static_query<T, new_thread_t>::is_valid>::type * = 0)
          ASIO_NOEXCEPT {
    return traits::static_query<T, new_thread_t>::value();
  }

  template <typename T>
  static ASIO_CONSTEXPR typename traits::static_query<T, other_t>::result_type
  static_query(
      typename enable_if<
          !traits::query_static_constexpr_member<T, mapping_t>::is_valid &&
          !traits::query_member<T, mapping_t>::is_valid &&
          ...
          traits::static_query<T, other_t>::is_valid>::type * = 0)
      ASIO_NOEXCEPT {
    return traits::static_query<T, other_t>::value();
  }

  template <typename E, typename T = decltype(mapping_t::static_query<E>())>
  static ASIO_CONSTEXPR const T static_query_v = mapping_t::static_query<E>();
#endif                  // defined(ASIO_HAS_DEDUCED_STATIC_QUERY_TRAIT)
                        //   && defined(ASIO_HAS_SFINAE_VARIABLE_TEMPLATES)

  friend ASIO_CONSTEXPR bool operator==(const mapping_t &a,
                                        const mapping_t &b) {
  ...
  friend ASIO_CONSTEXPR mapping_t query(
      ...
      typename enable_if<can_query<const Executor &, thread_t>::value>::type * =
          0)
      ...
      ASIO_NOEXCEPT_IF((is_nothrow_query<const Executor &, thread_t>::value))
  ...
  friend ASIO_CONSTEXPR mapping_t query(
      const Executor &ex, convertible_from_mapping_t,
      typename enable_if<!can_query<const Executor &, thread_t>::value &&
                         can_query<const Executor &, new_thread_t>::value>::type
          * = 0)
#if !defined(__clang__) // Clang crashes if noexcept is used here.
#if defined(ASIO_MSVC)  // Visual C++ wants the type to be qualified.
      ASIO_NOEXCEPT_IF((
  ...
  friend ASIO_CONSTEXPR mapping_t query(
      ...
      typename enable_if<!can_query<const Executor &, thread_t>::value &&
                         ...
                         can_query<const Executor &, other_t>::value>::type * =
          0)
#if !defined(__clang__) // Clang crashes if noexcept is used here.
#if defined(ASIO_MSVC)  // Visual C++ wants the type to be qualified.
      ASIO_NOEXCEPT_IF(
...
#else                   // defined(ASIO_MSVC)
      ASIO_NOEXCEPT_IF((is_nothrow_query<const Executor &, other_t>::value))
#endif                  // defined(ASIO_MSVC)
#endif                  // !defined(__clang__)
  {
...
#if !defined(ASIO_HAS_CONSTEXPR)
template <int I> const mapping_t<I> mapping_t<I>::instance;
#endif
...
template <int I = 0> struct thread_t {
  ...
  static ASIO_CONSTEXPR thread_t static_query(
      typename enable_if<
          ...
          !can_query<T, other_t<I>>::value>::type * = 0) ASIO_NOEXCEPT {
    return thread_t();
  }

  template <typename E, typename T = decltype(thread_t::static_query<E>())>
  static ASIO_CONSTEXPR const T static_query_v = thread_t::static_query<E>();
#endif // defined(ASIO_HAS_DEDUCED_STATIC_QUERY_TRAIT)
       //   && defined(ASIO_HAS_SFINAE_VARIABLE_TEMPLATES)

  static ASIO_CONSTEXPR mapping_t<I> value() { return thread_t(); }

  friend ASIO_CONSTEXPR bool operator==(const thread_t &, const thread_t &) {
    return true;
  }
...
template <int I = 0> struct new_thread_t {
  ...
  static ASIO_CONSTEXPR const
      T static_query_v = new_thread_t::static_query<E>();
#endif // defined(ASIO_HAS_DEDUCED_STATIC_QUERY_TRAIT)
       //   && defined(ASIO_HAS_SFINAE_VARIABLE_TEMPLATES)

  static ASIO_CONSTEXPR mapping_t<I> value() { return new_thread_t(); }

  friend ASIO_CONSTEXPR bool operator==(const new_thread_t &,
                                        const new_thread_t &) {
    return true;
  }
...
template <int I> struct other_t {
  ...
  static ASIO_CONSTEXPR const T static_query_v = other_t::static_query<E>();
#endif // defined(ASIO_HAS_DEDUCED_STATIC_QUERY_TRAIT)
       //   && defined(ASIO_HAS_SFINAE_VARIABLE_TEMPLATES)

  static ASIO_CONSTEXPR mapping_t<I> value() { return other_t(); }

  friend ASIO_CONSTEXPR bool operator==(const other_t &, const other_t &) {
    return true;
  }
...
struct query_free_default<
    ...
    typename enable_if<
        can_query<T, execution::mapping_t::thread_t>::value>::type> {
...
struct query_free_default<
    ...
    typename enable_if<
        ...
        can_query<T, execution::mapping_t::new_thread_t>::value>::type> {
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(
      bool,
      is_noexcept =
...
struct query_free_default<
    ...
    typename enable_if<
        ...
        can_query<T, execution::mapping_t::other_t>::value>::type> {
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(
      bool, is_noexcept =
...
struct static_query<T, execution::mapping_t,
                    typename enable_if<traits::query_static_constexpr_member<
                        T, execution::mapping_t>::is_valid>::type> {
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);

  typedef typename traits::query_static_constexpr_member<
      T, execution::mapping_t>::result_type result_type;
...
struct static_query<
    ...
    typename enable_if<
        !traits::query_static_constexpr_member<
            T, execution::mapping_t>::is_valid &&
        !traits::query_member<T, execution::mapping_t>::is_valid &&
        traits::static_query<T,
                             execution::mapping_t::thread_t>::is_valid>::type> {
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
...
struct static_query<
    ...
    typename enable_if<
        ...
        traits::static_query<T,
                             execution::mapping_t::other_t>::is_valid>::type> {
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
...
struct static_query<T, execution::mapping_t::thread_t,
                    typename enable_if<traits::query_static_constexpr_member<
                        T, execution::mapping_t::thread_t>::is_valid>::type> {
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  ...
  static ASIO_CONSTEXPR result_type value() {
    return traits::query_static_constexpr_member<
        T, execution::mapping_t::thread_t>::value();
  }
};
...
struct static_query<
    ...
    typename enable_if<
        !traits::query_static_constexpr_member<
            T, execution::mapping_t::thread_t>::is_valid &&
...
struct static_query<
    ...
    typename enable_if<traits::query_static_constexpr_member<
        T, execution::mapping_t::new_thread_t>::is_valid>::type> {
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  ...
  static ASIO_CONSTEXPR result_type value() {
    return traits::query_static_constexpr_member<
        T, execution::mapping_t::new_thread_t>::value();
  }
};
...
struct static_query<T, execution::mapping_t::other_t,
                    typename enable_if<traits::query_static_constexpr_member<
                        T, execution::mapping_t::other_t>::is_valid>::type> {
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  ...
  static ASIO_CONSTEXPR result_type value() {
    return traits::query_static_constexpr_member<
        T, execution::mapping_t::other_t>::value();
  }
};
...
struct static_require<T, execution::mapping_t::thread_t,
  ...
  ASIO_STATIC_CONSTEXPR(
      ...
      is_valid = (is_same<typename static_query<
                              T, execution::mapping_t::thread_t>::result_type,
...
struct static_require<
    T, execution::mapping_t::new_thread_t,
    typename enable_if<
        static_query<T, execution::mapping_t::new_thread_t>::is_valid>::type> {
  ASIO_STATIC_CONSTEXPR(
      bool,
      is_valid =
          (is_same<typename static_query<
                       T, execution::mapping_t::new_thread_t>::result_type,
...
struct static_require<T, execution::mapping_t::other_t,
  ...
  ASIO_STATIC_CONSTEXPR(
      bool,
      is_valid = (is_same<typename static_query<
                              T, execution::mapping_t::other_t>::result_type,
