...
template <int I = 0> struct context_t {
  ...
  static ASIO_CONSTEXPR const T static_query_v = context_t::static_query<E>();
...
#if !defined(ASIO_HAS_CONSTEXPR)
template <int I> const context_t<I> context_t<I>::instance;
#endif
...
struct static_query<T, execution::context_t,
                    typename enable_if<traits::query_static_constexpr_member<
                        T, execution::context_t>::is_valid>::type> {
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);

  typedef typename traits::query_static_constexpr_member<
      T, execution::context_t>::result_type result_type;
