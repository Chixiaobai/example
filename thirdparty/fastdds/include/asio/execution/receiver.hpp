...
#else // defined(ASIO_HAS_STD_EXCEPTION_PTR)
#define ASIO_EXECUTION_RECEIVER_ERROR_DEFAULT = ::asio::error_code
#endif // defined(ASIO_HAS_STD_EXCEPTION_PTR)
...
struct is_receiver :
    ...
    conditional<
        ...
        detail::is_receiver_base<T, E>, false_type>::type
...
struct is_receiver_of :
    ...
    integral_constant<bool, automatically_determined>
#else  // defined(GENERATING_DOCUMENTATION)
    conditional<is_receiver<T>::value,
...
template <typename T, typename... Vs>
ASIO_CONSTEXPR const bool is_receiver_of_v = is_receiver_of<T, Vs...>::value;
...
#define ASIO_EXECUTION_RECEIVER_OF_0 ::asio::execution::receiver_of

#define ASIO_EXECUTION_RECEIVER_OF_1(v) ::asio::execution::receiver_of<v>
...
#define ASIO_PRIVATE_RECEIVER_OF_TRAITS_DEF(n)                                 \
  ...
  struct is_receiver_of<T, ASIO_VARIADIC_TARGS(n)>                             \
      : conditional<conditional<true, is_receiver<T>, void>::type::value,      \
                    can_set_value<typename remove_cvref<T>::type,              \
...
struct is_nothrow_receiver_of<T>
    : integral_constant<bool, is_receiver_of<T>::value &&
                                  is_nothrow_set_value<
...
#define ASIO_PRIVATE_NOTHROW_RECEIVER_OF_TRAITS_DEF(n)                         \
  ...
  struct is_nothrow_receiver_of<T, ASIO_VARIADIC_TARGS(n)>                     \
      : integral_constant<                                                     \
            bool, is_receiver_of<T, ASIO_VARIADIC_TARGS(n)>::value &&          \
