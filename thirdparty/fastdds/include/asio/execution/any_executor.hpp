...
struct supportable_properties<I, void(Prop)> {
  ...
  struct find_convertible_property
      : conditional<is_same<T, Prop>::value || is_convertible<T, Prop>::value,
                    found, not_found>::type {};

  template <typename T>
  struct find_convertible_requirable_property
      : conditional<is_requirable<Prop>::value &&
  ...
  struct find_convertible_preferable_property
      : conditional<is_preferable<Prop>::value &&
                        (is_same<T, Prop>::value ||
                         is_convertible<T, Prop>::value),
                    found, not_found>::type {};

  struct find_context_as_property
      : conditional<is_context_as<Prop>::value, found, not_found>::type {};
};
...
struct supportable_properties<I, void(Head, Tail...)> {
  ...
  struct find_convertible_requirable_property
      : conditional<
            ...
            typename supportable_properties<I, void(Head)>::found,
            typename supportable_properties<I + 1, void(Tail...)>::
                template find_convertible_requirable_property<T>>::type {};
  ...
  struct find_convertible_preferable_property
      : conditional<
            ...
            typename supportable_properties<I, void(Head)>::found,
            typename supportable_properties<I + 1, void(Tail...)>::
                template find_convertible_preferable_property<T>>::type {};
...
#define ASIO_PRIVATE_ANY_EXECUTOR_PROPS_BASE_DEF(n)                            \
  template <std::size_t I, typename Head, ASIO_VARIADIC_TPARAMS(n)>            \
  struct supportable_properties<I, void(Head, ASIO_VARIADIC_TARGS(n))> {       \
    template <typename T>                                                      \
    struct is_valid_target                                                     \
        : integral_constant<                                                   \
              bool,                                                            \
              (supportable_properties<                                         \
                   I, void(Head)>::template is_valid_target<T>::value &&       \
               supportable_properties<I + 1, void(ASIO_VARIADIC_TARGS(n))>::   \
                   template is_valid_target<T>::value)> {};                    \
                                                                               \
    template <typename T>                                                      \
    struct find_convertible_property                                           \
    ...
    struct find_context_as_property                                            \
        : conditional<is_context_as<Head>::value,                              \
                      typename supportable_properties<I, void(Head)>::found,   \
                      typename supportable_properties<                         \
                          I + 1, void(ASIO_VARIADIC_TARGS(                     \
                                     n))>::find_context_as_property>::type {}; \
  };                                                                           \
  /**/
...
public:
  any_executor_base() ASIO_NOEXCEPT : object_fns_(object_fns_table<void>()),
                                      target_(0),
  ...
  any_executor_base(Executor other, true_type)
    ...
    asio::detail::shared_ptr<Executor> p =
        asio::detail::make_shared<Executor>(ASIO_MOVE_CAST(Executor)(other));
  ...
  ~any_executor_base() ASIO_NOEXCEPT { object_fns_->destroy(*this); }
  ...
  any_executor_base &operator=(any_executor_base &&other) ASIO_NOEXCEPT {
    if (this != &other) {
      object_fns_->destroy(*this);
      object_fns_ = other.object_fns_;
      other.object_fns_ = object_fns_table<void>();
  ...
  template <typename F> void execute(ASIO_MOVE_ARG(F) f) const {
    if (target_fns_->blocking_execute != 0) {
      ...
      target_fns_->execute(
          *this, function(ASIO_MOVE_CAST(F)(f), std::allocator<void>()));
    }
  }
  ...
  bool operator!() const ASIO_NOEXCEPT { return target_ == 0; }
...
protected:
  ...
  static const void *target_void(const any_executor_base &) { return 0; }

  template <typename Obj>
  static const object_fns *
  object_fns_table(typename enable_if<is_same<Obj, void>::value>::type * = 0) {
    static const object_fns fns = {
        &any_executor_base::destroy_void, &any_executor_base::copy_void,
        &any_executor_base::move_void, &any_executor_base::target_void};
    return &fns;
  }
  ...
  static const object_fns *object_fns_table(
      typename enable_if<
          is_same<Obj, asio::detail::shared_ptr<void>>::value>::type * = 0) {
    static const object_fns fns = {
...
#if !defined(ASIO_NO_TYPEID)
  static const std::type_info &target_type_void() { return typeid(void); }
#else  // !defined(ASIO_NO_TYPEID)
  ...
  target_fns_table(typename enable_if<is_same<Ex, void>::value>::type * = 0) {
    static const target_fns fns = {&any_executor_base::target_type_void,
  ...
  target_fns_table(bool is_always_blocking,
                   typename enable_if<!is_same<Ex, void>::value>::type * = 0) {
...
#pragma warning(disable : 4702)
  ...
  static void query_fn_non_void(
      ...
      typename enable_if<asio::can_query<const Ex &, const Prop &>::value &&
  ...
  static void query_fn_non_void(
      ...
      typename enable_if<
          asio::can_query<const Ex &, const Prop &>::value &&
          !is_same<typename Prop::polymorphic_query_result_type, void>::value &&
          is_scalar<typename Prop::polymorphic_query_result_type>::value>::type
          *) {
  ...
  template <typename Ex, class Prop>
  static void
  query_fn_impl(void *result, const void *ex, const void *prop,
                typename enable_if<is_same<Ex, void>::value>::type *) {
  ...
  static Poly
  require_fn_impl(const void *, const void *,
                  typename enable_if<is_same<Ex, void>::value>::type *) {
    bad_executor ex;
    asio::detail::throw_exception(ex);
    return Poly();
  ...
  static Poly require_fn_impl(const void *ex, const void *prop,
                              typename enable_if<!is_same<Ex, void>::value &&
                                                 Prop::is_requirable>::type *) {
  ...
  template <typename Poly, typename Ex, class Prop>
  static Poly
  prefer_fn_impl(const void *, const void *,
                 typename enable_if<is_same<Ex, void>::value>::type *) {
    bad_executor ex;
    asio::detail::throw_exception(ex);
    return Poly();
...
private:
  ...
  template <typename Executor> void construct_object(Executor &ex, false_type) {
    object_fns_ = object_fns_table<asio::detail::shared_ptr<void>>();
    asio::detail::shared_ptr<Executor> p =
        asio::detail::make_shared<Executor>(ASIO_MOVE_CAST(Executor)(ex));
    target_ = p.get();
    new (&object_) asio::detail::shared_ptr<void>(
        ASIO_MOVE_CAST(asio::detail::shared_ptr<Executor>)(p));
  }
...
public:
  any_executor() ASIO_NOEXCEPT : detail::any_executor_base() {}

  any_executor(nullptr_t) ASIO_NOEXCEPT : detail::any_executor_base() {}

  template <typename Executor>
  any_executor(Executor ex,
               typename enable_if<conditional<
                   !is_same<Executor, any_executor>::value &&
                       !is_base_of<detail::any_executor_base, Executor>::value,
                   is_executor<Executor>, false_type>::type::value>::type * = 0)
  ...
  friend typename enable_if<is_same<AnyExecutor1, any_executor>::value ||
                                is_same<AnyExecutor2, any_executor>::value,
                            bool>::type
  operator==(const AnyExecutor1 &a, const AnyExecutor2 &b) ASIO_NOEXCEPT {
    return static_cast<const any_executor &>(a).equality_helper(b);
  }

  template <typename AnyExecutor>
  friend
      typename enable_if<is_same<AnyExecutor, any_executor>::value, bool>::type
      operator==(const AnyExecutor &a, nullptr_t) ASIO_NOEXCEPT {
    return !a;
  }
  ...
  friend
      typename enable_if<is_same<AnyExecutor, any_executor>::value, bool>::type
      operator==(nullptr_t, const AnyExecutor &b) ASIO_NOEXCEPT {
    return !b;
  }
...
public:
  ...
  any_executor(
      ...
      typename enable_if<
          conditional<!is_same<any_executor<OtherSupportableProperties...>,
                               any_executor>::value,
                      typename detail::supportable_properties<
                      ...
                      false_type>::type::value>::type * = 0)
      : detail::any_executor_base(
            ASIO_MOVE_CAST(any_executor<OtherSupportableProperties...>)(other),
            true_type()),
        prop_fns_(
  ...
  query(const Property &p,
        typename enable_if<
            ...
            is_reference<typename find_convertible_property<
                Property>::query_result_type>::value>::type * = 0) const {
    typedef find_convertible_property<Property> found;
    typename remove_reference<typename found::query_result_type>::type *result =
        0;
    prop_fns_[found::index].query(
  ...
  any_executor require(const Property &p,
                       typename enable_if<find_convertible_requirable_property<
                           Property>::value>::type * = 0) const {
  ...
  any_executor prefer(const Property &p,
                      typename enable_if<find_convertible_preferable_property<
                          Property>::value>::type * = 0) const {
  ...
  public:                                                                      \
    ...
    any_executor(                                                              \
        ...
        typename enable_if<conditional<                                        \
            !is_same<Executor, any_executor>::value &&                         \
                !is_base_of<detail::any_executor_base, Executor>::value,       \
            detail::is_valid_target_executor<Executor,                         \
                                             void(ASIO_VARIADIC_TARGS(n))>,    \
            false_type>::type::value>::type * = 0)                             \
    ...
    any_executor(any_executor<> other)                                         \
        : detail::any_executor_base(ASIO_MOVE_CAST(any_executor<>)(other),     \
                                    true_type()),                              \
          prop_fns_(prop_fns_table<any_executor<>>()) {}                       \
                                                                               \
    template <typename OtherAnyExecutor>                                       \
    any_executor(                                                              \
        OtherAnyExecutor other,                                                \
        typename enable_if<                                                    \
            conditional<!is_same<OtherAnyExecutor, any_executor>::value &&     \
                        ...
                        false_type>::type::value>::type * = 0)                 \
        : detail::any_executor_base(ASIO_MOVE_CAST(OtherAnyExecutor)(other),   \
                                    true_type()),                              \
    ...
    operator==(const AnyExecutor1 &a, const AnyExecutor2 &b) ASIO_NOEXCEPT {   \
      return static_cast<const any_executor &>(a).equality_helper(b);          \
                                                                               ...
                                                                               \
    template <typename AnyExecutor>                                            \
    friend typename enable_if<is_same<AnyExecutor, any_executor>::value,       \
                              bool>::type                                      \
    operator==(const AnyExecutor &a, nullptr_t) ASIO_NOEXCEPT {                \
      return !a;                                                               \
    }                                                                          \
    ...
    template <typename T>                                                      \
    struct find_convertible_property                                           \
        : detail::supportable_properties<0, void(ASIO_VARIADIC_TARGS(n))>::    \
              template find_convertible_property<T> {};                        \
                                                                               \
    template <typename Property>                                               \
    void                                                                       \
    ...
    typename find_convertible_property<Property>::query_result_type query(     \
        const Property &p,                                                     \
        typename enable_if<!is_same<typename find_convertible_property<        \
                                        Property>::query_result_type,          \
                                    void>::value &&                            \
                           is_reference<typename find_convertible_property<    \
                               Property>::query_result_type>::value>::type * = \
            0) const {                                                         \
      typedef find_convertible_property<Property> found;                       \
      typename remove_reference<typename found::query_result_type>::type       \
          *result;                                                             \
      prop_fns_[found::index].query(                                           \
          &result, object_fns_->target(*this),                                 \
          &static_cast<const typename found::type &>(p));                      \
    ...
    any_executor require(                                                      \
        const Property &p,                                                     \
        typename enable_if<                                                    \
            find_convertible_requirable_property<Property>::value>::type * =   \
            0) const {                                                         \
      typedef find_convertible_requirable_property<Property> found;            \
      return prop_fns_[found::index].require(                                  \
          object_fns_->target(*this),                                          \
    ...
    any_executor prefer(                                                       \
        const Property &p,                                                     \
        typename enable_if<                                                    \
            find_convertible_preferable_property<Property>::value>::type * =   \
            0) const {                                                         \
      typedef find_convertible_preferable_property<Property> found;            \
      return prop_fns_[found::index].prefer(                                   \
          object_fns_->target(*this),                                          \
    ...
    static const prop_fns<any_executor> *prop_fns_table() {                    \
      ...
      return fns;                                                              \
                                                                               ...
                                                                               \
    const prop_fns<any_executor> *prop_fns_;                                   \
    typedef detail::supportable_properties<0, void(ASIO_VARIADIC_TARGS(n))>    \
...
template <> struct equality_comparable<execution::any_executor<>> {
  static const bool is_valid = true;
  static const bool is_noexcept = true;
};
...
#define ASIO_PRIVATE_ANY_EXECUTOR_EQUALITY_COMPARABLE_DEF(n)                   \
  ...
  /**/
ASIO_VARIADIC_GENERATE(ASIO_PRIVATE_ANY_EXECUTOR_EQUALITY_COMPARABLE_DEF)
...
template <typename F> struct execute_member<execution::any_executor<>, F> {
  static const bool is_valid = true;
  static const bool is_noexcept = false;
  typedef void result_type;
};
...
#define ASIO_PRIVATE_ANY_EXECUTOR_EXECUTE_MEMBER_DEF(n)                        \
  ...
  struct execute_member<execution::any_executor<ASIO_VARIADIC_TARGS(n)>, F> {  \
    static const bool is_valid = true;                                         \
    static const bool is_noexcept = false;                                     \
    typedef void result_type;                                                  \
  };                                                                           \
...
struct query_member<
    ...
    typename enable_if<
        execution::detail::supportable_properties<
            0, void(SupportableProperties...)>::
            template find_convertible_property<Prop>::value>::type> {
  static const bool is_valid = true;
  static const bool is_noexcept = false;
...
#define ASIO_PRIVATE_ANY_EXECUTOR_QUERY_MEMBER_DEF(n)                          \
  ...
  struct query_member<                                                         \
      ...
      typename enable_if<execution::detail::supportable_properties<            \
          0,                                                                   \
          void(ASIO_VARIADIC_TARGS(                                            \
              n))>::template find_convertible_property<Prop>::value>::type> {  \
    static const bool is_valid = true;                                         \
    static const bool is_noexcept = false;                                     \
    typedef typename execution::detail::supportable_properties<                \
        0, void(ASIO_VARIADIC_TARGS(n))>::                                     \
        template find_convertible_property<Prop>::query_result_type            \
            result_type;                                                       \
  };                                                                           \
  /**/
...
struct require_member<
    ...
    typename enable_if<
        execution::detail::supportable_properties<
            0, void(SupportableProperties...)>::
            template find_convertible_requirable_property<Prop>::value>::type> {
  static const bool is_valid = true;
  static const bool is_noexcept = false;
...
#define ASIO_PRIVATE_ANY_EXECUTOR_REQUIRE_MEMBER_DEF(n)                        \
  ...
  struct require_member<                                                       \
      execution::any_executor<ASIO_VARIADIC_TARGS(n)>, Prop,                   \
      typename enable_if<execution::detail::supportable_properties<            \
          0, void(ASIO_VARIADIC_TARGS(                                         \
                 n))>::template find_convertible_requirable_property<Prop>::   \
                             value>::type> {                                   \
    static const bool is_valid = true;                                         \
    static const bool is_noexcept = false;                                     \
...
struct prefer_member<
    ...
    typename enable_if<
        execution::detail::supportable_properties<
            0, void(SupportableProperties...)>::
            template find_convertible_preferable_property<Prop>::value>::type> {
  static const bool is_valid = true;
  static const bool is_noexcept = false;
  typedef execution::any_executor<SupportableProperties...> result_type;
};
...
#define ASIO_PRIVATE_ANY_EXECUTOR_PREFER_FREE_DEF(n)                           \
  ...
  struct prefer_member<                                                        \
      ...
      typename enable_if<execution::detail::supportable_properties<            \
          0, void(ASIO_VARIADIC_TARGS(                                         \
                 n))>::template find_convertible_preferable_property<Prop>::   \
                             value>::type> {                                   \
    static const bool is_valid = true;                                         \
    static const bool is_noexcept = false;                                     \
    typedef execution::any_executor<ASIO_VARIADIC_TARGS(n)> result_type;       \
