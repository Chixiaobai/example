...
void blocking_execute(ASIO_MOVE_ARG(Executor) ex, ASIO_MOVE_ARG(Function) func);
...
template <int I = 0> struct blocking_t {
  ...
  ASIO_CONSTEXPR blocking_t() : value_(-1) {}

  ASIO_CONSTEXPR blocking_t(possibly_t) : value_(0) {}

  ASIO_CONSTEXPR blocking_t(always_t) : value_(1) {}

  ASIO_CONSTEXPR blocking_t(never_t) : value_(2) {}
  ...
  static ASIO_CONSTEXPR
      ...
      static_query(
          typename enable_if<
              ...
              traits::static_query<T, possibly_t>::is_valid>::type * = 0)
          ASIO_NOEXCEPT {
    return traits::static_query<T, possibly_t>::value();
  }

  template <typename T>
  static ASIO_CONSTEXPR typename traits::static_query<T, always_t>::result_type
  static_query(
      typename enable_if<
          !traits::query_static_constexpr_member<T, blocking_t>::is_valid &&
          !traits::query_member<T, blocking_t>::is_valid &&
          !traits::static_query<T, possibly_t>::is_valid &&
          traits::static_query<T, always_t>::is_valid>::type * = 0)
      ASIO_NOEXCEPT {
    return traits::static_query<T, always_t>::value();
  }

  template <typename T>
  static ASIO_CONSTEXPR typename traits::static_query<T, never_t>::result_type
  static_query(
      typename enable_if<
          !traits::query_static_constexpr_member<T, blocking_t>::is_valid &&
          !traits::query_member<T, blocking_t>::is_valid &&
          ...
          traits::static_query<T, never_t>::is_valid>::type * = 0)
      ASIO_NOEXCEPT {
    return traits::static_query<T, never_t>::value();
  }

  template <typename E, typename T = decltype(blocking_t::static_query<E>())>
  static ASIO_CONSTEXPR const T static_query_v = blocking_t::static_query<E>();
#endif                  // defined(ASIO_HAS_DEDUCED_STATIC_QUERY_TRAIT)
                        //   && defined(ASIO_HAS_SFINAE_VARIABLE_TEMPLATES)

  friend ASIO_CONSTEXPR bool operator==(const blocking_t &a,
                                        const blocking_t &b) {
  ...
  friend ASIO_CONSTEXPR blocking_t
  query(const Executor &ex, convertible_from_blocking_t,
        typename enable_if<can_query<const Executor &, possibly_t>::value>::type
            * = 0)
      ...
      ASIO_NOEXCEPT_IF((is_nothrow_query<const Executor &, possibly_t>::value))
  ...
  friend ASIO_CONSTEXPR blocking_t query(
      ...
      typename enable_if<!can_query<const Executor &, possibly_t>::value &&
                         can_query<const Executor &, always_t>::value>::type * =
          0)
#if !defined(__clang__) // Clang crashes if noexcept is used here.
#if defined(ASIO_MSVC)  // Visual C++ wants the type to be qualified.
      ASIO_NOEXCEPT_IF(
...
#else                   // defined(ASIO_MSVC)
      ASIO_NOEXCEPT_IF((is_nothrow_query<const Executor &, always_t>::value))
#endif                  // defined(ASIO_MSVC)
#endif                  // !defined(__clang__)
  {
  ...
  friend ASIO_CONSTEXPR blocking_t query(
      ...
      typename enable_if<!can_query<const Executor &, possibly_t>::value &&
                         ...
                         can_query<const Executor &, never_t>::value>::type * =
          0)
#if !defined(__clang__) // Clang crashes if noexcept is used here.
#if defined(ASIO_MSVC)  // Visual C++ wants the type to be qualified.
      ASIO_NOEXCEPT_IF(
...
#else                   // defined(ASIO_MSVC)
      ASIO_NOEXCEPT_IF((is_nothrow_query<const Executor &, never_t>::value))
#endif                  // defined(ASIO_MSVC)
#endif                  // !defined(__clang__)
  {
...
#if !defined(ASIO_HAS_CONSTEXPR)
template <int I> const blocking_t<I> blocking_t<I>::instance;
#endif
...
template <int I = 0> struct possibly_t {
  ...
  static ASIO_CONSTEXPR possibly_t static_query(
      typename enable_if<
          ...
          !can_query<T, never_t<I>>::value>::type * = 0) ASIO_NOEXCEPT {
    return possibly_t();
  }

  template <typename E, typename T = decltype(possibly_t::static_query<E>())>
  static ASIO_CONSTEXPR const T static_query_v = possibly_t::static_query<E>();
#endif // defined(ASIO_HAS_SFINAE_VARIABLE_TEMPLATES)
       //   && defined(ASIO_HAS_SFINAE_VARIABLE_TEMPLATES)

  static ASIO_CONSTEXPR blocking_t<I> value() { return possibly_t(); }

  friend ASIO_CONSTEXPR bool operator==(const possibly_t &,
                                        const possibly_t &) {
    return true;
  }
...
public:
  adapter(int, const Executor &e) ASIO_NOEXCEPT : executor_(e) {}

  adapter(const adapter &other) ASIO_NOEXCEPT : executor_(other.executor_) {}
  ...
  typename enable_if<
      ...
      typename query_result<const Executor &, Property>::type>::type
  query(const Property &p) const
      ASIO_NOEXCEPT_IF((is_nothrow_query<const Executor &, Property>::value)) {
  ...
  typename enable_if<
      ...
      typename require_result<const Executor &, possibly_t<I>>::type>::type
  require(possibly_t<I>) const ASIO_NOEXCEPT {
  ...
  typename enable_if<
      ...
      typename require_result<const Executor &, never_t<I>>::type>::type
  require(never_t<I>) const ASIO_NOEXCEPT {
    return asio::require(executor_, never_t<I>());
  }

  template <typename Property>
  typename enable_if<can_require<const Executor &, Property>::value,
                     adapter<typename decay<typename require_result<
                         const Executor &, Property>::type>::type>>::type
  require(const Property &p) const ASIO_NOEXCEPT_IF(
  ...
  template <typename Property>
  typename enable_if<can_prefer<const Executor &, Property>::value,
                     adapter<typename decay<typename prefer_result<
                         const Executor &, Property>::type>::type>>::type
  prefer(const Property &p) const
      ASIO_NOEXCEPT_IF((is_nothrow_prefer<const Executor &, Property>::value)) {
    return adapter<typename decay<
  ...
  typename enable_if<
      execution::can_execute<const Executor &, Function>::value>::type
  execute(ASIO_MOVE_ARG(Function) f) const {
    blocking_adaptation::blocking_execute(executor_,
                                          ASIO_MOVE_CAST(Function)(f));
  }
...
template <int I = 0> struct always_t {
  ...
  static ASIO_CONSTEXPR const T static_query_v = always_t::static_query<E>();
#endif // defined(ASIO_HAS_SFINAE_VARIABLE_TEMPLATES)
       //   && defined(ASIO_HAS_SFINAE_VARIABLE_TEMPLATES)

  static ASIO_CONSTEXPR blocking_t<I> value() { return always_t(); }

  friend ASIO_CONSTEXPR bool operator==(const always_t &, const always_t &) {
    return true;
  }
  ...
  friend ASIO_CONSTEXPR bool operator==(const always_t &,
                                        const possibly_t<I> &) {
    return false;
  }
  ...
  friend ASIO_CONSTEXPR bool operator==(const always_t &, const never_t<I> &) {
    return false;
  }
  ...
  friend adapter<Executor> require(
      ...
      typename enable_if<is_executor<Executor>::value &&
                         traits::static_require<
                             const Executor &,
                             blocking_adaptation::allowed_t<0>>::is_valid>::type
          * = 0) {
...
template <int I> struct never_t {
  ...
  static ASIO_CONSTEXPR const T static_query_v = never_t::static_query<E>();
#endif // defined(ASIO_HAS_DEDUCED_STATIC_QUERY_TRAIT)
       //   && defined(ASIO_HAS_SFINAE_VARIABLE_TEMPLATES)

  static ASIO_CONSTEXPR blocking_t<I> value() { return never_t(); }

  friend ASIO_CONSTEXPR bool operator==(const never_t &, const never_t &) {
    return true;
  }
  ...
  friend ASIO_CONSTEXPR bool operator==(const never_t &,
                                        const possibly_t<I> &) {
    return false;
  }
  ...
  friend ASIO_CONSTEXPR bool operator==(const never_t &, const always_t<I> &) {
    return false;
  }
...
struct query_free_default<
    ...
    typename enable_if<
        can_query<T, execution::blocking_t::possibly_t>::value>::type> {
...
struct query_free_default<
    ...
    typename enable_if<
        ...
        can_query<T, execution::blocking_t::always_t>::value>::type> {
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(
      bool, is_noexcept =
...
struct query_free_default<
    ...
    typename enable_if<
        ...
        can_query<T, execution::blocking_t::never_t>::value>::type> {
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(
      bool, is_noexcept =
...
struct static_query<T, execution::blocking_t,
                    typename enable_if<traits::query_static_constexpr_member<
                        T, execution::blocking_t>::is_valid>::type> {
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);

  typedef typename traits::query_static_constexpr_member<
      T, execution::blocking_t>::result_type result_type;

  static ASIO_CONSTEXPR result_type value() {
    return traits::query_static_constexpr_member<
        T, execution::blocking_t>::value();
  }
};
...
struct static_query<
    ...
    typename enable_if<
        !traits::query_static_constexpr_member<
            T, execution::blocking_t>::is_valid &&
...
struct static_query<
    ...
    typename enable_if<
        ...
        traits::static_query<T,
                             execution::blocking_t::never_t>::is_valid>::type> {
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
...
struct static_query<
    ...
    typename enable_if<traits::query_static_constexpr_member<
        T, execution::blocking_t::possibly_t>::is_valid>::type> {
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  ...
  static ASIO_CONSTEXPR result_type value() {
    return traits::query_static_constexpr_member<
        T, execution::blocking_t::possibly_t>::value();
  }
};
...
struct static_query<
    ...
    typename enable_if<
        !traits::query_static_constexpr_member<
            T, execution::blocking_t::possibly_t>::is_valid &&
  ...
  static ASIO_CONSTEXPR result_type value() { return result_type(); }
};

template <typename T>
struct static_query<T, execution::blocking_t::always_t,
                    typename enable_if<traits::query_static_constexpr_member<
                        T, execution::blocking_t::always_t>::is_valid>::type> {
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  ...
  static ASIO_CONSTEXPR result_type value() {
    return traits::query_static_constexpr_member<
        T, execution::blocking_t::always_t>::value();
  }
};
...
struct static_query<T, execution::blocking_t::never_t,
                    typename enable_if<traits::query_static_constexpr_member<
                        T, execution::blocking_t::never_t>::is_valid>::type> {
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  ...
  static ASIO_CONSTEXPR result_type value() {
    return traits::query_static_constexpr_member<
        T, execution::blocking_t::never_t>::value();
  }
};
...
struct static_require<
    T, execution::blocking_t::possibly_t,
    typename enable_if<
        static_query<T, execution::blocking_t::possibly_t>::is_valid>::type> {
  ASIO_STATIC_CONSTEXPR(
      bool, is_valid =
                (is_same<typename static_query<
                             T, execution::blocking_t::possibly_t>::result_type,
...
struct static_require<
    ...
    typename enable_if<
        static_query<T, execution::blocking_t::always_t>::is_valid>::type> {
  ASIO_STATIC_CONSTEXPR(
      bool,
      is_valid = (is_same<typename static_query<
                              T, execution::blocking_t::always_t>::result_type,
                          execution::blocking_t::always_t>::value));
};

template <typename T>
struct static_require<T, execution::blocking_t::never_t,
                      typename enable_if<static_query<
                          T, execution::blocking_t::never_t>::is_valid>::type> {
  ASIO_STATIC_CONSTEXPR(
      bool,
      is_valid = (is_same<typename static_query<
                              T, execution::blocking_t::never_t>::result_type,
...
struct require_free_default<
    T, execution::blocking_t::always_t,
    typename enable_if<is_same<T, typename decay<T>::type>::value &&
                       execution::is_executor<T>::value &&
                       traits::static_require<
                           const T &, execution::detail::blocking_adaptation::
                                          allowed_t<0>>::is_valid>::type> {
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
...
struct query_member<
    ...
    typename enable_if<can_query<const Executor &, Property>::value>::type> {
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(
      bool, is_noexcept = (is_nothrow_query<Executor, Property>::value));
...
struct require_member<
    ...
    execution::detail::blocking::possibly_t<I>,
    typename enable_if<
        can_require<const Executor &,
                    execution::detail::blocking::possibly_t<I>>::value>::type> {
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(
      bool, is_noexcept = (is_nothrow_require<
                           const Executor &,
                           execution::detail::blocking::possibly_t<I>>::value));
  typedef
      typename require_result<const Executor &,
                              execution::detail::blocking::possibly_t<I>>::type
          result_type;
};
...
struct require_member<
    ...
    typename enable_if<
        can_require<const Executor &,
                    execution::detail::blocking::never_t<I>>::value>::type> {
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(
      bool,
      is_noexcept =
  ...
  typedef typename require_result<const Executor &,
                                  execution::detail::blocking::never_t<I>>::type
      result_type;
};
...
struct require_member<
    execution::detail::blocking::adapter<Executor>, Property,
    typename enable_if<can_require<const Executor &, Property>::value>::type> {
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(
      bool, is_noexcept = (is_nothrow_require<Executor, Property>::value));
  typedef execution::detail::blocking::adapter<
      typename decay<typename require_result<Executor, Property>::type>::type>
      result_type;
};
...
struct prefer_member<
    execution::detail::blocking::adapter<Executor>, Property,
    typename enable_if<can_prefer<const Executor &, Property>::value>::type> {
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(
      bool, is_noexcept = (is_nothrow_prefer<Executor, Property>::value));
  typedef execution::detail::blocking::adapter<
      typename decay<typename prefer_result<Executor, Property>::type>::type>
      result_type;
};
