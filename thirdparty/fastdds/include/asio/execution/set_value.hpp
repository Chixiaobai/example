...
struct can_set_value : integral_constant<bool, automatically_determined> {};
...
enum overload_type { call_member, call_free, ill_formed };

template <typename R, typename Vs, typename = void> struct call_traits {
...
struct call_traits<R, Vs,
                   typename enable_if<(!set_value_member<R, Vs>::is_valid &&
                                       set_value_free<R, Vs>::is_valid)>::type>
    : set_value_free<R, Vs> {
...
struct impl {
  ...
  ASIO_CONSTEXPR typename enable_if<
      ...
      typename call_traits<R, void(Vs...)>::result_type>::type
  operator()(R &&r, Vs &&... v) const
      ASIO_NOEXCEPT_IF((call_traits<R, void(Vs...)>::is_noexcept)) {
  ...
  operator()(R &&r, Vs &&... v) const
      ASIO_NOEXCEPT_IF((call_traits<R, void(Vs...)>::is_noexcept)) {
    return set_value(ASIO_MOVE_CAST(R)(r), ASIO_MOVE_CAST(Vs)(v)...);
  }
  ...
  template <typename R>
  ASIO_CONSTEXPR
      typename enable_if<call_traits<R, void()>::overload == call_member,
                         typename call_traits<R, void()>::result_type>::type
      operator()(R &&r) const
      ASIO_NOEXCEPT_IF((call_traits<R, void()>::is_noexcept)) {
    return ASIO_MOVE_CAST(R)(r).set_value();
  }

  template <typename R>
  ASIO_CONSTEXPR
      typename enable_if<call_traits<R, void()>::overload == call_free,
                         typename call_traits<R, void()>::result_type>::type
      operator()(R &&r) const
      ASIO_NOEXCEPT_IF((call_traits<R, void()>::is_noexcept)) {
...
#define ASIO_PRIVATE_SET_VALUE_CALL_DEF(n)                                     \
  ...
  ASIO_CONSTEXPR typename enable_if<                                           \
      call_traits<R, void(ASIO_VARIADIC_TARGS(n))>::overload == call_member,   \
      typename call_traits<R,                                                  \
                           void(ASIO_VARIADIC_TARGS(n))>::result_type>::type   \
  operator()(R &&r, ASIO_VARIADIC_MOVE_PARAMS(n)) const ASIO_NOEXCEPT_IF(      \
      (call_traits<R, void(ASIO_VARIADIC_TARGS(n))>::is_noexcept)) {           \
    return ASIO_MOVE_CAST(R)(r).set_value(ASIO_VARIADIC_MOVE_ARGS(n));         \
  }                                                                            \
                                                                               \
  template <typename R, ASIO_VARIADIC_TPARAMS(n)>                              \
  ASIO_CONSTEXPR typename enable_if<                                           \
  ...
  operator()(R &&r, ASIO_VARIADIC_MOVE_PARAMS(n)) const ASIO_NOEXCEPT_IF(      \
      (call_traits<R, void(ASIO_VARIADIC_TARGS(n))>::is_noexcept)) {           \
    return set_value(ASIO_MOVE_CAST(R)(r), ASIO_VARIADIC_MOVE_ARGS(n));        \
  }                                                                            \
  /**/
...
#undef ASIO_PRIVATE_SET_VALUE_CALL_DEF
  ...
  ASIO_CONSTEXPR typename enable_if<
      ...
      typename call_traits<R &, void(const Vs &...)>::result_type>::type
  operator()(R &r, const Vs &... v) const
      ASIO_NOEXCEPT_IF((call_traits<R &, void(const Vs &...)>::is_noexcept)) {
  ...
  ASIO_CONSTEXPR typename enable_if<
      ...
      typename call_traits<const R &, void(const Vs &...)>::result_type>::type
  operator()(const R &r, const Vs &... v) const ASIO_NOEXCEPT_IF(
  ...
  ASIO_CONSTEXPR typename enable_if<
      ...
      typename call_traits<const R &, void()>::result_type>::type
  operator()(const R &r) const
      ASIO_NOEXCEPT_IF((call_traits<const R &, void()>::is_noexcept)) {
    return r.set_value();
  }
...
#define ASIO_PRIVATE_SET_VALUE_CALL_DEF(n)                                     \
  ...
  template <typename R, ASIO_VARIADIC_TPARAMS(n)>                              \
  ASIO_CONSTEXPR typename enable_if<                                           \
      call_traits<const R &, void(ASIO_VARIADIC_TARGS(n))>::overload ==        \
          call_member,                                                         \
      typename call_traits<const R &,                                          \
                           void(ASIO_VARIADIC_TARGS(n))>::result_type>::type   \
  operator()(const R &r, ASIO_VARIADIC_MOVE_PARAMS(n)) const ASIO_NOEXCEPT_IF( \
...
static ASIO_CONSTEXPR const asio_execution_set_value_fn::impl &set_value =
    asio_execution_set_value_fn::static_instance<>::instance;
...
struct can_set_value
    : integral_constant<bool, asio_execution_set_value_fn::call_traits<
                                  R, void(Vs...)>::overload !=
...
template <typename R, typename = void, typename = void, typename = void,
...
struct can_set_value<R>
    : integral_constant<
          bool, asio_execution_set_value_fn::call_traits<R, void()>::overload !=
                    asio_execution_set_value_fn::ill_formed> {};
...
#define ASIO_PRIVATE_SET_VALUE_TRAITS_DEF(n)                                   \
  ...
  struct can_set_value<R, ASIO_VARIADIC_TARGS(n)>                              \
      : integral_constant<bool,                                                \
                          asio_execution_set_value_fn::call_traits<            \
                              R, void(ASIO_VARIADIC_TARGS(n))>::overload !=    \
                              asio_execution_set_value_fn::ill_formed> {};     \
                                                                               \
  template <typename R, ASIO_VARIADIC_TPARAMS(n)>                              \
  struct is_nothrow_set_value<R, ASIO_VARIADIC_TARGS(n)>                       \
      : integral_constant<bool,                                                \
                          asio_execution_set_value_fn::call_traits<            \
                              R, void(ASIO_VARIADIC_TARGS(n))>::is_noexcept> { \
  };                                                                           \
  /**/
