...
struct can_submit : integral_constant<bool, automatically_determined> {};
...
template <typename S, typename R, typename = void> struct call_traits {
...
struct call_traits<S, void(R),
                   typename enable_if<(submit_member<S, R>::is_valid &&
                                       is_sender_to<S, R>::value)>::type>
    : submit_member<S, R> {
...
struct impl {
  ...
  template <typename S, typename R>
  ASIO_CONSTEXPR
      typename enable_if<call_traits<S, void(R)>::overload == call_member,
                         typename call_traits<S, void(R)>::result_type>::type
      operator()(S &&s, R &&r) const
      ASIO_NOEXCEPT_IF((call_traits<S, void(R)>::is_noexcept)) {
    return ASIO_MOVE_CAST(S)(s).submit(ASIO_MOVE_CAST(R)(r));
  }

  template <typename S, typename R>
  ASIO_CONSTEXPR
      typename enable_if<call_traits<S, void(R)>::overload == call_free,
                         typename call_traits<S, void(R)>::result_type>::type
      operator()(S &&s, R &&r) const
      ASIO_NOEXCEPT_IF((call_traits<S, void(R)>::is_noexcept)) {
  ...
  template <typename S, typename R>
  ASIO_CONSTEXPR
      typename enable_if<call_traits<S, void(R)>::overload == adapter,
                         typename call_traits<S, void(R)>::result_type>::type
      operator()(S &&s, R &&r) const
      ASIO_NOEXCEPT_IF((call_traits<S, void(R)>::is_noexcept)) {
  ...
  ASIO_CONSTEXPR typename enable_if<
      ...
      typename call_traits<const S &, void(R &)>::result_type>::type
  operator()(const S &s, R &r) const
      ASIO_NOEXCEPT_IF((call_traits<const S &, void(R &)>::is_noexcept)) {
    return s.submit(r);
  }
  ...
  operator()(S &s, R &r) const
      ASIO_NOEXCEPT_IF((call_traits<S &, void(R &)>::is_noexcept)) {
    return asio::execution::start(
        (new asio::execution::detail::submit_receiver<S &, R &>(s, r))->state_);
  }
  ...
  operator()(const S &s, R &r) const
    ...
    asio::execution::start(
        (new asio::execution::detail::submit_receiver<const S &, R &>(s, r))
            ->state_);
  }
  ...
  ASIO_CONSTEXPR typename enable_if<
      ...
      typename call_traits<S &, void(const R &)>::result_type>::type
  operator()(S &s, const R &r) const
      ASIO_NOEXCEPT_IF((call_traits<S &, void(const R &)>::is_noexcept)) {
    return s.submit(r);
  }
  ...
  ASIO_CONSTEXPR typename enable_if<
      ...
      typename call_traits<const S &, void(const R &)>::result_type>::type
  operator()(const S &s, const R &r) const
      ASIO_NOEXCEPT_IF((call_traits<const S &, void(const R &)>::is_noexcept)) {
    return s.submit(r);
  }
  ...
  operator()(S &s, const R &r) const
      ASIO_NOEXCEPT_IF((call_traits<S &, void(const R &)>::is_noexcept)) {
    asio::execution::start(
        (new asio::execution::detail::submit_receiver<S &, const R &>(s, r))
            ->state_);
  }
  ...
  operator()(const S &s, const R &r) const
      ASIO_NOEXCEPT_IF((call_traits<const S &, void(const R &)>::is_noexcept)) {
    asio::execution::start(
        (new asio::execution::detail::submit_receiver<const S &, const R &>(s,
                                                                            r))
            ->state_);
  }
...
static ASIO_CONSTEXPR const asio_execution_submit_fn::impl &submit =
    asio_execution_submit_fn::static_instance<>::instance;
...
struct can_submit
    : integral_constant<
          bool, asio_execution_submit_fn::call_traits<S, void(R)>::overload !=
...
struct is_nothrow_submit
    : integral_constant<bool, asio_execution_submit_fn::call_traits<
                                  S, void(R)>::is_noexcept> {};

#if defined(ASIO_HAS_VARIABLE_TEMPLATES)

template <typename S, typename R>
constexpr bool is_nothrow_submit_v = is_nothrow_submit<S, R>::value;

#endif // defined(ASIO_HAS_VARIABLE_TEMPLATES)

template <typename S, typename R> struct submit_result {
  typedef
      typename asio_execution_submit_fn::call_traits<S, void(R)>::result_type
          type;
};
