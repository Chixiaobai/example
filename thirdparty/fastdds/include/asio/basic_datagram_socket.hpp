...
public:
  ...
  async_send(const ConstBufferSequence &buffers,
    ...
    return async_initiate<WriteHandler, void(asio::error_code, std::size_t)>(
        initiate_async_send(this), handler, buffers,
  ...
  async_receive(const MutableBufferSequence &buffers,
    ...
    return async_initiate<ReadHandler, void(asio::error_code, std::size_t)>(
        initiate_async_receive(this), handler, buffers,
        socket_base::message_flags(0));
  }
...
private:
  ...
  basic_datagram_socket &operator=(const basic_datagram_socket &) ASIO_DELETED;
