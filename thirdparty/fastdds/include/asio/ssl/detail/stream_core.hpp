...
#if defined(ASIO_HAS_BOOST_DATE_TIME)
        pending_read_(
            ASIO_MOVE_CAST(asio::deadline_timer)(other.pending_read_)),
        pending_write_(
            ASIO_MOVE_CAST(asio::deadline_timer)(other.pending_write_)),
#else  // defined(ASIO_HAS_BOOST_DATE_TIME)
        pending_read_(ASIO_MOVE_CAST(asio::steady_timer)(other.pending_read_)),
        pending_write_(
            ASIO_MOVE_CAST(asio::steady_timer)(other.pending_write_)),
#endif // defined(ASIO_HAS_BOOST_DATE_TIME)
        output_buffer_space_(ASIO_MOVE_CAST(std::vector<unsigned char>)(
            other.output_buffer_space_)),
        output_buffer_(other.output_buffer_),
        input_buffer_space_(ASIO_MOVE_CAST(std::vector<unsigned char>)(
