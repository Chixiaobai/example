...
asio_handler_allocate(std::size_t size, binder1<Handler, Arg1> *this_handler) {
...
asio_handler_invoke(Function &function, binder1<Handler, Arg1> *this_handler) {
...
public:
  template <typename T>
  binder3(int, ASIO_MOVE_ARG(T) handler, const Arg1 &arg1, const Arg2 &arg2,
          const Arg3 &arg3)
      : handler_(ASIO_MOVE_CAST(T)(handler)), arg1_(arg1), arg2_(arg2),
        arg3_(arg3) {}
...
bind_handler(ASIO_MOVE_ARG(Handler) handler, const Arg1 &arg1, const Arg2 &arg2,
             const Arg3 &arg3) {
...
public:
  template <typename T>
  binder4(int, ASIO_MOVE_ARG(T) handler, const Arg1 &arg1, const Arg2 &arg2,
...
public:
  template <typename T>
  binder5(int, ASIO_MOVE_ARG(T) handler, const Arg1 &arg1, const Arg2 &arg2,
...
public:
  move_binder2(int, ASIO_MOVE_ARG(Handler) handler, const Arg1 &arg1,
