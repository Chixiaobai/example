...
public:
  ...
  allocator_binder(ASIO_MOVE_ARG(F) f, const Allocator &a)
      : f_(ASIO_MOVE_CAST(F)(f)), allocator_(a) {}
  ...
  struct on_invoker_exit {
    ...
    ~on_invoker_exit() {
      ...
      if (more_handlers) {
        ...
        execution::execute(
            asio::prefer(
                asio::require(this_->executor_, execution::blocking.never),
...
inline void strand_executor_service::execute(
    ...
    typename enable_if<
        can_query<Executor, execution::allocator_t<void>>::value>::type *) {
  return strand_executor_service::do_execute(
      impl, ex, ASIO_MOVE_CAST(Function)(function),
...
inline void strand_executor_service::execute(
    ...
    typename enable_if<
        !can_query<Executor, execution::allocator_t<void>>::value>::type *) {
  return strand_executor_service::do_execute(
      impl, ex, ASIO_MOVE_CAST(Function)(function), std::allocator<void>());
}
