...
public:
  ...
  reactive_socket_accept_op(const asio::error_code &success_ec,
      ...
      : reactive_socket_accept_op_base<Socket, Protocol>(
        ...
        handler_(ASIO_MOVE_CAST(Handler)(handler)), work_(handler_, io_ex) {}
  ...
  static void do_complete(void *owner, operation *base,
    ...
    handler_work<Handler, IoExecutor> w(
        ASIO_MOVE_CAST2(handler_work<Handler, IoExecutor>)(o->work_));
...
public:
  ...
  static void do_complete(void *owner, operation *base,
    ...
    detail::move_binder2<Handler, asio::error_code, peer_socket_type> handler(
        0, ASIO_MOVE_CAST(Handler)(o->handler_), o->ec_,
