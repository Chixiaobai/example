...
#define ASIO_VARIADIC_BYVAL_PARAMS_6 T1 x1, T2 x2, T3 x3, T4 x4, T5 x5, T6 x6
#define ASIO_VARIADIC_BYVAL_PARAMS_7                                           \
  T1 x1, T2 x2, T3 x3, T4 x4, T5 x5, T6 x6, T7 x7
#define ASIO_VARIADIC_BYVAL_PARAMS_8                                           \
...
#define ASIO_VARIADIC_MOVE_PARAMS_7                                            \
  ASIO_MOVE_ARG(T1)                                                            \
  x1, ASIO_MOVE_ARG(T2) x2, ASIO_MOVE_ARG(T3) x3, ASIO_MOVE_ARG(T4) x4,        \
      ASIO_MOVE_ARG(T5) x5, ASIO_MOVE_ARG(T6) x6, ASIO_MOVE_ARG(T7) x7
...
#define ASIO_VARIADIC_UNNAMED_MOVE_PARAMS_1 ASIO_MOVE_ARG(T1)
#define ASIO_VARIADIC_UNNAMED_MOVE_PARAMS_2 ASIO_MOVE_ARG(T1), ASIO_MOVE_ARG(T2)
#define ASIO_VARIADIC_UNNAMED_MOVE_PARAMS_3                                    \
  ASIO_MOVE_ARG(T1), ASIO_MOVE_ARG(T2), ASIO_MOVE_ARG(T3)
#define ASIO_VARIADIC_UNNAMED_MOVE_PARAMS_4                                    \
  ASIO_MOVE_ARG(T1), ASIO_MOVE_ARG(T2), ASIO_MOVE_ARG(T3), ASIO_MOVE_ARG(T4)
...
#define ASIO_VARIADIC_UNNAMED_MOVE_PARAMS_7                                    \
  ASIO_MOVE_ARG(T1), ASIO_MOVE_ARG(T2), ASIO_MOVE_ARG(T3), ASIO_MOVE_ARG(T4),  \
      ASIO_MOVE_ARG(T5), ASIO_MOVE_ARG(T6), ASIO_MOVE_ARG(T7)
...
#define ASIO_VARIADIC_MOVE_ARGS_6                                              \
  ASIO_MOVE_CAST(T1)                                                           \
  (x1), ASIO_MOVE_CAST(T2)(x2), ASIO_MOVE_CAST(T3)(x3),                        \
      ASIO_MOVE_CAST(T4)(x4), ASIO_MOVE_CAST(T5)(x5), ASIO_MOVE_CAST(T6)(x6)
...
#define ASIO_VARIADIC_DECLVAL(n) ASIO_VARIADIC_DECLVAL_##n

#define ASIO_VARIADIC_DECLVAL_1 declval<T1>()
#define ASIO_VARIADIC_DECLVAL_2 declval<T1>(), declval<T2>()
#define ASIO_VARIADIC_DECLVAL_3 declval<T1>(), declval<T2>(), declval<T3>()
#define ASIO_VARIADIC_DECLVAL_4                                                \
  declval<T1>(), declval<T2>(), declval<T3>(), declval<T4>()
#define ASIO_VARIADIC_DECLVAL_5                                                \
  declval<T1>(), declval<T2>(), declval<T3>(), declval<T4>(), declval<T5>()
#define ASIO_VARIADIC_DECLVAL_6                                                \
  declval<T1>(), declval<T2>(), declval<T3>(), declval<T4>(), declval<T5>(),   \
      declval<T6>()
#define ASIO_VARIADIC_DECLVAL_7                                                \
  declval<T1>(), declval<T2>(), declval<T3>(), declval<T4>(), declval<T5>(),   \
      declval<T6>(), declval<T7>()
#define ASIO_VARIADIC_DECLVAL_8                                                \
  declval<T1>(), declval<T2>(), declval<T3>(), declval<T4>(), declval<T5>(),   \
      declval<T6>(), declval<T7>(), declval<T8>()
