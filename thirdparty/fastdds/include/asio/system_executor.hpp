...
public:
  /// Default constructor.
  basic_system_executor() ASIO_NOEXCEPT : allocator_(Allocator()) {}
   ...
   *   ... @endcode
   */
  static ASIO_CONSTEXPR execution::blocking_t
   ...
   *   ... @endcode
   */
  static ASIO_CONSTEXPR execution::relationship_t
  query(execution::relationship_t) ASIO_NOEXCEPT {
    return Relationship();
  }
