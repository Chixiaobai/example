...
public:
  //! @brief This enumeration represents the two kinds of CDR serialization
  //! supported by eprosima::fastcdr::CDR.
  typedef enum {
  ...
  //! @brief This enumeration represents the two posible values of the flag that
  //! points if the content is a parameter list (only in DDS CDR).
  ...
  private:
    ...
    //! @brief The position from the aligment is calculated,  when the state was
    //! created..
    const FastBuffer::iterator m_alignPosition;

    //! @brief This attribute specified if it is needed to swap the bytes when
    //! the state was created..
    bool m_swapBytes;

    //! @brief Stores the last datasize serialized/deserialized when the state
    //! was created.
   ...
   *
   * @param cdrBuffer A reference to the buffer that contains (or will contain)
   * the CDR representation.
   * @param endianness The initial endianness that will be used. The default
   * value is the endianness of the system.
   ...
   *        If the CDR stream contains an encapsulation, then this function
   * should be called before starting to deserialize.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
   * when trying to deserialize a position that exceeds the internal memory
   * size.
   * @exception exception::BadParamException This exception is thrown when
   * trying to deserialize an invalid value.
   */
  Cdr &read_encapsulation();

  /*!
   * @brief This function writes the encapsulation of the CDR stream.
   *        If the CDR stream should contain an encapsulation, then this
   * function should be called before starting to serialize.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
   * when trying to serialize a position that exceeds the internal memory size.
   */
   ...
   * eprosima::fastcdr::DDS_CDR.
   * @param plFlag New value for the flag that specifies if the content is a
   * parameter list.
   */
   ...
   * @return True is returned when it works successfully. Otherwise, false is
   * returned.
   */
  bool jump(size_t numBytes);

  /*!
   * @brief This function resets the current position in the buffer to the
   * beginning.
   */
  void reset();
  ...
  /*!
   * @brief This function returns the length of the serialized data inside the
   * stream.
  ...
  /*!
   * @brief Get the number of bytes needed to align a position to certain data
   * size.
  ...
  /*!
   * @brief This function returns the current state of the CDR serialization
   * process.
  ...
  /*!
   * @brief This function sets a previous state of the CDR serialization
   * process;
  ...
  /*!
   * @brief This function resets the alignment to the current position in the
   * buffer.
   */
   ...
   * @param octet_t The value of the octet that will be serialized in the
   * buffer.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
   * when trying to serialize a position that exceeds the internal memory size.
   ...
   * @param char_t The value of the character that will be serialized in the
   * buffer.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
   * when trying to serialize a position that exceeds the internal memory size.
   ...
   * @param ushort_t The value of the unsigned short that will be serialized in
   * the buffer.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
   * when trying to serialize a position that exceeds the internal memory size.
   ...
   * @param short_t The value of the short that will be serialized in the
   * buffer.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
   * when trying to serialize a position that exceeds the internal memory size.
   ...
   * @param ulong_t The value of the unsigned long that will be serialized in
   * the buffer.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
   * when trying to serialize a position that exceeds the internal memory size.
   ...
   * @param wchar The value of the wide-char that will be serialized in the
   * buffer.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
   * when trying to serialize a position that exceeds the internal memory size.
   ...
   * @param ulonglong_t The value of the unsigned long long that will be
   * serialized in the buffer.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
   * when trying to serialize a position that exceeds the internal memory size.
   */
   ...
   * @param longlong_t The value of the long long that will be serialized in the
   * buffer.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
   * when trying to serialize a position that exceeds the internal memory size.
   ...
   * @param float_t The value of the float that will be serialized in the
   * buffer.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
   * when trying to serialize a position that exceeds the internal memory size.
   ...
   * @param double_t The value of the double that will be serialized in the
   * buffer.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
   * when trying to serialize a position that exceeds the internal memory size.
   ...
   * @param ldouble_t The value of the long double that will be serialized in
   * the buffer.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
   * when trying to serialize a position that exceeds the internal memory size.
   ...
   * @param bool_t The value of the boolean that will be serialized in the
   * buffer.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
   * when trying to serialize a position that exceeds the internal memory size.
   ...
   * @param string_t Pointer to the begining of the string that will be
   * serialized in the buffer.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
   * when trying to serialize a position that exceeds the internal memory size.
   ...
   * when trying to serialize a position that exceeds the internal memory size.
   */
  template <class _T> inline Cdr &operator<<(const std::vector<_T> &vector_t) {
  ...
  /*!
   * @brief This operator template is used to serialize any other non-basic
   * type.
   * @param type_t A reference to the object that will be serialized in the
   * buffer.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
   * when trying to serialize a position that exceeds the internal memory size.
   */
  template <class _T> inline Cdr &operator<<(const _T &type_t) {
   ...
   * @param char_t The variable that will store the character read from the
   * buffer.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
   * when trying to deserialize a position that exceeds the internal memory
   ...
   * @param ushort_t The variable that will store the unsigned short read from
   * the buffer.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
   * when trying to deserialize a position that exceeds the internal memory
   ...
   * @param ulong_t The variable that will store the unsigned long read from the
   * buffer.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
   * when trying to deserialize a position that exceeds the internal memory
   ...
   * @param wchar The variable that will store the wide-char read from the
   * buffer.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
   * when trying to deserialize a position that exceeds the internal memory
   ...
   * @param ulonglong_t The variable that will store the unsigned long long read
   * from the buffer.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
   * when trying to deserialize a position that exceeds the internal memory
   ...
   * @param longlong_t The variable that will store the long long read from the
   * buffer.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
   * when trying to deserialize a position that exceeds the internal memory
   ...
   * @param double_t The variable that will store the double read from the
   * buffer.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
   * when trying to deserialize a position that exceeds the internal memory
   ...
   * @param ldouble_t The variable that will store the long double read from the
   * buffer.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
   * when trying to deserialize a position that exceeds the internal memory
   ...
   * @param bool_t The variable that will store the boolean read from the
   * buffer.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
   * when trying to deserialize a position that exceeds the internal memory
   ...
   * @param string_t The variable that will store the c-string read from the
   * buffer. Please note that a newly allocated string will be returned. The
   * caller should free the returned pointer when appropiate.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
   * when trying to deserialize a position that exceeds the internal memory
   * size.
   ...
   * @param string_t The variable that will store the string read from the
   * buffer.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
   * when trying to deserialize a position that exceeds the internal memory
   ...
   * @param vector_t The variable that will store the sequence read from the
   * buffer.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
   * when trying to deserialize a position that exceeds the internal memory
   * size.
   */
  template <class _T> inline Cdr &operator>>(std::vector<_T> &vector_t) {
  ...
  /*!
   * @brief This operator template is used to deserialize any other non-basic
   * type.
   ...
   * when trying to serialize a position that exceeds the internal memory size.
   */
  template <class _T> inline Cdr &operator>>(_T &type_t) {
   ...
   * @param octet_t The value of the octet that will be serialized in the
   * buffer.
   * @param endianness Endianness that will be used in the serialization of this
   * value.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
   * when trying to serialize a position that exceeds the internal memory size.
  ...
  /*!
   * @brief This function serializes an unsigned short with a different
   * endianness.
   * @param ushort_t The value of the unsigned short that will be serialized in
   * the buffer.
   * @param endianness Endianness that will be used in the serialization of this
  ...
  /*!
   * @brief This function serializes an unsigned long with a different
   * endianness.
   * @param ulong_t The value of the unsigned long that will be serialized in
   * the buffer.
   * @param endianness Endianness that will be used in the serialization of this
  ...
  /*!
   * @brief This function serializes an unsigned long long with a different
   * endianness.
   * @param ulonglong_t The value of the unsigned long long that will be
   * serialized in the buffer.
   * @param endianness Endianness that will be used in the serialization of this
   ...
   * @exception exception::NotEnoughMemoryException This exception is thrown
   * when trying to serialize a position that exceeds the internal memory size.
   * @note Due to internal representation differences, WIN32 and *NIX like
   ...
   * @param string_t The pointer to the string that will be serialized in the
   * buffer.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
   * when trying to serialize a position that exceeds the internal memory size.
   ...
   * @param string_t The pointer to the wstring that will be serialized in the
   * buffer.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
   * when trying to serialize a position that exceeds the internal memory size.
  ...
  /*!
   * @brief This function template serializes an array with a different
   * endianness.
   * @param array_t The array that will be serialized in the buffer.
   * @param endianness Endianness that will be used in the serialization of this
   * value.
   ...
   * when trying to serialize a position that exceeds the internal memory size.
   */
  template <class _T = bool> Cdr &serialize(const std::vector<bool> &vector_t) {
   ...
   * when trying to serialize a position that exceeds the internal memory size.
   */
  template <class _T> Cdr &serialize(const std::vector<_T> &vector_t) {
   ...
   * when trying to serialize a position that exceeds the internal memory size.
   */
  template <class _K, class _T> Cdr &serialize(const std::map<_K, _T> &map_t) {
    state state_(*this);
   ...
   * when trying to serialize a position that exceeds the internal memory size.
   */
  template <> Cdr &serialize<bool>(const std::vector<bool> &vector_t) {
    return serializeBoolSequence(vector_t);
  }
  ...
  /*!
   * @brief This function template serializes a sequence with a different
   * endianness.
   * @param vector_t The sequence that will be serialized in the buffer.
   * @param endianness Endianness that will be used in the serialization of this
   * value.
   ...
   * when trying to serialize a position that exceeds the internal memory size.
   */
  template <class _T> inline Cdr &serialize(const _T &type_t) {
    type_t.serialize(*this);
    return *this;
  }
   ...
   * @param octet_t The sequence of octets that will be serialized in the
   * buffer.
  ...
  /*!
   * @brief This function serializes an array of octets with a different
   * endianness.
   ...
   * @param char_t The array of characters that will be serialized in the
   * buffer.
   * @param numElements Number of the elements in the array.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
  ...
  /*!
   * @brief This function serializes an array of characters with a different
   * endianness.
   * @param char_t The array of characters that will be serialized in the
   * buffer.
   * @param numElements Number of the elements in the array.
  ...
  /*!
   * @brief This function serializes an array of int8_t with a different
   * endianness.
   ...
   * @param ushort_t The array of unsigned shorts that will be serialized in the
   * buffer.
   * @param numElements Number of the elements in the array.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
  ...
  inline Cdr &serializeArray(const uint16_t *ushort_t, size_t numElements) {
    return serializeArray(reinterpret_cast<const int16_t *>(ushort_t),
                          numElements);
  }

  /*!
   * @brief This function serializes an array of unsigned shorts with a
  ...
  /*!
   * @brief This function serializes an array of shorts with a different
   * endianness.
   * @param short_t The array of shorts that will be serialized in the buffer.
   * @param numElements Number of the elements in the array.
   * @param endianness Endianness that will be used in the serialization of this
   ...
   * @param ulong_t The array of unsigned longs that will be serialized in the
   * buffer.
   * @param numElements Number of the elements in the array.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
  ...
  inline Cdr &serializeArray(const uint32_t *ulong_t, size_t numElements) {
    return serializeArray(reinterpret_cast<const int32_t *>(ulong_t),
                          numElements);
  }
  ...
  /*!
   * @brief This function serializes an array of longs with a different
   * endianness.
   * @param long_t The array of longs that will be serialized in the buffer.
   * @param numElements Number of the elements in the array.
   * @param endianness Endianness that will be used in the serialization of this
  ...
  /*!
   * @brief This function serializes an array of wide-chars with a different
   * endianness.
   ...
   * @param ulonglong_t The array of unsigned long longs that will be serialized
   * in the buffer.
   * @param numElements Number of the elements in the array.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
  ...
  inline Cdr &serializeArray(const uint64_t *ulonglong_t, size_t numElements) {
    return serializeArray(reinterpret_cast<const int64_t *>(ulonglong_t),
                          numElements);
  }

  /*!
   * @brief This function serializes an array of unsigned long longs with a
   * different endianness.
   * @param ulonglong_t The array of unsigned long longs that will be serialized
   * in the buffer.
   * @param numElements Number of the elements in the array.
   ...
   * @param longlong_t The array of long longs that will be serialized in the
   * buffer.
   * @param numElements Number of the elements in the array.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
  ...
  /*!
   * @brief This function serializes an array of long longs with a different
   * endianness.
   * @param longlong_t The array of long longs that will be serialized in the
   * buffer.
   * @param numElements Number of the elements in the array.
  ...
  /*!
   * @brief This function serializes an array of floats with a different
   * endianness.
   * @param float_t The array of floats that will be serialized in the buffer.
   * @param numElements Number of the elements in the array.
   * @param endianness Endianness that will be used in the serialization of this
  ...
  /*!
   * @brief This function serializes an array of doubles with a different
   * endianness.
   * @param double_t The array of doubles that will be serialized in the buffer.
   * @param numElements Number of the elements in the array.
   * @param endianness Endianness that will be used in the serialization of this
   ...
   * @param ldouble_t The array of long doubles that will be serialized in the
   * buffer.
   * @param numElements Number of the elements in the array.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
  ...
  /*!
   * @brief This function serializes an array of long doubles with a different
   * endianness.
   * @param ldouble_t The array of long doubles that will be serialized in the
   * buffer.
   * @param numElements Number of the elements in the array.
  ...
  /*!
   * @brief This function serializes an array of booleans with a different
   * endianness.
   * @param bool_t The array of booleans that will be serialized in the buffer.
   * @param numElements Number of the elements in the array.
   * @param endianness Endianness that will be used in the serialization of this
   ...
   * @param string_t The array of wide-strings that will be serialized in the
   * buffer.
   * @param numElements Number of the elements in the array.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
  ...
  /*!
   * @brief This function serializes an array of strings with a different
   * endianness.
   * @param string_t The array of strings that will be serialized in the buffer.
   * @param numElements Number of the elements in the array.
   * @param endianness Endianness that will be used in the serialization of this
  ...
  /*!
   * @brief This function serializes an array of wide-strings with a different
   * endianness.
   * @param string_t The array of wide-strings that will be serialized in the
   * buffer.
   * @param numElements Number of the elements in the array.
   ...
   * @param vector_t The array of sequences of objects that will be serialized
   * in the buffer.
   * @param numElements Number of the elements in the array.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
  ...
  /*!
   * @brief This function template serializes an array of non-basic objects with
   ...
   * @param sequence_t Pointer to the sequence that will be serialized in the
   * buffer.
  ...
  /*!
   * @brief This function template serializes a raw sequence with a different
   * endianness.
   * @param sequence_t Pointer to the sequence that will be serialized in the
   * buffer.
   * @param numElements The number of elements contained in the sequence.
  ...
  /*!
   * @brief This function deserializes an unsigned short with a different
   * endianness.
   * @param ushort_t The variable that will store the unsigned short read from
   * the buffer.
   * @param endianness Endianness that will be used in the serialization of this
  ...
  /*!
   * @brief This function deserializes an unsigned long with a different
   * endianness.
   * @param ulong_t The variable that will store the unsigned long read from the
   * buffer..
   * @param endianness Endianness that will be used in the serialization of this
  ...
  /*!
   * @brief This function deserializes an unsigned long long with a different
   * endianness.
   * @param ulonglong_t The variable that will store the unsigned long long read
   * from the buffer.
   * @param endianness Endianness that will be used in the serialization of this
  ...
  /*!
   * @brief This function deserializes a long double with a different
   * endianness.
   * @param ldouble_t The variable that will store the long double read from the
   * buffer.
   * @param endianness Endianness that will be used in the serialization of this
   ...
   * This function allocates memory to store the string. The user pointer will
   * be set to point this allocated memory. The user will have to free this
   * allocated memory using free()
   * @param string_t The pointer that will point to the string read from the
   * buffer. The user will have to free the allocated memory using free()
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
   * when trying to deserialize a position that exceeds the internal memory
   * size.
   ...
   * This function allocates memory to store the wide string. The user pointer
   * will be set to point this allocated memory. The user will have to free this
   * allocated memory using free()
   * @param string_t The pointer that will point to the wide string read from
   * the buffer. The user will have to free the allocated memory using free()
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
   * when trying to deserialize a position that exceeds the internal memory
   * size.
   ...
   * @param string_t The pointer that will point to the string read from the
   * buffer.
   * @param endianness Endianness that will be used in the deserialization of
   * this value. The user will have to free the allocated memory using free()
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
   * when trying to deserialize a position that exceeds the internal memory
   * size.
  ...
  /*!
   * @brief This function deserializes a wide string with a different
   * endianness. This function allocates memory to store the wide string. The
   * user pointer will be set to point this allocated memory. The user will have
   * to free this allocated memory using free()
   * @param string_t The pointer that will point to the wide string read from
   * the buffer.
   * @param endianness Endianness that will be used in the deserialization of
   * this value. The user will have to free the allocated memory using free()
  ...
  /*!
   * @brief This function template deserializes an array with a different
   * endianness.
   * @param array_t The variable that will store the array read from the buffer.
   * @param endianness Endianness that will be used in the serialization of this
   * value.
   ...
   * size.
   */
  template <class _T = bool> Cdr &deserialize(std::vector<bool> &vector_t) {
   ...
   * size.
   */
  template <class _T> Cdr &deserialize(std::vector<_T> &vector_t) {
   ...
   * size.
   */
  template <class _K, class _T> Cdr &deserialize(std::map<_K, _T> &map_t) {
    uint32_t seqLength = 0;
    state state_(*this);
   ...
   * size.
   */
  template <> Cdr &deserialize<bool>(std::vector<bool> &vector_t) {
    return deserializeBoolSequence(vector_t);
  }
  ...
  /*!
   * @brief This function template deserializes a sequence with a different
   * endianness.
   * @param vector_t The variable that will store the sequence read from the
   * buffer.
   * @param endianness Endianness that will be used in the serialization of this
   ...
   * size.
   */
  template <class _T> inline Cdr &deserialize(_T &type_t) {
    type_t.deserialize(*this);
    return *this;
  }
   ...
   * @param octet_t The variable that will store the array of octets read from
   * the buffer.
   * @param numElements Number of the elements in the array.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
  ...
  /*!
   * @brief This function deserializes an array of octets with a different
   * endianness.
   * @param octet_t The variable that will store the array of octets read from
   * the buffer.
   * @param numElements Number of the elements in the array.
   ...
   * @param char_t The variable that will store the array of characters read
   * from the buffer.
   * @param numElements Number of the elements in the array.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
  ...
  /*!
   * @brief This function deserializes an array of characters with a different
   * endianness.
   * @param char_t The variable that will store the array of characters read
   * from the buffer.
   * @param numElements Number of the elements in the array.
   ...
   * size.
   */
  inline Cdr &deserializeArray(char *char_t, size_t numElements,
                               Endianness endianness) {
    (void)endianness;
   ...
   * @param int8 The variable that will store the array of int8_t read from the
   * buffer.
   * @param numElements Number of the elements in the array.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
  ...
  /*!
   * @brief This function deserializes an array of int8_t with a different
   * endianness.
   * @param int8 The variable that will store the array of int8_t read from the
   * buffer.
   * @param numElements Number of the elements in the array.
   ...
   * @param ushort_t The variable that will store the array of unsigned shorts
  ...
  /*!
   * @brief This function deserializes an array of unsigned shorts with a
   * different endianness.
   * @param ushort_t The variable that will store the array of unsigned shorts
   * read from the buffer.
   * @param numElements Number of the elements in the array.
   ...
   * @param short_t The variable that will store the array of shorts read from
   * the buffer.
   * @param numElements Number of the elements in the array.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
  ...
  /*!
   * @brief This function deserializes an array of shorts with a different
   * endianness.
   * @param short_t The variable that will store the array of shorts read from
   * the buffer.
   * @param numElements Number of the elements in the array.
   ...
   * @param ulong_t The variable that will store the array of unsigned longs
   * read from the buffer.
   * @param numElements Number of the elements in the array.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
  ...
  /*!
   * @brief This function deserializes an array of unsigned longs with a
   * different endianness.
   * @param ulong_t The variable that will store the array of unsigned longs
   * read from the buffer.
   * @param numElements Number of the elements in the array.
   ...
   * @param long_t The variable that will store the array of longs read from the
   * buffer.
   * @param numElements Number of the elements in the array.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
  ...
  /*!
   * @brief This function deserializes an array of longs with a different
   * endianness.
   * @param long_t The variable that will store the array of longs read from the
   * buffer.
   * @param numElements Number of the elements in the array.
   ...
   * @param wchar The variable that will store the array of wide-chars read from
   * the buffer.
   * @param numElements Number of the elements in the array.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
  ...
  /*!
   * @brief This function deserializes an array of wide-chars with a different
   * endianness.
   * @param wchar The variable that will store the array of wide-chars read from
   * the buffer.
   * @param numElements Number of the elements in the array.
   ...
   * @param ulonglong_t The variable that will store the array of unsigned long
   * longs read from the buffer.
   * @param numElements Number of the elements in the array.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
   * when trying to deserialize a position that exceeds the internal memory
  ...
  inline Cdr &deserializeArray(uint64_t *ulonglong_t, size_t numElements) {
    return deserializeArray(reinterpret_cast<int64_t *>(ulonglong_t),
                            numElements);
  }

  /*!
   * @brief This function deserializes an array of unsigned long longs with a
   * different endianness.
   * @param ulonglong_t The variable that will store the array of unsigned long
   * longs read from the buffer.
   * @param numElements Number of the elements in the array.
   ...
   * @param longlong_t The variable that will store the array of long longs read
   * from the buffer.
   * @param numElements Number of the elements in the array.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
  ...
  /*!
   * @brief This function deserializes an array of long longs with a different
   * endianness.
   * @param longlong_t The variable that will store the array of long longs read
   * from the buffer.
   * @param numElements Number of the elements in the array.
   ...
   * @param float_t The variable that will store the array of floats read from
   * the buffer.
   * @param numElements Number of the elements in the array.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
  ...
  /*!
   * @brief This function deserializes an array of floats with a different
   * endianness.
   * @param float_t The variable that will store the array of floats read from
   * the buffer.
   * @param numElements Number of the elements in the array.
   ...
   * @param double_t The variable that will store the array of doubles read from
   * the buffer.
   * @param numElements Number of the elements in the array.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
  ...
  /*!
   * @brief This function deserializes an array of doubles with a different
   * endianness.
   * @param double_t The variable that will store the array of doubles read from
   * the buffer.
   * @param numElements Number of the elements in the array.
   ...
   * @param ldouble_t The variable that will store the array of long doubles
   * read from the buffer.
   * @param numElements Number of the elements in the array.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
   ...
   * @param bool_t The variable that will store the array of booleans read from
   * the buffer.
   * @param numElements Number of the elements in the array.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
  ...
  /*!
   * @brief This function deserializes an array of booleans with a different
   * endianness.
   * @param bool_t The variable that will store the array of booleans read from
   * the buffer.
   * @param numElements Number of the elements in the array.
   ...
   * size.
   */
  inline Cdr &deserializeArray(bool *bool_t, size_t numElements,
                               Endianness endianness) {
    (void)endianness;
   ...
   * @param string_t The variable that will store the array of strings read from
   * the buffer.
   * @param numElements Number of the elements in the array.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
   ...
   * @param string_t The variable that will store the array of wide-strings read
   * from the buffer.
   * @param numElements Number of the elements in the array.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
  ...
  /*!
   * @brief This function deserializes an array of strings with a different
   * endianness.
   * @param string_t The variable that will store the array of strings read from
   * the buffer.
   * @param numElements Number of the elements in the array.
   ...
   * @param vector_t The variable that will store the array of sequences of
   * objects read from the buffer.
   * @param numElements Number of the elements in the array.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
   * when trying to deserialize a position that exceeds the internal memory
   ...
   * @param type_t The variable that will store the array of objects read from
   * the buffer.
   * @param numElements Number of the elements in the array.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
   ...
   * size.
   */
  template <class _T> Cdr &deserializeArray(_T *type_t, size_t numElements) {
    for (size_t count = 0; count < numElements; ++count) {
   ...
   * This function allocates memory to store the sequence. The user pointer will
   * be set to point this allocated memory. The user will have to free this
   * allocated memory using free()
   * @param sequence_t The pointer that will store the sequence read from the
   * buffer.
   * @param numElements This variable return the number of elements of the
   * sequence.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
   * when trying to deserialize a position that exceeds the internal memory
   ...
   */
  template <>
  Cdr &deserializeSequence<std::string>(std::string *&sequence_t,
                                        size_t &numElements) {
    return deserializeStringSequence(sequence_t, numElements);
  }
   ...
   */
  template <>
  Cdr &deserializeSequence<std::wstring>(std::wstring *&sequence_t,
                                         size_t &numElements) {
    return deserializeWStringSequence(sequence_t, numElements);
  }
   ...
   * endianness. This function allocates memory to store the sequence. The user
   * pointer will be set to point this allocated memory. The user will have to
   * free this allocated memory using free()
   * @param sequence_t The pointer that will store the sequence read from the
   * buffer.
   * @param numElements This variable return the number of elements of the
   * sequence.
...
private:
  ...
  Cdr &deserializeWStringSequence(std::wstring *&sequence_t,
                                  size_t &numElements);

#if HAVE_CXX0X
  /*!
   * @brief This function template detects the content type of the STD
   * container array and serializes the array.
   * @param array_t The array that will be serialized in the buffer.
   * @param numElements Number of the elements in the array.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
   * when trying to serialize a position that exceeds the internal memory
   * size.
   */
  template <class _T, size_t _Size>
  Cdr &serializeArray(const std::array<_T, _Size> *array_t,
                      size_t numElements) {
  ...
  /*!
   * @brief This function template detects the content type of the STD
   * container array and serializes the array with a different endianness.
   * @param array_t The array that will be serialized in the buffer.
   * @param numElements Number of the elements in the array.
   * @param endianness Endianness that will be used in the serialization of
   * this value.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
   * when trying to serialize a position that exceeds the internal memory
  ...
  /*!
   * @brief This function template detects the content type of the STD
   * container array and deserializes the array.
   * @param array_t The variable that will store the array read from the
   * buffer.
   * @param numElements Number of the elements in the array.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown
  ...
  /*!
   * @brief This function template detects the content type of STD container
   * array and deserializes the array with a different endianness.
   * @param array_t The variable that will store the array read from the
   * buffer.
   * @param numElements Number of the elements in the array.
   * @param endianness Endianness that will be used in the serialization of
  ...
  inline size_t alignment(size_t dataSize) const {
    return dataSize > m_lastDataSize
               ? (dataSize -
                  ((m_currentPosition - m_alignPosition) % dataSize)) &
                     (dataSize - 1)
               : 0;
  }

  /*!
   * @brief This function jumps the number of bytes of the alignment. These
   * bytes should be calculated with the function
  ...
  /*!
   * @brief This function resizes the internal buffer. It only applies if the
   * FastBuffer object was created with the default constructor.
  ...
  //! @brief Using DDS_CDR type, this attribute stores if the stream buffer
  //! contains a parameter list or not.
  DDSCdrPlFlag m_plFlag;

  //! @brief This attribute stores the option flags when the CDR type is
  //! DDS_CDR;
  uint16_t m_options;
  ...
  //! @brief Stores the last datasize serialized/deserialized. It's used to
  //! optimize.
  size_t m_lastDataSize;
