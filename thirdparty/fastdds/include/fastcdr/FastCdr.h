...
public:
    ...
    /*!
     * @brief This constructor creates a eprosima::fastcdr::FastCdr object that
     * can serialize/deserialize the assigned buffer.
     *
     * @param cdrBuffer A reference to the buffer that contains (or will
     * contain) the CDR representation.
     */
     ...
     * @return True is returned when the jump operation works successfully.
     ...
     * when trying to serialize in a position that exceeds the internal memory
     * size.
     */
    inline FastCdr &serializeArray(const uint8_t *octet_t, size_t numElements) {
      return serializeArray(reinterpret_cast<const char *>(octet_t),
                            numElements);
    }
     ...
     * @param ushort_t The array of unsigned shorts that will be serialized in
     * the buffer.
     * @param numElements Number of the elements in the array.
     * @return Reference to the eprosima::fastcdr::FastCdr object.
     * @exception exception::NotEnoughMemoryException This exception is thrown
     ...
     * size.
     */
    inline FastCdr &serializeArray(const uint16_t *ushort_t,
                                   size_t numElements) {
     ...
     * size.
     */
    inline FastCdr &serializeArray(const uint32_t *ulong_t,
                                   size_t numElements) {
     ...
     * @param wchar The array of wide-chars that will be serialized in the
     * buffer.
     * @param numElements Number of the elements in the array.
     * @return Reference to the eprosima::fastcdr::FastCdr object.
     * @exception exception::NotEnoughMemoryException This exception is thrown
     ...
     * @param ulonglong_t The array of unsigned long longs that will be
     ...
     * size.
     */
    inline FastCdr &serializeArray(const uint64_t *ulonglong_t,
                                   size_t numElements) {
     ...
     * @param double_t The array of doubles that will be serialized in the
     * buffer.
     * @param numElements Number of the elements in the array.
     * @return Reference to the eprosima::fastcdr::FastCdr object.
     * @exception exception::NotEnoughMemoryException This exception is thrown
     ...
     * @param bool_t The array of booleans that will be serialized in the
     * buffer.
     * @param numElements Number of the elements in the array.
     * @return Reference to the eprosima::fastcdr::FastCdr object.
     * @exception exception::NotEnoughMemoryException This exception is thrown
     ...
     * @param string_t The array of strings that will be serialized in the
     * buffer.
     * @param numElements Number of the elements in the array.
     * @return Reference to the eprosima::fastcdr::FastCdr object.
     * @exception exception::NotEnoughMemoryException This exception is thrown
     ...
     * size.
     */
    inline FastCdr &serializeArray(const std::string *string_t,
                                   size_t numElements) {
     ...
     * @param string_t The array of wstrings that will be serialized in the
     * buffer.
     * @param numElements Number of the elements in the array.
     * @return Reference to the eprosima::fastcdr::FastCdr object.
     * @exception exception::NotEnoughMemoryException This exception is thrown
     ...
     * size.
     */
    inline FastCdr &serializeArray(const std::wstring *string_t,
                                   size_t numElements) {
      for (size_t count = 0; count < numElements; ++count) {
        serialize(string_t[count].c_str());
      }
     ...
     * @param vector_t The array of sequences that will be serialized in the
     * buffer.
     * @param numElements Number of the elements in the array.
     * @return Reference to the eprosima::fastcdr::FastCdr object.
     * @exception exception::NotEnoughMemoryException This exception is thrown
    ...
    /*!
     * @brief This function template serializes an array of non-basic type
     * objects.
     ...
     * @return Reference to the eprosima::fastcdr::FastCdr object.
     * @exception exception::NotEnoughMemoryException This exception is thrown
     * when trying to deserialize in a position that exceeds the internal memory
     * size.
     */
     ...
     * @param int8 The variable that will store the array of int8_t read from
     * the buffer.
     * @param numElements Number of the elements in the array.
     * @return Reference to the eprosima::fastcdr::FastCdr object.
     * @exception exception::NotEnoughMemoryException This exception is thrown
    ...
    inline FastCdr &deserializeArray(uint16_t *ushort_t, size_t numElements) {
      return deserializeArray(reinterpret_cast<int16_t *>(ushort_t),
                              numElements);
    }
    ...
    inline FastCdr &deserializeArray(uint32_t *ulong_t, size_t numElements) {
      return deserializeArray(reinterpret_cast<int32_t *>(ulong_t),
                              numElements);
    }

    /*!
     * @brief This function deserializes an array of longs.
     * @param long_t The variable that will store the array of longs read from
     * the buffer.
     * @param numElements Number of the elements in the array.
     * @return Reference to the eprosima::fastcdr::FastCdr object.
     * @exception exception::NotEnoughMemoryException This exception is thrown
     ...
     * @param wchar The variable that will store the array of wide-chars read
     * from the buffer.
     * @param numElements Number of the elements in the array.
     * @return Reference to the eprosima::fastcdr::FastCdr object.
     * @exception exception::NotEnoughMemoryException This exception is thrown
     ...
     * @param ulonglong_t The variable that will store the array of unsigned
     * long longs read from the buffer.
     * @param numElements Number of the elements in the array.
     * @return Reference to the eprosima::fastcdr::FastCdr object.
     * @exception exception::NotEnoughMemoryException This exception is thrown
     * when trying to deserialize in a position that exceeds the internal memory
     * size.
     */
    inline FastCdr &deserializeArray(uint64_t *ulonglong_t,
                                     size_t numElements) {
     ...
     * @param longlong_t The variable that will store the array of long longs
     * read from the buffer.
     * @param numElements Number of the elements in the array.
     * @return Reference to the eprosima::fastcdr::FastCdr object.
     * @exception exception::NotEnoughMemoryException This exception is thrown
     ...
     * @param double_t The variable that will store the array of doubles read
     * from the buffer.
     * @param numElements Number of the elements in the array.
     * @return Reference to the eprosima::fastcdr::FastCdr object.
     * @exception exception::NotEnoughMemoryException This exception is thrown
     ...
     * @param bool_t The variable that will store the array of booleans read
     * from the buffer.
     * @param numElements Number of the elements in the array.
     * @return Reference to the eprosima::fastcdr::FastCdr object.
     * @exception exception::NotEnoughMemoryException This exception is thrown
     ...
     * @param string_t The variable that will store the array of strings read
     * from the buffer.
     * @param numElements Number of the elements in the array.
     * @return Reference to the eprosima::fastcdr::FastCdr object.
     * @exception exception::NotEnoughMemoryException This exception is thrown
     ...
     * size.
     */
    inline FastCdr &deserializeArray(std::string *string_t,
                                     size_t numElements) {
      for (size_t count = 0; count < numElements; ++count) {
     ...
     * size.
     */
    inline FastCdr &deserializeArray(std::wstring *string_t,
                                     size_t numElements) {
      for (size_t count = 0; count < numElements; ++count) {
        deserialize(string_t[count]);
      }
     ...
     * @param vector_t The variable that will store the array of sequences read
     * from the buffer.
     * @param numElements Number of the elements in the array.
     * @return Reference to the eprosima::fastcdr::FastCdr object.
     * @exception exception::NotEnoughMemoryException This exception is thrown
    ...
    /*!
     * @brief This function template deserializes an array of non-basic type
     * objects.
     ...
     * This function allocates memory to store the sequence. The user pointer
     * will be set to point this allocated memory. The user will have to free
     * this allocated memory using free()
    ...
    FastCdr &deserializeSequence(std::string *&sequence_t,
                                 size_t &numElements) {
    ...
    FastCdr &deserializeSequence(std::wstring *&sequence_t,
                                 size_t &numElements) {
     ...
     */
    template <>
    FastCdr &deserializeSequence<std::string>(std::string *&sequence_t,
                                              size_t &numElements) {
      return deserializeStringSequence(sequence_t, numElements);
    }
...
private:
    ...
    FastCdr &deserializeStringSequence(std::string *&sequence_t,
                                       size_t &numElements);

    FastCdr &deserializeWStringSequence(std::wstring *&sequence_t,
                                        size_t &numElements);
     ...
     */
    template <class _T, size_t _Size>
    FastCdr &serializeArray(const std::array<_T, _Size> *array_t,
                            size_t numElements) {
     ...
     */
    template <class _T, size_t _Size>
    FastCdr &deserializeArray(std::array<_T, _Size> *array_t,
                              size_t numElements) {
