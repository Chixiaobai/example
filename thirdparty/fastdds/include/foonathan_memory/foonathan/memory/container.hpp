...
#include "detail/container_node_sizes.hpp"
        ...
        /// Contains the node size of a node based STL container with a specific
        /// type. These classes are auto-generated and only available if the
        /// tools are build and without cross-compiling.
        template <typename T>
