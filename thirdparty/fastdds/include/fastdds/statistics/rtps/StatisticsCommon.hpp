    ...
    : protected StatisticsListenersImpl
{
  ...
  protected:
     ...
     */
    void on_sample_datas(const fastrtps::rtps::SampleIdentity &sample_identity,
...
protected:
     ...
     */
    void on_data_notify(const fastrtps::rtps::GUID_t &writer_guid,
...
protected:
  ...
  /**
   * @brief Reports publication throughtput based on last added sample to
   * writer's history Parameter: size of the message sent
   */
...
protected:
     ...
     */
  inline void on_data_notify(const fastrtps::rtps::GUID_t &,
  ...
  /**
   * @brief Reports subscription throughtput based on last added sample to
   * reader's history Parameter: size of the message received
   */
