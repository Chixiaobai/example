...
public:
    ...
    bool operator==(const DomainParticipantQos &b) const {
      return (this->user_data_ == b.user_data()) &&
             ...
             (this->transport_ == b.transport()) && (this->name_ == b.name()) &&
     ...
     * @return name
     */
    const fastrtps::string_255 &name() const { return name_; }
     ...
     * @return name
     */
    fastrtps::string_255 &name() { return name_; }
     ...
     */
    void name(const fastrtps::string_255 &value) { name_ = value; }
     ...
     */
    RTPS_DllAPI void setup_transports(rtps::BuiltinTransports transports);
