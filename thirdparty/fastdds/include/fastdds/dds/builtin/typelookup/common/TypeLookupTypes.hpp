...
const int32_t TypeLookup_getDependencies_Hash =
    static_cast<int32_t>(0x31fbaa35);

struct TypeLookup_getTypes_In {
  std::vector<fastrtps::types::TypeIdentifier> type_ids;

  RTPS_DllAPI static size_t
  getCdrSerializedSize(const TypeLookup_getTypes_In &data,
...
struct TypeLookup_getTypes_Out {
  ...
  RTPS_DllAPI static size_t
  getCdrSerializedSize(const TypeLookup_getTypes_Out &data,
                       size_t current_alignment = 0);
...
public:
  ...
  RTPS_DllAPI TypeLookup_getTypes_Result &
  operator=(const TypeLookup_getTypes_Result &x);

  RTPS_DllAPI TypeLookup_getTypes_Result &
  operator=(TypeLookup_getTypes_Result &&x);
  ...
  RTPS_DllAPI static size_t
  getCdrSerializedSize(const TypeLookup_getTypes_Result &data,
                       size_t current_alignment = 0);
...
public:
  ...
  RTPS_DllAPI static size_t
  getCdrSerializedSize(const TypeLookup_getTypeDependencies_In &data,
                       size_t current_alignment = 0);
...
public:
  ...
  RTPS_DllAPI static size_t
  getCdrSerializedSize(const TypeLookup_getTypeDependencies_Out &data,
                       size_t current_alignment = 0);
...
public:
  ...
  RTPS_DllAPI TypeLookup_getTypeDependencies_Result &
  operator=(const TypeLookup_getTypeDependencies_Result &x);

  RTPS_DllAPI TypeLookup_getTypeDependencies_Result &
  operator=(TypeLookup_getTypeDependencies_Result &&x);
  ...
  RTPS_DllAPI static size_t
  getCdrSerializedSize(const TypeLookup_getTypeDependencies_Result &data,
                       size_t current_alignment = 0);
...
public:
  ...
  RTPS_DllAPI void
  getTypeDependencies(TypeLookup_getTypeDependencies_In &&_getTypeDependencies);

  RTPS_DllAPI const TypeLookup_getTypeDependencies_In &
  getTypeDependencies() const;

  RTPS_DllAPI TypeLookup_getTypeDependencies_In &getTypeDependencies();

  RTPS_DllAPI static size_t getCdrSerializedSize(const TypeLookup_Call &data,
                                                 size_t current_alignment = 0);
...
public:
  ...
  RTPS_DllAPI static size_t getCdrSerializedSize(const TypeLookup_Request &data,
                                                 size_t current_alignment = 0);
...
public:
  ...
  RTPS_DllAPI const TypeLookup_getTypeDependencies_Result &
  getTypeDependencies() const;

  RTPS_DllAPI TypeLookup_getTypeDependencies_Result &getTypeDependencies();

  RTPS_DllAPI static size_t getCdrSerializedSize(const TypeLookup_Return &data,
                                                 size_t current_alignment = 0);
...
public:
  ...
  RTPS_DllAPI static size_t getCdrSerializedSize(const TypeLookup_Reply &data,
                                                 size_t current_alignment = 0);
...
public:
  RTPS_DllAPI bool
  serialize(void *data, fastrtps::rtps::SerializedPayload_t *payload) override;

  RTPS_DllAPI bool deserialize(fastrtps::rtps::SerializedPayload_t *payload,
                               void *data) override;

  static size_t getCdrSerializedSize(const TypeLookup_Request &data,
                                     size_t current_alignment = 0);
...
public:
  ...
  static size_t getCdrSerializedSize(const TypeLookup_Reply &data,
                                     size_t current_alignment = 0);
