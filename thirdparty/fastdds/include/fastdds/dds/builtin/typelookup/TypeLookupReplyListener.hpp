...
/**
 * Class TypeLookupReplyListener that receives the typelookup request messages
 * of remote endpoints.
...
public:
   ...
   */
  TypeLookupReplyListener(TypeLookupManager *pwlp);
  ...
  /**
   * @brief This method is called when all the readers matched with this Writer
   * acknowledge that a cache change has been received.
   * @param change The cache change
   */
  void
  onWriterChangeReceivedByAll(fastrtps::rtps::RTPSWriter *,
