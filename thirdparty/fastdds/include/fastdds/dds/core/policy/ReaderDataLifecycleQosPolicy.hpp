...
public:
  /**
   * @brief Indicates the duration the DataReader must retain information
   * regarding instances that have the instance_state NOT_ALIVE_NO_WRITERS. <br>
   * By default, c_TimeInfinite.
   */
  Duration_t autopurge_no_writer_samples_delay;
  /**
   * @brief Indicates the duration the DataReader must retain information
   * regarding instances that have the instance_state NOT_ALIVE_DISPOSED. <br>
   * By default, c_TimeInfinite.
   */
