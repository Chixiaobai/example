...
public:
  ...
  bool operator==(const Parameter_t &b) const {
    return (this->Pid == b.Pid) && (this->length == b.length);
    }
...
public:
  ...
  /**
   * @brief Constructor using a parameter PID, parameter length and Instance
   * Handle
   *
   * @param pid Pid of the parameter
   * @param in_length Its associated length
  ...
  ParameterKey_t(ParameterId_t pid, uint16_t in_length,
      ...
      : Parameter_t(pid, in_length), key(ke) {}
};
...
public:
    ...
    ParameterString_t(ParameterId_t pid, uint16_t in_length,
        ...
        : Parameter_t(pid, in_length), string_(strin) {}
...
public:
  ...
  ParameterGuid_t(ParameterId_t pid, uint16_t in_length,
      ...
      : Parameter_t(pid, in_length), guid(guidin) {}

  /**
   * @brief Constructor using a parameter PID, the parameter length and a
   * Instance Handle
   *
   * @param pid Pid of the parameter
   * @param in_length Its associated length
...
public:
   ...
   * @brief Constructor without parameters
   */
  ParameterVendorId_t() : vendorId(fastrtps::rtps::c_VendorId_eProsima) {}
...
public:
  ...
  ParameterIP4Address_t(ParameterId_t pid, uint16_t in_length)
     ...
     */
    void setIP4Address(fastrtps::rtps::octet o1, fastrtps::rtps::octet o2,
                       fastrtps::rtps::octet o3, fastrtps::rtps::octet o4) {
      address[0] = o1;
      address[1] = o2;
      address[2] = o3;
      address[3] = o4;
...
public:
  ...
  ParameterCount_t(ParameterId_t pid, uint16_t in_length)
      : Parameter_t(pid, in_length), count(0) {}
};
...
public:
  ...
  ParameterEntityId_t(ParameterId_t pid, uint16_t in_length)
      : Parameter_t(pid, in_length), entityId(ENTITYID_UNKNOWN) {}
};
...
public:
  ...
  ParameterBuiltinEndpointSet_t(ParameterId_t pid, uint16_t in_length)
      : Parameter_t(pid, in_length), endpointSet(0) {}
};
...
private:
     ...
     */
  static uint32_t element_size(const fastrtps::rtps::octet *ptr) {
...
public:
    ...
    public:
         ...
         */
        iterator(fastrtps::rtps::octet *ptr) : ptr_(ptr), value_(ptr) {}
    ...
    protected:
         ...
         * @return the pointer
         */
        fastrtps::rtps::octet *address() const { return ptr_; }
    ...
    public:
        ...
        const_iterator(const fastrtps::rtps::octet *ptr)
            : ptr_(ptr), value_(const_cast<fastrtps::rtps::octet *>(ptr)) {}
    ...
    protected:
        ...
        void advance()
        {
            ptr_ += value_.size();
            value_ =
                ParameterProperty_t(const_cast<fastrtps::rtps::octet *>(ptr_));
        }
         ...
         * @return the pointer
         */
        const fastrtps::rtps::octet *address() const { return ptr_; }
...
protected:
  void push_back_helper(const fastrtps::rtps::octet *data, uint32_t size,
                        uint32_t alignment) {
...
public:
   ...
   *
   * @param[in,out] msg Pointer to the message where the parameter should be
   * added.
   ...
   *
   * @param[in,out] msg Pointer to the message from where the parameter should
   * be taken.
...
public:
   ...
   * @param in_length Its associated length
   */
  ParameterToken_t(ParameterId_t pid, uint16_t in_length)
      : Parameter_t(pid, in_length) {}
};
...
public:
  ...
  fastrtps::rtps::security::ParticipantSecurityAttributesMask
      security_attributes = 0;
  //! Plugin Participant Security Attributes Mask <br> By default, 0.
  fastrtps::rtps::security::PluginParticipantSecurityAttributesMask
      plugin_security_attributes = 0;

  /**
   * @brief Constructor without parameters. <br>
   * Sets the value PID_PARTICIPANT_SECURITY_INFO for the parameter PID and
   * PARAMETER_PARTICIPANT_SECURITY_INFO_LENGTH for the length.
   */
  ParameterParticipantSecurityInfo_t()
      : Parameter_t(PID_PARTICIPANT_SECURITY_INFO,
                    PARAMETER_PARTICIPANT_SECURITY_INFO_LENGTH) {}
   ...
   * @param in_length Its associated length
   */
  ParameterParticipantSecurityInfo_t(ParameterId_t pid, uint16_t in_length)
      : Parameter_t(pid, in_length) {}
};
...
public:
  fastrtps::rtps::security::EndpointSecurityAttributesMask security_attributes =
      0;
  fastrtps::rtps::security::PluginEndpointSecurityAttributesMask
      plugin_security_attributes = 0;

  /**
   * @brief Constructor without parameters. <br>
   * Sets the value PID_ENDPOINT_SECURITY_INFO for the parameter PID and
   * PARAMETER_ENDPOINT_SECURITY_INFO_LENGTH for the length.
   */
  ParameterEndpointSecurityInfo_t()
      : Parameter_t(PID_ENDPOINT_SECURITY_INFO,
                    PARAMETER_ENDPOINT_SECURITY_INFO_LENGTH) {}
   ...
   * @param in_length Its associated length
   */
  ParameterEndpointSecurityInfo_t(ParameterId_t pid, uint16_t in_length)
      : Parameter_t(pid, in_length) {}
};
