...
class Topic : public DomainEntity, public TopicDescription
{
  ...
  Topic(const std::string &topic_name, const std::string &type_name,
        TopicImpl *p, const StatusMask &mask = StatusMask::all());

  Topic(DomainParticipant *dp, const std::string &topic_name,
        const std::string &type_name, const TopicQos &qos = TOPIC_QOS_DEFAULT,
...
public:
    ...
    RTPS_DllAPI ReturnCode_t set_listener(
        TopicListener *listener, const StatusMask &mask = StatusMask::all());
