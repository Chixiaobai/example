...
public:
  ...
  operator=(const TypeSupport &type) noexcept = default;
   ...
   * correctly
   */
  RTPS_DllAPI virtual ReturnCode_t
  register_type(DomainParticipant *participant) const;
  ...
  RTPS_DllAPI virtual const std::string &get_type_name() const {
    ...
    serialize(void *data, fastrtps::rtps::SerializedPayload_t *payload);
     ...
     */
    RTPS_DllAPI virtual bool
    deserialize(fastrtps::rtps::SerializedPayload_t *payload, void *data);
    ...
    get_serialized_size_provider(void *data) {
