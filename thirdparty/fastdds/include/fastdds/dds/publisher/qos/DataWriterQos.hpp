...
public:
  ...
  RTPS_DllAPI WriterQos get_writerqos(const PublisherQos &pqos,
  ...
  RTPS_DllAPI const DurabilityQosPolicy &durability() const {
     ...
     */
    RTPS_DllAPI void durability(const DurabilityQosPolicy &durability) {
     ...
     */
    RTPS_DllAPI void
    durability_service(const DurabilityServiceQosPolicy &durability_service) {
     ...
     */
    RTPS_DllAPI void deadline(const DeadlineQosPolicy &deadline) {
      deadline_ = deadline;
    }
     ...
     */
    RTPS_DllAPI void
    latency_budget(const LatencyBudgetQosPolicy &latency_budget) {
     ...
     */
    RTPS_DllAPI void liveliness(const LivelinessQosPolicy &liveliness) {
     ...
     */
    RTPS_DllAPI void reliability(const ReliabilityQosPolicy &reliability) {
     ...
     */
    RTPS_DllAPI void
    destination_order(const DestinationOrderQosPolicy &destination_order) {
     ...
     */
    RTPS_DllAPI void history(const HistoryQosPolicy &history) {
      history_ = history;
    }
     ...
     */
    RTPS_DllAPI void
    resource_limits(const ResourceLimitsQosPolicy &resource_limits) {
     ...
     */
    RTPS_DllAPI void
    transport_priority(const TransportPriorityQosPolicy &transport_priority) {
     ...
     */
    RTPS_DllAPI void lifespan(const LifespanQosPolicy &lifespan) {
      lifespan_ = lifespan;
    }
     ...
     */
    RTPS_DllAPI void user_data(const UserDataQosPolicy &user_data) {
     ...
     */
    RTPS_DllAPI void ownership(const OwnershipQosPolicy &ownership) {
     ...
     */
    RTPS_DllAPI void
    ownership_strength(const OwnershipStrengthQosPolicy &ownership_strength) {
     ...
     * @return WriterDataLifecycleQosPolicy reference
     */
    RTPS_DllAPI const WriterDataLifecycleQosPolicy &
     ...
     */
    RTPS_DllAPI void publish_mode(const PublishModeQosPolicy &publish_mode) {
     ...
     */
    RTPS_DllAPI void
    representation(const DataRepresentationQosPolicy &representation) {
     ...
     */
    RTPS_DllAPI void properties(const PropertyPolicyQos &properties) {
     ...
     */
    RTPS_DllAPI void
    reliable_writer_qos(const RTPSReliableWriterQos &reliable_writer_qos) {
     ...
     */
    RTPS_DllAPI void endpoint(const RTPSEndpointQos &endpoint) {
      endpoint_ = endpoint;
    }
     ...
     */
    RTPS_DllAPI fastrtps::rtps::ThroughputControllerDescriptor &
     ...
     * @deprecated Use flow_controllers() on DomainParticipantQoS
     */
    RTPS_DllAPI const fastrtps::rtps::ThroughputControllerDescriptor &
    throughput_controller() const {
      return throughput_controller_;
    }
     ...
     *
     * @param throughput_controller new value for the
     * ThroughputControllerDescriptor
     * @deprecated Use flow_controllers() on DomainParticipantQoS
     */
    RTPS_DllAPI void
    throughput_controller(const fastrtps::rtps::ThroughputControllerDescriptor
                              &throughput_controller) {
