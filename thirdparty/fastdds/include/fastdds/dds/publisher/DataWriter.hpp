...
public:
     ...
     * @return True if correct, false otherwise
     */
    RTPS_DllAPI bool write(void *data, fastrtps::rtps::WriteParams &params);
     ...
     * NOT YET IMPLEMENTED
     *
     * @brief This operation performs the same function as write except that it
     * also provides the value for the
     * @ref eprosima::fastdds::dds::SampleInfo::source_timestamp
     * "source_timestamp" that is made available to DataReader objects by means
     * of the @ref eprosima::fastdds::dds::SampleInfo::source_timestamp
     * attribute "source_timestamp" inside the SampleInfo. The constraints on
     * the values of the @c handle parameter and the corresponding error
     * behavior are the same specified for the @ref write operation. This
     * operation may block and return RETCODE_TIMEOUT under the same
     * circumstances described for the @ref write operation.
     * This operation may return RETCODE_OUT_OF_RESOURCES,
     * RETCODE_PRECONDITION_NOT_MET or RETCODE_BAD_PARAMETER under the same
     * circumstances described for the write operation.
     *
     * @param data Pointer to the data
     * @param handle InstanceHandle_t
    ...
    write_w_timestamp(void *data, const InstanceHandle_t &handle,
                      const fastrtps::Time_t &timestamp);

#ifndef DOXYGEN_SHOULD_SKIP_THIS
    FASTDDS_DEPRECATED_UNTIL(
        3, "eprosima::fastdds::dds:DataWriter::write_w_timestamp()",
    ...
    /*!
     * @brief Informs that the application will be modifying a particular
     * instance. It gives an opportunity to the middleware to pre-configure
     ...
     * NOT YET IMPLEMENTED
     *
     * @brief This operation performs the same function as register_instance and
     * can be used instead of
     * @ref register_instance in the cases where the application desires to
     * specify the value for the
     * @ref eprosima::fastdds::dds::SampleInfo::source_timestamp
     * "source_timestamp". The @ref
     * eprosima::fastdds::dds::SampleInfo::source_timestamp "source_timestamp"
     * potentially affects the relative order in which readers observe events
     * from multiple writers. See the QoS policy
     * @ref eprosima::fastdds::dds::DataWriterQos::destination_order
     * "DESTINATION_ORDER".
     *
     * This operation may block and return RETCODE_TIMEOUT under the same
     * circumstances described for the @ref write operation.
     *
     * This operation may return RETCODE_OUT_OF_RESOURCES under the same
     * circumstances described for the
     * @ref write operation.
     *
...
#ifndef DOXYGEN_SHOULD_SKIP_THIS
    FASTDDS_DEPRECATED_UNTIL(
        3, "eprosima::fastdds::dds:DataWriter::register_instance_w_timestamp()",
        "In favor of version using eprosima::fastrtps::Time_t.")
    RTPS_DllAPI InstanceHandle_t register_instance_w_timestamp(
     ...
     * Informs the middleware that the DataWriter is not intending to modify any
     * more of that data instance. Also indicates that the middleware can
     * locally remove all information regarding that instance.
     *
     * @param[in] instance Sample used to deduce instance's key in case of
     * `handle` parameter is HANDLE_NIL.
     * @param[in] handle Instance's key to be unregistered.
     * @return Returns the operation's result.
     * If the operation finishes successfully, ReturnCode_t::RETCODE_OK is
     * returned.
     */
    RTPS_DllAPI ReturnCode_t
    unregister_instance(void *instance, const InstanceHandle_t &handle);

    /**
     * NOT YET IMPLEMENTED
     *
     * @brief This operation performs the same function as @ref
     * unregister_instance and can be used instead of
     * @ref unregister_instance in the cases where the application desires to
     * specify the value for the
     * @ref eprosima::fastdds::dds::SampleInfo::source_timestamp
     * "source_timestamp". The @ref
     * eprosima::fastdds::dds::SampleInfo::source_timestamp "source_timestamp"
     ...
     * "DESTINATION_ORDER".
     *
     * The constraints on the values of the @c handle parameter and the
     * corresponding error behavior are the same specified for the @ref
     * unregister_instance operation.
     *
     * This operation may block and return RETCODE_TIMEOUT under the same
     * circumstances described for the write operation
     *
     * @param instance  Sample used to deduce instance's key in case of `handle`
     * parameter is HANDLE_NIL.
    ...
    FASTDDS_DEPRECATED_UNTIL(
        3,
        "eprosima::fastdds::dds:DataWriter::unregister_instance_w_timestamp()",
        "In favor of version using eprosima::fastrtps::Time_t.")
    RTPS_DllAPI ReturnCode_t unregister_instance_w_timestamp(
        void *instance, const InstanceHandle_t &handle,
        const fastrtps::rtps::Time_t &timestamp);
     ...
     * The operation will only fill the fields that form the key inside the
     * key_holder instance.
     *
     * This operation may return BAD_PARAMETER if the InstanceHandle_t handle
     ...
     * @param[in] handle          Handle to the instance to retrieve the key
     * values from.
     *
     * @return Any of the standard return codes.
     */
     ...
     * NOT YET IMPLEMENTED
     *
     * Takes as a parameter an instance and returns a handle that can be used in
     * subsequent operations that accept an instance handle as an argument. The
     * instance parameter is only used for the purpose of examining the fields
     * that define the key.
     *
     ...
     */
    RTPS_DllAPI ReturnCode_t
    wait_for_acknowledgments(const fastrtps::Duration_t &max_wait);
     ...
     */
    RTPS_DllAPI ReturnCode_t
    get_offered_deadline_missed_status(OfferedDeadlineMissedStatus &status);
     ...
     */
    RTPS_DllAPI ReturnCode_t
    get_offered_incompatible_qos_status(OfferedIncompatibleQosStatus &status);
     ...
     */
    RTPS_DllAPI ReturnCode_t
    get_publication_matched_status(PublicationMatchedStatus &status) const;
     ...
     */
    RTPS_DllAPI ReturnCode_t set_qos(const DataWriterQos &qos);
     ...
     * @return RETCODE_OK
     */
    RTPS_DllAPI ReturnCode_t get_qos(DataWriterQos &qos) const;
     ...
     * @return RETCODE_OK
     */
    RTPS_DllAPI ReturnCode_t set_listener(DataWriterListener *listener);
    ...
    /**
     * @brief This operation requests the middleware to delete the data (the
     * actual deletion is postponed until there is no more use for that data in
     * the whole system). In general, applications are made aware of the
     * deletion by means of operations on the DataReader objects that already
     * knew that instance. This operation does not modify the value of the
     * instance. The instance parameter is passed just for the purposes of
     * identifying the instance. When this operation is used, the Service will
     * automatically supply the value of the source_timestamp that is made
     * available to DataReader objects by means of the source_timestamp
     * attribute inside the SampleInfo. The constraints on the values of the
     * handle parameter and the corresponding error behavior are the same
     * specified for the unregister_instance operation.
     *
     * @param[in] data Sample used to deduce instance's key in case of `handle`
     * parameter is HANDLE_NIL.
     * @param[in] handle InstanceHandle of the data
     * @return RETCODE_PRECONDITION_NOT_MET if the handle introduced does not
     * match with the one associated to the data, RETCODE_OK if the data is
     * correctly sent and RETCODE_ERROR otherwise.
     */
    RTPS_DllAPI ReturnCode_t dispose(void *data,
                                     const InstanceHandle_t &handle);

    /**
     * @brief This operation performs the same functions as @ref dispose except
     * that the application provides the value for the @ref
     * eprosima::fastdds::dds::SampleInfo::source_timestamp "source_timestamp"
     * that is made available to DataReader objects by means of the @ref
     * eprosima::fastdds::dds::SampleInfo::source_timestamp "source_timestamp"
     * attribute inside the SampleInfo.
     *
     * The constraints on the values of the @c handle parameter and the
     * corresponding error behavior are the same specified for the @ref dispose
     * operation.
     *
     * This operation may return RETCODE_PRECONDITION_NOT_MET and
     * RETCODE_BAD_PARAMETER under the same circumstances described for the @ref
     * dispose operation.
     *
     * This operation may return RETCODE_TIMEOUT and RETCODE_OUT_OF_RESOURCES
     * under the same circumstances described for the @ref write operation.
     *
     * @param instance  Sample used to deduce instance's key in case of `handle`
     * parameter is HANDLE_NIL.
     ...
     */
    RTPS_DllAPI ReturnCode_t
    dispose_w_timestamp(void *instance, const InstanceHandle_t &handle,
                        const fastrtps::Time_t &timestamp);
    /**
     ...
     */
    RTPS_DllAPI ReturnCode_t
    get_liveliness_lost_status(LivelinessLostStatus &status);
     ...
     * DataReaders
     *
     * @param[out] subscription_handles Vector where the InstanceHandle_t are
     * returned
     * @return RETCODE_OK
     */
...
#ifndef DOXYGEN_SHOULD_SKIP_THIS
    FASTDDS_DEPRECATED_UNTIL(
        3, "eprosima::fastdds::dds:DataWriter::get_matched_subscriptions()",
        "In favor of version using "
        "std::vector<fastrtps::rtps::InstanceHandle_t>.")
    RTPS_DllAPI ReturnCode_t get_matched_subscriptions(
        std::vector<InstanceHandle_t *> &subscription_handles) const;
#endif // DOXYGEN_SHOULD_SKIP_THIS
    ...
    /**
     * @brief Get a pointer to the internal pool where the user could directly
     * write.
     *
     * This method can only be used on a DataWriter for a plain data type. It
     * will provide the user with a pointer to an internal buffer where the data
     * type can be prepared for sending.
     *
     * When using NO_LOAN_INITIALIZATION on the initialization parameter, which
     * is the default, no assumptions should be made on the contents where the
     * pointer points to, as it may be an old pointer being reused. See @ref
     * LoanInitializationKind for more details.
     *
     * Once the sample has been prepared, it can then be published by calling
     * @ref write. After a successful call to @ref write, the middleware takes
     * ownership of the loaned pointer again, and the user should not access
     * that memory again.
     *
     * If, for whatever reason, the sample is not published, the loan can be
     * returned by calling
     * @ref discard_loan.
     *
     ...
     *
     * @return ReturnCode_t::RETCODE_ILLEGAL_OPERATION when the data type does
     * not support loans.
     * @return ReturnCode_t::RETCODE_NOT_ENABLED if the writer has not been
     * enabled.
     * @return ReturnCode_t::RETCODE_OUT_OF_RESOURCES if the pool has been
     * exhausted.
     * @return ReturnCode_t::RETCODE_OK if a pointer to a sample is successfully
     * obtained.
     */
    RTPS_DllAPI ReturnCode_t loan_sample(
        void *&sample, LoanInitializationKind initialization =
                           LoanInitializationKind::NO_LOAN_INITIALIZATION);

    /**
     * @brief Discards a loaned sample pointer.
     *
     * See the description on @ref loan_sample for how and when to call this
     * method.
     *
     ...
     * @return ReturnCode_t::RETCODE_NOT_ENABLED if the writer has not been
     * enabled.
     * @return ReturnCode_t::RETCODE_BAD_PARAMETER if the pointer does not
     * correspond to a loaned sample.
     ...
     */
    RTPS_DllAPI ReturnCode_t
    get_sending_locators(rtps::LocatorList &locators) const;
     ...
     */
    RTPS_DllAPI ReturnCode_t
    wait_for_acknowledgments(void *instance, const InstanceHandle_t &handle,
