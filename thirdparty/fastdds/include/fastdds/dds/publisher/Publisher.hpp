...
public:
    ...
    create_datawriter(Topic *topic, const DataWriterQos &qos,
     ...
     */
    RTPS_DllAPI DataWriter *
    create_datawriter_with_profile(Topic *topic,
     ...
     */
    RTPS_DllAPI ReturnCode_t
    set_default_datawriter_qos(const DataWriterQos &qos);
     ...
     */
    RTPS_DllAPI ReturnCode_t
    get_default_datawriter_qos(DataWriterQos &qos) const;
     ...
     */
    RTPS_DllAPI ReturnCode_t
    copy_from_topic_qos(fastdds::dds::DataWriterQos &writer_qos,
