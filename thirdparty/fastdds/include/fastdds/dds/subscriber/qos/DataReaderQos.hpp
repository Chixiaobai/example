...
public:
   ...
   * @brief Constructor
   */
  RTPS_DllAPI TypeConsistencyQos() : QosPolicy(false) {}
  ...
  bool operator==(const TypeConsistencyQos &b) const {
...
public:
     ...
     * @brief Constructor
     */
  RTPS_DllAPI DataReaderQos() : expects_inline_qos_(false) {}

  RTPS_DllAPI bool operator==(const DataReaderQos &b) const {
    return (durability_ == b.durability()) && (deadline_ == b.deadline()) &&
           ...
           (user_data_ == b.user_data()) && (ownership_ == b.ownership()) &&
     ...
     */
    RTPS_DllAPI DurabilityQosPolicy &durability() { return durability_; }
     ...
     */
    RTPS_DllAPI void durability(const DurabilityQosPolicy &new_value) {
     ...
     */
    RTPS_DllAPI void deadline(const DeadlineQosPolicy &new_value) {
      deadline_ = new_value;
    }
     ...
     */
    RTPS_DllAPI void latency_budget(const LatencyBudgetQosPolicy &new_value) {
     ...
     */
    RTPS_DllAPI void liveliness(const LivelinessQosPolicy &new_value) {
     ...
     */
    RTPS_DllAPI ReliabilityQosPolicy &reliability() { return reliability_; }
     ...
     */
    RTPS_DllAPI void reliability(const ReliabilityQosPolicy &new_value) {
     ...
     */
    RTPS_DllAPI void
    destination_order(const DestinationOrderQosPolicy &new_value) {
     ...
     */
    RTPS_DllAPI void history(const HistoryQosPolicy &new_value) {
      history_ = new_value;
    }
     ...
     */
    RTPS_DllAPI void resource_limits(const ResourceLimitsQosPolicy &new_value) {
     ...
     */
    RTPS_DllAPI UserDataQosPolicy &user_data() { return user_data_; }
     ...
     */
    RTPS_DllAPI void user_data(const UserDataQosPolicy &new_value) {
     ...
     */
    RTPS_DllAPI void ownership(const OwnershipQosPolicy &new_value) {
     ...
     */
    RTPS_DllAPI void
    time_based_filter(const TimeBasedFilterQosPolicy &new_value) {
     ...
     */
    RTPS_DllAPI const ReaderDataLifecycleQosPolicy &
     ...
     */
    RTPS_DllAPI void
    reader_data_lifecycle(const ReaderDataLifecycleQosPolicy &new_value) {
     ...
     */
    RTPS_DllAPI void lifespan(const LifespanQosPolicy &new_value) {
      lifespan_ = new_value;
    }
     ...
     */
    RTPS_DllAPI void
    durability_service(const DurabilityServiceQosPolicy &new_value) {
     ...
     */
    RTPS_DllAPI void
    reliable_reader_qos(const RTPSReliableReaderQos &new_value) {
     ...
     */
    RTPS_DllAPI void type_consistency(const TypeConsistencyQos &new_value) {
     ...
     */
    RTPS_DllAPI bool expects_inline_qos() const { return expects_inline_qos_; }
     ...
     */
    RTPS_DllAPI void expects_inline_qos(bool new_value) {
     ...
     */
    RTPS_DllAPI PropertyPolicyQos &properties() { return properties_; }
     ...
     */
    RTPS_DllAPI void properties(const PropertyPolicyQos &new_value) {
     ...
     */
    RTPS_DllAPI RTPSEndpointQos &endpoint() { return endpoint_; }
     ...
     */
    RTPS_DllAPI const RTPSEndpointQos &endpoint() const { return endpoint_; }
     ...
     */
    RTPS_DllAPI void endpoint(const RTPSEndpointQos &new_value) {
      endpoint_ = new_value;
    }
     ...
     */
    RTPS_DllAPI void
    reader_resource_limits(const ReaderResourceLimitsQos &new_value) {
     ...
     */
    RTPS_DllAPI DataSharingQosPolicy &data_sharing() { return data_sharing_; }
     ...
     */
    RTPS_DllAPI void data_sharing(const DataSharingQosPolicy &data_sharing) {
