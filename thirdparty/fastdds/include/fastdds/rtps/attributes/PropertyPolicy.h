...
public:
  ...
  //! Get properties
  RTPS_DllAPI const PropertySeq &properties() const { return properties_; }

  //! Set properties
  RTPS_DllAPI PropertySeq &properties() { return properties_; }
...
public:
   ...
   */
  RTPS_DllAPI static PropertyPolicy
  get_properties_with_prefix(const PropertyPolicy &property_policy,
  ...
  RTPS_DllAPI static std::string *find_property(PropertyPolicy &property_policy,
                                                const std::string &name);

  //! Retrieves a property_policy by name
  RTPS_DllAPI static const std::string *
  find_property(const PropertyPolicy &property_policy, const std::string &name);
   ...
   */
  RTPS_DllAPI static const Property *
  get_property(const PropertyPolicy &property_policy, const std::string &name);
};
