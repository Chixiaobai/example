...
/**
 * Class StatelessPersistentReader, specialization of StatelessReader that
 * manages sequence number persistence.
 * @ingroup READER_MODULE
 */
class StatelessPersistentReader : public StatelessReader {
  friend class RTPSParticipantImpl;

  StatelessPersistentReader(RTPSParticipantImpl *pimpl, const GUID_t &guid,
