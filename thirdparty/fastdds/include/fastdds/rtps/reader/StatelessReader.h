...
/**
 * Class StatelessReader, specialization of the RTPSReader for Best Effort
 * Readers.
...
public:
   ...
   */
  void assert_writer_liveliness(const GUID_t &guid) override;
...
private:
  ...
  bool acceptMsgFrom(const GUID_t &entityId, ChangeKind_t change_kind);

  bool thereIsUpperRecordOf(const GUID_t &guid, const SequenceNumber_t &seq);
