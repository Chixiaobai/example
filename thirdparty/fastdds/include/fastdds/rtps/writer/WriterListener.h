...
/**
 * Class WriterListener with virtual method so the user can implement callbacks
 * to certain events.
...
public:
  ...
  /**
   * This method is called when a new Reader is matched with this Writer by the
   * builtin protocols
   ...
   * matches that of a local writer, but with a requested QoS that is
   * incompatible with the one offered by the local writer
   * @param writer Pointer to the RTPSWriter.
   * @param qos A mask with the bits of all incompatible Qos activated.
   */
  virtual void
  on_offered_incompatible_qos(RTPSWriter *writer,
  ...
  /**
   * This method is called when all the readers matched with this Writer
   * acknowledge that a cache change has been received.
   * @param writer Pointer to the RTPSWriter.
   * @param change Pointer to the affected CacheChange_t.
   */
  virtual void onWriterChangeReceivedByAll(RTPSWriter *writer,
  ...
  /**
   * @brief Method called when the discovery information of a reader regarding a
   * writer changes.
   *
   * @param writer       The writer.
   * @param reason       The reason motivating this method to be called.
   * @param reader_guid  The GUID of the reader for which the discovery
   * information changed.
   * @param reader_info  Discovery information about the reader. Will be @c
   * nullptr for reason @c REMOVED_READER.
   */
