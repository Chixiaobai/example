...
protected:
  StatelessWriter(RTPSParticipantImpl *participant, const GUID_t &guid,
                  const WriterAttributes &attributes,
                  fastdds::rtps::FlowController *flow_controller,
                  WriterHistory *history, WriterListener *listener = nullptr);

  StatelessWriter(RTPSParticipantImpl *impl, const GUID_t &guid,
...
public:
   ...
   * end.
   */
  bool send_nts(CDRMessage_t *message,
...
private:
  ...
  bool datasharing_delivery(CacheChange_t *change);

  bool intraprocess_delivery(CacheChange_t *change,
  ...
  ResourceLimitedVector<std::unique_ptr<ReaderLocator>>
