...
/**
 * Class StatelessPersistentWriter, specialization of StatelessWriter that
 * manages history persistence.
 * @ingroup WRITER_MODULE
 */
class StatelessPersistentWriter : public StatelessWriter,
                                  private PersistentWriter {
  friend class RTPSParticipantImpl;

  StatelessPersistentWriter(RTPSParticipantImpl *, const GUID_t &guid,
