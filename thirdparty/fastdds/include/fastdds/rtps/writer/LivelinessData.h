...
struct LivelinessData {
   ...
   */
  LivelinessData(GUID_t guid_in, LivelinessQosPolicyKind kind_in,
                 Duration_t lease_duration_in)
      : guid(guid_in), kind(kind_in), lease_duration(lease_duration_in),
        status(WriterStatus::NOT_ASSERTED) {}

  LivelinessData()
      : guid(), kind(LivelinessQosPolicyKind::AUTOMATIC_LIVELINESS_QOS),
  ...
  bool operator==(const LivelinessData &other) const {
    return ((guid == other.guid) && (kind == other.kind) &&
