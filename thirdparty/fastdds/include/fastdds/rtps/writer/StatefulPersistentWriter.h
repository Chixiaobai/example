...
/**
 * Class StatefulPersistentWriter, specialization of StatefulWriter that manages
 * history persistence.
 * @ingroup WRITER_MODULE
 */
class StatefulPersistentWriter : public StatefulWriter,
                                 private PersistentWriter {
  friend class RTPSParticipantImpl;

  StatefulPersistentWriter(RTPSParticipantImpl *, const GUID_t &guid,
