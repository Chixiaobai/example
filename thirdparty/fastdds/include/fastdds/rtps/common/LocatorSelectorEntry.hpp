 ...
 *
 * This class holds the locators of a remote endpoint along with data required
 * for the locator selection algorithm. Can be easily integrated inside other
 * classes, such as @ref ReaderProxyData and @ref WriterProxyData.
 */
