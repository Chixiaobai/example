...
/**
 * @enum MatchingStatus, indicates whether the matched publication/subscription
 * method of the PublisherListener or SubscriberListener has been called for a
 * matching or a removal of a remote endpoint.
...
/**
 * Class MatchingInfo contains information about the matching between two
 * endpoints.
 * @ingroup COMMON_MODULE
 */
...
public:
  ...
  MatchingInfo(MatchingStatus stat, const GUID_t &guid)
      : status(stat), remoteEndpointGuid(guid){};
  ~MatchingInfo(){};
  //! Status
