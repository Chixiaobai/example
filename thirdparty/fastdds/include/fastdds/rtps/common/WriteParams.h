...
public:
  ...
  const SampleIdentity &sample_identity() const { return sample_identity_; }

  SampleIdentity &sample_identity() { return sample_identity_; }
  ...
  SampleIdentity &related_sample_identity() { return related_sample_identity_; }
