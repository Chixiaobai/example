...
public:
   ...
   *     @li @c *cache_change equals @c CacheChange_t() except for the contents
   * of @c serializedPayload
   */
   ...
   *     @li @c cache_change points to a cache change obtained from a call to @c
   * this->reserve_cache
   */
