...
struct test_UDPv4TransportDescriptor : public SocketTransportDescriptor {
  ...
  typedef std::function<bool(const Locator &destination)>
      DestinationLocatorFilter;
  ...
  std::vector<fastrtps::rtps::SequenceNumber_t>
  ...
  //! Copy assignment
  RTPS_DllAPI test_UDPv4TransportDescriptor &
  operator=(const test_UDPv4TransportDescriptor &t) = delete;
  ...
  //! Move assignment
  RTPS_DllAPI test_UDPv4TransportDescriptor &
  operator=(test_UDPv4TransportDescriptor &&t) = delete;
