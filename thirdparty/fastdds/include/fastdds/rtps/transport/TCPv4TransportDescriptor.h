 ...
 * The kind value for TCPv4TransportDescriptor is given by \c
 * eprosima::fastrtps::rtps::LOCATOR_KIND_TCPv4.
 *
 * - \c wan_addr: Public IP address. Peers on a different LAN will use this IP
 * for communications with this host.
 *
...
struct TCPv4TransportDescriptor : public TCPTransportDescriptor {
  ...
  void set_WAN_address(fastrtps::rtps::octet o1, fastrtps::rtps::octet o2,
  ...
  //! Copy assignment
  RTPS_DllAPI TCPv4TransportDescriptor &
  operator=(const TCPv4TransportDescriptor &t);

  //! Comparison operator
  RTPS_DllAPI bool operator==(const TCPv4TransportDescriptor &t) const;
};
