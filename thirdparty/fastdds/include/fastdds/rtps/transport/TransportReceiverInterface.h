...
/**
 * Interface against which to implement a data receiver, decoupled from
 * transport internals.
...
public:
   ...
   */
  virtual void OnDataReceived(const fastrtps::rtps::octet *data,
                              const uint32_t size, const Locator &local_locator,
