...
private:
   ...
   */
  bool separateKey(InstanceHandle_t &key, GuidPrefix_t *guidP,
   ...
   * and extract the liveliness kind.
   *
   * @param[in] serialized_kind A pointer to the first octet of the kind array.
   * The function assumes 4 elements in the array.
   ...
   */
  bool get_wlp_kind(const octet *serialized_kind,
