...
public:
   ...
   */
  bool newRemoteEndpointStaticallyDiscovered(const GUID_t &pguid,
...
private:
  ...
  void match_pdp_remote_endpoints(const ParticipantProxyData &pdata,
                                  bool notify_secure_endpoints);

  void assign_low_level_remote_endpoints(const ParticipantProxyData &pdata,
                                         bool notify_secure_endpoints);
