...
set_target_properties(protobuf::libprotobuf-lite PROPERTIES
  ...
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/libprotobuf-lite.so.29.0.0"
  IMPORTED_SONAME_NOCONFIG "libprotobuf-lite.so.29.0.0"
  )

list(APPEND _cmake_import_check_targets protobuf::libprotobuf-lite )
list(APPEND _cmake_import_check_files_for_protobuf::libprotobuf-lite "${_IMPORT_PREFIX}/lib/libprotobuf-lite.so.29.0.0" )
...
set_target_properties(protobuf::libprotobuf PROPERTIES
  IMPORTED_LINK_DEPENDENT_LIBRARIES_NOCONFIG "utf8_range::utf8_validity"
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/libprotobuf.so.29.0.0"
  IMPORTED_SONAME_NOCONFIG "libprotobuf.so.29.0.0"
  )

list(APPEND _cmake_import_check_targets protobuf::libprotobuf )
list(APPEND _cmake_import_check_files_for_protobuf::libprotobuf "${_IMPORT_PREFIX}/lib/libprotobuf.so.29.0.0" )
...
set_target_properties(protobuf::libprotoc PROPERTIES
  ...
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/libprotoc.so.29.0.0"
  IMPORTED_SONAME_NOCONFIG "libprotoc.so.29.0.0"
  )

list(APPEND _cmake_import_check_targets protobuf::libprotoc )
list(APPEND _cmake_import_check_files_for_protobuf::libprotoc "${_IMPORT_PREFIX}/lib/libprotoc.so.29.0.0" )
...
set_target_properties(protobuf::protoc PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/bin/protoc-29.0.0"
  )
...
set_target_properties(protobuf::protoc-gen-upb PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/bin/protoc-gen-upb-29.0.0"
  )
...
set_target_properties(protobuf::protoc-gen-upbdefs PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/bin/protoc-gen-upbdefs-29.0.0"
  )
...
set_target_properties(protobuf::protoc-gen-upb_minitable PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/bin/protoc-gen-upb_minitable-29.0.0"
  )
