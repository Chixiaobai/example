 ...
 *  @ ver 4.0 - Start to support CAN FD
 *            - Add INNO_SET_MTU_CMD ioctl command
 *            - must use EMUC2_LIBRARY_VERSION >= ver 2.5.0
 *            - support timing configuration from ini file
 *  @ ver 4.1 - kernel version >= 6.6.0: modify N_EMUC (N_DEVELOPMENT)
 *  @ ver 4.2 - kernel version >= 5.18.0: modify N_EMUC (N_DEVELOPMENT)
 *
 */

#define  EMUC_DAEMON_UTILITY_VERSION  "v4.2"
