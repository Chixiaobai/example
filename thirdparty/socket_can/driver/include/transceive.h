...
#define   EMUC_FD_MTU  82
// #define   EMUC_FD_MTU     74
#define   EMUC_MTU        17
#define   EMUC_MTU_TS     25    // CAN2.0B with timestamp
...
typedef struct
{
  ...
  unsigned char       rbuff[EMUC_FD_MTU];     /* receiver buffer           */
  int                 rcount;                 /* received chars counter    */
  unsigned char       xbuff[EMUC_FD_MTU];     /* transmitter buffer        */
...
void emuc_fd_encaps   (EMUC_RAW_INFO *info, int channel, struct canfd_frame *cf);
