@echo off&pushd %~dp0 &title Sdk软件包设置
:menu
echo.&echo 以下运行环境只能多选一
echo.&echo 1、安装64位Sdk软件包(Visual Studio 2017)
echo.&echo 2、安装32位Sdk软件包(Visual Studio 2017)
echo.&echo 3、卸载当前Sdk软件包
echo.&echo 4、退出
echo.&echo.
...
cls && echo.&echo Sdk软件包卸载完成，任意键返回！&&pause >nul && cls && goto menu
...
cls && echo.&echo Sdk软件包安装完成，任意键返回！&&pause >nul && cls && goto menu
